...
const title = "Summer 2026 City Travel Planning Guides";
const description =
  "Browse Summer 2026 city travel planning guides with arrival planning, verified visual orientation, budget tools, transport context, healthcare and public-safety context, comparisons, methodology, and source transparency.";
const introParagraph =
  "Each Summer 2026 guide pairs structured city intelligence with arrival planning, visual orientation, neighborhood research, and moving-to research. These pages support summer 2026 city travel planning only — they are not a weather forecast, events calendar, ticket-price guide, hotel-price guide, flight-price guide, itinerary generator, tourism ranking, or official tourism page. Verify weather, events, transport, health, and safety details with official or trusted current sources before departure.";

export const metadata: Metadata = createMetadata({
  title,
  description,
  path: staticRoutes.summerTravel,
});

export default function SummerTravelDirectoryPage() {
  const summerPages = getAllSummerTravelPages();
  ...
  const itemListSchema = {
    ...
    itemListElement: guides.map((entry) => ({
      "@type": "ListItem",
      name: `Summer 2026 Travel Planning Guide for ${entry.city.name}`,
      url: absoluteUrl(summerTravelRoute(entry.city.slug)),
    })),
  };
  ...
  return (
    <main>
      ...
      <Container className="space-y-12 py-12">
        ...
        <section
          aria-labelledby="summer-directory-scope-heading"
          className="rounded-2xl border border-neutral-border bg-surface-soft p-6"
        >
          <h2
            className="text-2xl font-semibold text-text-primary"
            id="summer-directory-scope-heading"
          >
            Sources and methodology
          </h2>
          <p className="mt-3 max-w-3xl text-base leading-7 text-text-secondary">
            Summer 2026 travel guides are seasonal planning checklists only.
            They do not publish weather forecasts, exact temperatures, heatwave
            claims, event or festival dates, ticket prices, hotel or flight
            prices, opening hours, transport schedules, airport routes,
            attraction rankings, crime rates, or any &ldquo;best&rdquo; /
            &ldquo;must-see&rdquo; / &ldquo;safest&rdquo; /
            &ldquo;cheapest&rdquo; claims. Verify weather, events, transport,
            health, and safety details with official or trusted current sources
            before departure. Read the{" "}
            <Link
        ...
        <section aria-labelledby="summer-directory-grid-heading">
          <SectionHeading
            description="Each card opens a Summer 2026 city travel planning guide with structured city intelligence, arrival, visual, neighborhood, and moving-to planning links plus budget tools and source transparency."
            title="All Summer 2026 travel planning guides"
          />
          <h2 className="sr-only" id="summer-directory-grid-heading">
            All Summer 2026 travel planning guides
          </h2>
                ...
                <li key={page.citySlug}>
                  <Card as="article" className="h-full" interactive>
                    ...
                    <h3 className="mt-2 text-lg font-semibold text-text-primary">
                      ...
                      >
                        {`Summer 2026 travel in ${city.name}`}
                      </Link>
                    </h3>
                    <p className="mt-1 text-xs font-medium text-text-secondary">
                      {getSummerTravelFocusLabel(page.summerFocus)}
                    </p>
                    ...
                    <div className="mt-4 flex flex-wrap gap-x-4 gap-y-2 text-sm">
                      <Link
                        ...
                        href={summerTravelRoute(city.slug)}
                      >
                        {`Open the ${city.name} Summer 2026 guide`}
                      </Link>
                      <Link
        ...
        <section aria-labelledby="summer-directory-country-heading">
          <SectionHeading
            description="A complete index of Summer 2026 travel planning guides grouped by country, fully present in the initial HTML so every link is crawlable without client-side JavaScript."
            title="Summer 2026 guides by country"
          />
          <h2 className="sr-only" id="summer-directory-country-heading">
            Summer 2026 guides by country
          </h2>
        ...
        <section
          aria-labelledby="summer-directory-related-heading"
          className="rounded-2xl border border-neutral-border bg-surface-soft p-6"
        >
          <h2
            className="text-2xl font-semibold text-text-primary"
            id="summer-directory-related-heading"
          >
            Continue exploring
          </h2>
          <p className="mt-3 max-w-3xl text-base leading-7 text-text-secondary">
            Use the structured city and country profiles, comparisons, arrival,
            visual, neighborhood, and moving-to planning alongside any Summer
            2026 travel guide. Calculators use your own inputs and do not query
            housing, salary, or transport providers — they do not publish live
            prices or schedules.
          </p>
          <ul className="mt-5 grid gap-3 text-sm md:grid-cols-2">
            ...
            <li>
              ...
              <span className="text-text-secondary">
                {" "}
                — first-day planning context paired with summer travel research.
              </span>
            </li>
            <li>
              <Link
              ...
              <span className="text-text-secondary">
                {" "}
                — source-attributed verified imagery paired with summer travel
                research.
              </span>
            </li>
            <li>
              ...
              <span className="text-text-secondary">
                {" "}
                — relocation research paired with summer travel research.
              </span>
            </li>
            <li>
              <Link
              ...
              <span className="text-text-secondary">
                {" "}
                — estimate an arrival and trip budget using your own inputs.
              </span>
            </li>
            <li>
              <Link
