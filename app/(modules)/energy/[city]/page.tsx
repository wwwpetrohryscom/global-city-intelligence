...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return createMetadata({
    title: `Energy Readiness in ${cityTitleName(city)}, ${city.countryName}: Score, Data and Sources`,
    description: `${cityTitleName(city)}, ${city.countryName} energy intelligence with clean-energy readiness, grid resilience, climate stressors, data table, and trusted sources.`,
