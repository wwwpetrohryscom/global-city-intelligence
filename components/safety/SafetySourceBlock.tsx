...
export function SafetySourceBlock({
  sources,
  lastVerified,
}: {
  sources: DataSource[];
  ...
  return (
    <section
      aria-label="Public safety sources"
    ...
    >
      ...
      <p className="mt-2 text-sm leading-6 text-text-secondary">
        Each emergency contact above is attributed to an official emergency
        service or government publisher. Confirm current numbers directly with
        these sources.
      </p>
