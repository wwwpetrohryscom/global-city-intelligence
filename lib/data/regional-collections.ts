...
export const REGIONAL_DISCOVERY_COLLECTIONS: readonly RegionalCollection[] = [
  {
    ...
    cities: ["adelaide", "coffs-harbour", "devonport", "hobart", "mackay", "melbourne", "port-macquarie", "rockhampton", "broome", "busselton", "sale", "karratha", "port-lincoln", "cessnock", "murray-bridge", "port-hedland", "esperance", "gympie", "portland-vic", "nambour", "nowra", "hamilton"],
  ...
  },
  {
    ...
    cities: ["brisbane", "geraldton", "melbourne", "perth", "townsville", "port-lincoln", "cessnock", "murray-bridge", "port-hedland", "esperance", "portland-vic", "hamilton", "sale", "nambour", "karratha", "nowra"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["augsburg", "garmisch-partenkirchen", "innsbruck", "munich", "salzburg", "ulm", "ingolstadt", "linz", "bregenz", "feldkirch", "rosenheim", "dachau"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["aachen", "antwerp", "bonn", "cologne", "dusseldorf", "hasselt", "liege", "saarbrucken", "gelsenkirchen", "hamm", "herne", "munster", "duisburg", "krefeld", "leverkusen", "eschweiler"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["los-angeles", "sacramento", "san-diego", "san-francisco", "oakland", "santa-rosa", "san-jose-us", "anaheim", "stockton", "riverside", "carson-city", "san-luis-obispo", "redwood-city", "huntington-beach", "oxnard"],
  ...
  },
  {
    ...
    regionType: "island_region",
    cities: ["laval", "nanaimo", "quebec-city", "st-johns", "toronto", "victoria", "windsor-ontario", "montreal", "sarnia", "sydney-ca", "sept-iles", "saint-eustache", "baie-comeau", "riviere-du-loup", "saint-constant", "sainte-therese", "rimouski", "vaudreuil-dorion", "shawinigan", "l-assomption"],
  ...
  },
  {
    ...
    regionType: "mountain_region",
    cities: ["calgary", "nanaimo", "sherbrooke", "vancouver", "abbotsford", "banff", "richmond-ca", "rimouski", "saint-hyacinthe", "gaspe", "victoriaville", "sorel-tracy", "alma", "val-d-or", "saint-georges", "l-assomption", "thetford-mines", "new-westminster", "sydney-ca", "sept-iles", "baie-comeau", "riviere-du-loup", "magog", "brossard", "saint-constant"],
  ...
  },
  {
    ...
    regionType: "national_park_region",
    cities: ["calgary", "charlottetown", "edmonton", "gatineau", "halifax", "laval", "montreal", "saskatoon", "sherbrooke", "winnipeg", "longueuil", "banff", "cornwall", "brandon", "brossard", "prince-albert", "rimouski", "saint-hyacinthe", "gaspe", "sept-iles", "saint-eustache", "vaudreuil-dorion", "alma", "riviere-du-loup", "magog", "shawinigan", "l-assomption"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["aachen", "bochum", "celje", "chemnitz", "czestochowa", "hradec-kralove", "kassel", "kielce", "magdeburg", "miskolc", "opole", "presov", "saarbrucken", "sankt-polten", "villach", "marburg", "cuxhaven", "wetzlar", "wismar", "lutherstadt-wittenberg", "greifswald", "goslar", "neubrandenburg", "dachau", "hamelin", "nordhausen", "altenburg", "straubing"],
  ...
  },
  {
    ...
    regionType: "coastal_region",
    cities: ["amsterdam", "bayonne", "bruges", "caen", "cagliari", "constanta", "gdansk", "granada", "le-havre", "lisbon", "lubeck", "malmo", "san-sebastian", "tarragona", "venice", "den-helder", "kampen", "saint-germain-en-laye", "alkmaar", "vlissingen", "noordoostpolder", "grasse", "harderwijk", "evreux", "saint-brieuc", "goes", "sneek", "dieppe", "sete", "la-roche-sur-yon"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["freiburg", "karlsruhe", "metz", "saarbrucken", "strasbourg", "trier", "montbeliard", "mulhouse", "colmar", "ulm", "ludwigshafen", "duisburg", "leverkusen", "troyes", "rastatt", "haguenau"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["aosta", "chambery", "grenoble", "nice", "turin", "asti", "cannes", "antibes", "toulon", "valence", "pavia", "gap"],
  ...
  },
  {
    ...
    regionType: "national_park_region",
    cities: ["grenoble", "marseille", "montpellier", "nice", "pau", "toulon", "antibes", "cannes", "albi", "beziers", "biarritz", "tarbes", "gap", "ales"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["aachen", "esch-sur-alzette", "luxembourg-city", "saarbrucken", "trier", "gelsenkirchen", "duisburg", "krefeld", "leverkusen", "mulheim-an-der-ruhr", "neuss", "solingen", "wuppertal", "herne", "monchengladbach", "neuwied", "eschweiler"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["aachen", "arnhem", "bochum", "cologne", "dusseldorf", "eindhoven", "enschede", "maastricht", "nijmegen", "zoetermeer", "leeuwarden", "gelsenkirchen", "hamm", "herne", "munster", "doetinchem", "weert", "deventer", "oss", "tiel", "aalten", "wesel"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["berlin", "dresden", "gorlitz", "szczecin", "wroclaw", "legnica", "walbrzych", "koszalin", "jelenia-gora", "gorzow-wielkopolski", "stralsund", "zielona-gora", "cottbus", "kolobrzeg", "frankfurt-oder"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["cologne", "dortmund", "flensburg", "kiel", "lubeck", "mainz", "munich", "potsdam", "regensburg", "rostock", "trier", "ulm", "ingolstadt", "gelsenkirchen", "hamm", "goslar", "cuxhaven"],
  ...
  },
  {
    ...
    regionType: "protected_landscape_region",
    cities: ["brampton", "burnaby", "colorado-springs", "jacksonville", "long-beach", "markham", "mississauga", "newark", "surrey", "vaughan", "virginia-beach", "jefferson-city", "eau-claire", "sioux-city", "kalamazoo", "rapid-city", "terre-haute", "lawrence", "little-rock", "davenport", "south-bend", "kenosha", "joliet", "grand-forks", "racine", "bowling-green", "st-joseph", "waukegan", "waterloo"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["birmingham-al", "brampton", "burnaby", "colorado-springs", "el-paso", "fort-worth", "fresno", "hartford", "jacksonville", "laval", "long-beach", "markham", "newark", "reno", "rochester", "san-angelo", "st-joseph", "waterloo", "jefferson-city", "eau-claire", "mckinney", "lawrence"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["birmingham-al", "el-paso", "fort-worth", "fresno", "jacksonville", "reno", "rochester", "tulsa", "virginia-beach", "mckinney", "wichita-falls"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["bundaberg", "dubbo", "gladstone", "invercargill", "kalgoorlie", "lower-hutt", "tamworth", "wodonga", "wangaratta", "grafton", "griffith", "taree", "echuca", "goulburn", "sale", "lithgow", "morwell", "benalla"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["brisbane", "cairns", "gold-coast", "sunshine-coast", "toowoomba", "townsville", "gympie", "nambour"],
  ...
  },
  {
    ...
    regionType: "national_park_region",
    cities: ["atlanta", "bellingham", "boulder", "chicago", "cleveland", "durango", "el-paso", "fresno", "knoxville", "los-angeles", "louisville", "miami", "richmond", "san-diego", "tacoma", "alexandria-va", "st-george", "redding", "roswell", "rapid-city", "rockville", "bowling-green", "yakima", "charlottesville"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["berlin", "dresden", "leipzig", "magdeburg", "potsdam", "braunschweig", "halle", "gottingen", "cottbus", "hildesheim", "weimar", "lutherstadt-wittenberg", "bautzen", "meissen", "altenburg", "freiberg", "halberstadt", "greifswald", "frankfurt-oder", "neubrandenburg"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["bayonne", "bordeaux", "la-rochelle", "pau", "angouleme", "niort", "saint-nazaire", "poitiers", "biarritz", "vannes", "agen", "perigueux"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["boston", "providence", "worcester", "manchester-nh", "albany-ny", "bridgeport", "cambridge-us", "salem-us", "plymouth-us", "nashua"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["brisbane", "gold-coast", "sunshine-coast", "toowoomba", "gympie", "nambour"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["chemnitz", "erfurt", "gorlitz", "braunschweig", "halle", "furth", "offenbach-am-main", "paderborn", "darmstadt", "berlin", "erlangen", "gottingen", "cottbus", "hildesheim", "bayreuth", "coburg", "nordhausen", "lutherstadt-wittenberg", "gotha", "amberg", "eisenach", "altenburg", "hof", "halberstadt"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["chicago", "milwaukee", "rockford", "green-bay", "peoria", "fort-wayne", "cedar-rapids", "iowa-city", "davenport", "kenosha", "joliet", "racine", "waukegan"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["aachen", "bochum", "bonn", "cologne", "dusseldorf", "essen", "gelsenkirchen", "hamm", "herne", "munster", "duisburg", "krefeld", "leverkusen", "mulheim-an-der-ruhr", "neuss", "wesel", "bad-homburg-vor-der-hohe", "marburg", "detmold"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["frankfurt", "heidelberg", "karlsruhe", "kassel", "mainz", "wurzburg", "ingolstadt", "hamm", "herne", "braunschweig", "duisburg", "gelsenkirchen", "krefeld", "leverkusen", "mulheim-an-der-ruhr", "schweinfurt", "wetzlar", "aschaffenburg", "eisenach", "bad-homburg-vor-der-hohe", "rastatt"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["freiburg", "konstanz", "saarbrucken", "stuttgart", "ulm", "ingolstadt", "ludwigshafen", "duisburg", "leverkusen", "furth", "heilbronn", "wiesbaden", "speyer", "offenburg", "goppingen", "waiblingen", "rastatt"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["annecy", "avignon", "chambery", "grenoble", "lyon", "saint-etienne", "toulon", "antibes", "valence", "cannes", "albi", "beziers", "bourg-en-bresse", "macon-fr", "albertville"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["bremen", "hamburg", "hanover", "kiel", "lubeck", "wolfsburg", "hamm", "herne", "braunschweig", "osnabruck", "oldenburg", "munster", "paderborn", "bielefeld", "halle", "celle", "luneburg", "wismar", "cuxhaven", "hamelin"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["long-beach", "los-angeles", "santa-barbara", "anaheim", "riverside", "bakersfield", "santa-monica", "huntington-beach", "oxnard"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["aix-en-provence", "marseille", "montpellier", "nice", "nimes", "toulon", "cannes", "antibes", "valence", "arles", "grasse", "ales"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["ballarat", "bendigo", "geelong", "melbourne", "morwell", "benalla"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["gatineau", "laval", "montreal", "ottawa", "sherbrooke", "belleville", "kingston", "trois-rivieres", "longueuil", "cornwall", "peterborough", "vaudreuil-dorion", "magog", "joliette", "shawinigan", "saint-hyacinthe", "victoriaville", "sorel-tracy", "saint-eustache", "brossard", "saint-constant", "sainte-therese", "l-assomption"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["augsburg", "garmisch-partenkirchen", "munich", "nuremberg", "passau", "regensburg", "ulm", "ingolstadt", "furth", "heilbronn", "aalen", "friedrichshafen", "ansbach", "heidenheim-an-der-brenz", "amberg", "straubing", "dachau", "goppingen", "waiblingen"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["hartford", "new-haven", "new-york", "newark", "philadelphia", "allentown", "worcester", "bridgeport", "paterson", "reading-us", "camden", "wilkes-barre", "white-plains", "new-brunswick"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["orleans", "paris", "reims", "rouen", "beauvais", "poitiers", "bourges", "saint-quentin", "troyes", "versailles", "chartres", "neuilly-sur-seine", "auxerre", "chalons-en-champagne", "laon", "courbevoie", "cambrai", "compiegne", "asnieres-sur-seine", "douai", "abbeville"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["eugene", "portland", "salem", "olympia", "vancouver-us"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["sacramento", "san-francisco", "salinas", "oakland", "santa-rosa", "san-jose-us", "stockton", "palo-alto", "merced", "redwood-city"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["newcastle", "sydney", "wollongong", "central-coast", "orange", "goulburn", "lithgow", "nowra", "cessnock"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["brampton", "hamilton-ontario", "markham", "mississauga", "toronto", "vaughan", "barrie", "st-catharines", "peterborough", "guelph", "oshawa", "brantford", "cambridge-ca"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["perpignan", "toulouse", "narbonne", "albi", "beziers", "tarbes", "carcassonne", "biarritz", "montauban", "brive-la-gaillarde", "sete", "aurillac"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["burnaby", "nanaimo", "surrey", "vancouver", "victoria", "abbotsford", "chilliwack", "new-westminster", "richmond-ca"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["almere", "angers", "bradford", "charleroi", "coventry", "derby", "drogheda", "enschede", "limoges", "metz", "orleans", "s-hertogenbosch", "saint-etienne", "sunderland", "swords", "gorinchem", "asnieres-sur-seine", "villeneuve-d-ascq", "neuilly-sur-seine", "belfort", "cambrai", "aurillac", "douai", "abbeville"],
