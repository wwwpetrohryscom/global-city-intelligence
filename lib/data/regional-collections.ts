...
export const REGIONAL_DISCOVERY_COLLECTIONS: readonly RegionalCollection[] = [
  {
    ...
    cities: ["adelaide", "coffs-harbour", "devonport", "hobart", "mackay", "melbourne", "port-macquarie", "rockhampton", "broome", "busselton", "sale", "karratha", "port-lincoln", "cessnock", "murray-bridge", "port-hedland", "esperance", "gympie", "portland-vic", "nambour", "nowra", "hamilton", "lismore", "margaret-river", "goolwa", "ballina-nsw", "kingston-au", "smithton-au", "kadina", "gosford", "victor-harbor", "bairnsdale", "charters-towers", "carnarvon", "yass", "wonthaggi", "ingham", "new-norfolk", "biloela", "byron-bay", "wynyard", "leongatha", "goonellabah", "moruya", "cowes", "millicent"],
  ...
  },
  {
    ...
    cities: ["brisbane", "geraldton", "melbourne", "perth", "townsville", "port-lincoln", "cessnock", "murray-bridge", "port-hedland", "esperance", "portland-vic", "hamilton", "sale", "nambour", "karratha", "nowra", "margaret-river", "goolwa", "kingston-au", "victor-harbor", "bairnsdale", "charters-towers", "carnarvon", "yass", "ingham", "wynyard", "moruya", "millicent", "gosford", "wonthaggi", "biloela", "leongatha", "smithton-au", "cowes", "kadina"],
  ...
  },
  {
    ...
    cities: ["canberra", "dubbo", "hobart", "melbourne", "port-macquarie", "rockhampton", "toowoomba", "orange", "broken-hill", "whyalla", "mount-isa", "horsham", "gawler", "swan-hill", "goulburn", "broome", "wodonga", "port-lincoln", "wangaratta", "cessnock", "grafton", "murray-bridge", "griffith", "busselton", "port-hedland", "sale", "lithgow", "karratha", "nowra", "morwell", "benalla", "hamilton", "echuca", "ararat", "warragul", "lismore", "warwick", "maryborough", "cowra", "traralgon", "dalby", "inverell", "colac", "muswellbrook", "singleton", "kingaroy", "margaret-river", "forster", "mudgee", "gunnedah", "kempsey", "murwillumbah", "ballina-nsw", "moree", "ayr", "leeton", "casino", "kingston-au", "penrith", "moss-vale", "port-augusta", "innisfail", "latrobe", "george-town-au", "nuriootpa", "katanning", "bairnsdale", "katoomba", "charters-towers", "cooma", "collie", "yass", "tumut", "forbes", "narrabri", "castlemaine", "deniliquin", "wonthaggi", "goondiwindi", "ingham"],
  ...
  },
  {
    ...
    cities: ["adelaide", "brisbane", "bundaberg", "coffs-harbour", "devonport", "dubbo", "gladstone", "gold-coast", "hobart", "mackay", "perth", "port-macquarie", "rockhampton", "sydney", "tamworth", "broken-hill", "whyalla", "goulburn", "wodonga", "port-lincoln", "wangaratta", "cessnock", "grafton", "murray-bridge", "griffith", "busselton", "horsham", "sale", "gympie", "lithgow", "nambour", "karratha", "taree", "nowra", "morwell", "benalla", "swan-hill", "echuca", "ararat", "lismore", "warwick", "maryborough", "cowra", "traralgon", "dalby", "inverell", "colac", "emerald", "muswellbrook", "singleton", "kingaroy", "bowen", "margaret-river", "forster", "mudgee", "gunnedah", "kempsey", "murwillumbah", "ballina-nsw", "moree", "ayr", "leeton", "casino", "penrith", "moss-vale", "katherine", "kununurra", "port-augusta", "gosford", "bairnsdale", "katoomba", "charters-towers", "carnarvon", "cooma", "innisfail", "collie", "northam", "tumut", "forbes", "narrabri"],
  ...
  },
  {
    ...
    cities: ["adelaide", "albury", "cairns", "canberra", "coffs-harbour", "darwin", "devonport", "geraldton", "gold-coast", "mackay", "melbourne", "mildura", "port-macquarie", "rockhampton", "townsville", "broken-hill", "whyalla", "mount-isa", "goulburn", "broome", "wodonga", "port-lincoln", "wangaratta", "grafton", "murray-bridge", "griffith", "busselton", "port-hedland", "esperance", "horsham", "gympie", "lithgow", "portland-vic", "karratha", "gawler", "taree", "morwell", "benalla", "swan-hill", "hamilton", "echuca", "ararat", "warwick", "cowra", "traralgon", "dalby", "inverell", "colac", "emerald", "muswellbrook", "singleton", "kingaroy", "bowen", "margaret-river", "mudgee", "goolwa", "gunnedah", "kempsey", "murwillumbah", "moree", "ayr", "leeton", "casino", "kingston-au", "penrith", "moss-vale", "port-augusta", "katherine", "victor-harbor", "katoomba", "charters-towers", "kununurra", "carnarvon", "cooma", "innisfail", "collie", "yass", "northam", "tumut", "forbes"],
  ...
  },
  {
    ...
    cities: ["brno", "ceske-budejovice", "sankt-polten", "vienna", "plzen", "linz", "pardubice", "jihlava", "decin", "eisenstadt", "wiener-neustadt", "freistadt", "tulln-an-der-donau", "melk"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["augsburg", "garmisch-partenkirchen", "innsbruck", "munich", "salzburg", "ulm", "ingolstadt", "linz", "bregenz", "feldkirch", "rosenheim", "dachau", "landsberg-am-lech", "furstenfeldbruck", "bad-tolz", "aichach", "donauworth", "gunzburg", "starnberg", "erding", "traunstein", "neuburg-an-der-donau", "kufstein", "kitzbuhel", "imst", "landeck"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["bolzano", "innsbruck", "klagenfurt", "salzburg", "udine", "verona", "villach", "brescia", "feldkirch", "bregenz", "vicenza", "treviso", "trieste", "lienz", "schwaz"],
  ...
  },
  {
    ...
    cities: ["graz", "innsbruck", "klagenfurt", "salzburg", "vienna", "villach", "linz", "eisenstadt", "wiener-neustadt", "bruck-an-der-mur", "st-veit-an-der-glan", "volkermarkt", "spittal-an-der-drau", "voitsberg", "bischofshofen", "kufstein", "gmunden", "lienz", "schwaz", "kitzbuhel", "vocklabruck", "zell-am-see", "leibnitz", "st-johann-im-pongau", "deutschlandsberg", "kapfenberg", "neusiedl-am-see", "bludenz", "tulln-an-der-donau", "liezen", "oberwart", "saalfelden-am-steinernen-meer"],
  ...
  },
  {
    ...
    regionType: "mountain_region",
    cities: ["graz", "innsbruck", "klagenfurt", "salzburg", "vienna", "villach", "linz", "wiener-neustadt", "eisenstadt", "vocklabruck", "leibnitz", "deutschlandsberg", "bludenz", "hohenems", "kufstein", "gmunden", "modling", "lienz", "bruck-an-der-mur", "schwaz", "kitzbuhel", "zell-am-see", "judenburg", "st-veit-an-der-glan", "melk", "volkermarkt", "st-johann-im-pongau", "imst", "kapfenberg", "neusiedl-am-see", "spittal-an-der-drau", "freistadt", "landeck", "tulln-an-der-donau", "weiz", "liezen", "voitsberg", "oberwart", "saalfelden-am-steinernen-meer", "feldbach", "furstenfeld", "bischofshofen"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["celje", "graz", "klagenfurt", "kranj", "ljubljana", "villach", "linz", "maribor", "eisenstadt", "wiener-neustadt", "koper", "kapfenberg", "weiz", "feldbach", "bruck-an-der-mur", "judenburg", "st-veit-an-der-glan", "leibnitz", "volkermarkt", "deutschlandsberg", "spittal-an-der-drau", "liezen", "voitsberg", "furstenfeld"],
  ...
  },
  {
    ...
    regionType: "coastal_region",
    cities: ["helsinki", "lubeck", "parnu", "tallinn", "umea", "visby", "espoo", "schwerin", "wismar", "greifswald", "neubrandenburg", "uetersen", "rendsburg", "wilhelmshaven", "emden"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["aachen", "antwerp", "bonn", "cologne", "dusseldorf", "hasselt", "liege", "saarbrucken", "gelsenkirchen", "hamm", "herne", "munster", "duisburg", "krefeld", "leverkusen", "eschweiler", "kleve", "bocholt", "euskirchen", "viersen", "gummersbach", "bergheim", "siegburg", "heinsberg", "herstal", "overpelt", "coesfeld", "borken", "eupen", "spa", "lommel", "maasmechelen", "bilzen"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["antwerp", "breda", "charleroi", "delft", "eindhoven", "hasselt", "liege", "maastricht", "nijmegen", "s-hertogenbosch", "zoetermeer", "aalst", "alphen-aan-den-rijn", "dordrecht", "ede", "gouda", "zeist", "gorinchem", "oss", "weert", "ridderkerk", "tiel", "heusden", "aarschot", "halle-be", "maasmechelen", "bilzen", "wavre", "ixelles", "waterloo-be", "uccle", "etterbeek", "lier", "saint-gilles", "beveren", "woluwe-saint-pierre", "woluwe-saint-lambert", "forest", "jette", "evere", "auderghem", "tienen", "herstal", "lommel", "overpelt"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["los-angeles", "sacramento", "san-diego", "san-francisco", "oakland", "santa-rosa", "san-jose-us", "anaheim", "stockton", "riverside", "carson-city", "san-luis-obispo", "redwood-city", "huntington-beach", "oxnard", "rancho-cucamonga", "pomona", "corona", "garden-grove", "palmdale", "cupertino", "napa", "hanford", "madera", "elk-grove", "escondido", "orange-us", "san-mateo", "mountain-view", "palm-springs", "norwalk", "compton", "hollister", "daly-city", "rialto", "woodland", "vacaville", "newport-beach", "livermore", "alameda", "carson"],
  ...
  },
  {
    ...
    regionType: "island_region",
    cities: ["laval", "nanaimo", "quebec-city", "st-johns", "toronto", "victoria", "windsor-ontario", "montreal", "sarnia", "sydney-ca", "sept-iles", "saint-eustache", "baie-comeau", "riviere-du-loup", "saint-constant", "sainte-therese", "rimouski", "vaudreuil-dorion", "shawinigan", "l-assomption", "riverview", "salaberry-de-valleyfield", "chambly", "pointe-claire", "cote-saint-luc", "boisbriand", "dorval", "saint-lazare", "summerside", "greater-napanee", "deux-montagnes", "miramichi", "varennes", "leamington", "beaconsfield", "quinte-west", "campbell-river", "owen-sound", "courtenay", "white-rock", "thorold"],
  ...
  },
  {
    ...
    regionType: "mountain_region",
    cities: ["calgary", "nanaimo", "sherbrooke", "vancouver", "abbotsford", "banff", "richmond-ca", "rimouski", "saint-hyacinthe", "gaspe", "victoriaville", "sorel-tracy", "alma", "val-d-or", "saint-georges", "l-assomption", "thetford-mines", "new-westminster", "sydney-ca", "sept-iles", "baie-comeau", "riviere-du-loup", "magog", "brossard", "saint-constant", "matane", "amos", "rouyn-noranda", "edmundston", "cowansville", "lachute", "north-vancouver", "aurora-ca", "dolbeau-mistassini", "mascouche", "sainte-marie", "port-moody", "boucherville", "canmore", "mont-saint-hilaire", "salaberry-de-valleyfield", "halton-hills", "chambly", "campbell-river", "westmount", "cote-saint-luc", "candiac", "courtenay", "port-alberni", "sainte-julie", "orangeville", "la-prairie", "beloeil", "langford", "saint-lazare", "saint-lambert", "saint-bruno-de-montarville", "miramichi", "varennes"],
  ...
  },
  {
    ...
    regionType: "national_park_region",
    cities: ["calgary", "charlottetown", "edmonton", "gatineau", "halifax", "laval", "montreal", "saskatoon", "sherbrooke", "winnipeg", "longueuil", "banff", "cornwall", "brandon", "brossard", "prince-albert", "rimouski", "saint-hyacinthe", "gaspe", "sept-iles", "saint-eustache", "vaudreuil-dorion", "alma", "riviere-du-loup", "magog", "shawinigan", "l-assomption", "dolbeau-mistassini", "mirabel", "lachute", "brockville", "mascouche", "beauharnois", "orillia", "riverview", "boucherville", "edmundston", "swift-current", "saint-lin-laurentides", "saint-lambert", "salaberry-de-valleyfield", "chambly", "westmount", "white-rock", "sainte-julie", "canmore", "beloeil", "mont-saint-hilaire", "saint-lazare", "saint-bruno-de-montarville", "miramichi", "varennes", "leamington"],
  ...
  },
  {
    ...
    cities: ["brampton", "burnaby", "kelowna", "markham", "mississauga", "ottawa", "regina", "sudbury", "surrey", "thunder-bay", "vancouver", "vaughan", "victoria", "yellowknife", "north-bay", "grande-prairie", "kenora", "rimouski", "new-westminster", "cambridge-ca", "saint-hyacinthe", "sydney-ca", "gaspe", "victoriaville", "sept-iles", "sorel-tracy", "saint-eustache", "baie-comeau", "vaudreuil-dorion", "alma", "riviere-du-loup", "brandon", "magog", "brossard", "prince-albert", "shawinigan", "sainte-therese", "l-assomption", "moose-jaw", "timmins", "mont-laurier", "becancour", "matane", "stratford", "blainville", "mirabel", "lachute", "welland", "brockville", "dolbeau-mistassini", "chateauguay", "mascouche", "dollard-des-ormeaux", "beauharnois", "sainte-marie", "orillia", "port-moody", "woodstock", "riverview", "strathmore", "boucherville", "edmundston", "lloydminster", "spruce-grove", "leduc", "brooks", "steinbach", "fort-saskatchewan", "portage-la-prairie", "camrose", "thompson", "yorkton", "cold-lake", "pembroke", "north-battleford", "quinte-west", "salaberry-de-valleyfield", "halton-hills", "chambly", "campbell-river"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["calgary", "charlottetown", "edmonton", "halifax", "kamloops", "kelowna", "kitchener", "longueuil", "mississauga", "montreal", "prince-george", "st-johns", "sudbury", "thunder-bay", "whitehorse", "richmond-ca", "rimouski", "new-westminster", "cambridge-ca", "north-bay", "saint-hyacinthe", "sydney-ca", "gaspe", "victoriaville", "sept-iles", "sorel-tracy", "saint-eustache", "baie-comeau", "vaudreuil-dorion", "grande-prairie", "alma", "riviere-du-loup", "val-d-or", "brandon", "saint-georges", "magog", "joliette", "brossard", "saint-constant", "prince-albert", "shawinigan", "kenora", "sainte-therese", "thetford-mines", "moose-jaw", "becancour", "timmins", "matane", "cowansville", "stratford", "blainville", "mirabel", "amos", "welland", "rouyn-noranda", "north-vancouver", "aurora-ca", "brockville", "dolbeau-mistassini", "chateauguay", "mont-laurier", "sainte-adele", "dollard-des-ormeaux", "beauharnois", "sainte-marie", "orillia", "port-moody", "woodstock", "riverview", "strathmore", "boucherville", "edmundston", "lloydminster", "quinte-west", "spruce-grove", "halton-hills", "leduc", "campbell-river", "pointe-claire", "westmount"],
  ...
  },
  {
    ...
    regionType: "mountain_region",
    cities: ["celje", "hradec-kralove", "kielce", "magdeburg", "opole", "villach", "braunschweig", "rybnik", "walbrzych", "legnica", "pardubice", "halle", "bielsko-biala", "chorzow", "ruda-slaska", "wetzlar", "goslar", "hof", "marburg", "luneburg", "landshut", "bayreuth", "aschaffenburg", "aalen", "friedrichshafen", "detmold", "bautzen", "eschweiler", "speyer", "celle", "ansbach", "brandenburg-an-der-havel", "plauen", "coburg", "meissen", "hamelin", "heidenheim-an-der-brenz", "schweinfurt", "gotha", "amberg", "eisenach", "nordhausen", "neu-ulm", "goppingen", "ludenscheid", "straubing", "freiberg", "bad-homburg-vor-der-hohe", "waiblingen", "halberstadt", "arnsberg", "quedlinburg", "lorrach", "landau-in-der-pfalz", "soest", "herford", "saarlouis", "wolfenbuttel", "bad-kreuznach", "pirmasens", "boblingen", "limburg-an-der-lahn", "bad-kissingen", "pirna", "deggendorf", "naumburg", "eberswalde", "suhl", "muhlhausen-thuringia", "euskirchen", "landsberg-am-lech", "biberach-an-der-riss", "bergheim", "schwabisch-hall", "homburg", "siegburg", "husum", "gummersbach", "ingelheim-am-rhein", "rottweil"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["aachen", "bochum", "celje", "chemnitz", "czestochowa", "hradec-kralove", "kassel", "kielce", "magdeburg", "miskolc", "opole", "presov", "saarbrucken", "sankt-polten", "villach", "marburg", "cuxhaven", "wetzlar", "wismar", "lutherstadt-wittenberg", "greifswald", "goslar", "neubrandenburg", "dachau", "hamelin", "nordhausen", "altenburg", "straubing", "lorrach", "oranienburg", "wolfenbuttel", "bad-kissingen", "deggendorf", "suhl", "stendal", "nordhorn", "gustrow", "gifhorn", "rottweil", "elmshorn", "meiningen", "leer", "calw", "meppen", "uetersen", "eisleben", "pinneberg", "gmunden", "peine", "modling", "kothen", "bernburg", "arnstadt", "rendsburg", "vocklabruck", "furstenfeldbruck", "zell-am-see", "wilhelmshaven", "judenburg", "bad-tolz", "saalfeld", "aichach", "melk", "donauworth", "gunzburg", "bad-hersfeld", "imst", "itzehoe", "warendorf", "neusiedl-am-see", "emmendingen", "starnberg", "bludenz", "heinsberg", "freistadt", "sigmaringen", "landeck", "helmstedt", "freital", "weiz"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["ceske-budejovice", "chemnitz", "dresden", "gorlitz", "hradec-kralove", "karlovy-vary", "leipzig", "liberec", "nuremberg", "passau", "potsdam", "prague", "pardubice", "ingolstadt", "plzen", "pirna", "freital", "annaberg-buchholz"],
  ...
  },
  {
    ...
    regionType: "mountain_region",
    cities: ["bolzano", "celje", "innsbruck", "klagenfurt", "verona", "vicenza", "brescia", "maribor", "belluno", "mantua", "varese", "monza", "koper", "oberwart", "kufstein", "gmunden", "modling", "lienz", "bruck-an-der-mur", "schwaz", "kitzbuhel", "vocklabruck", "zell-am-see", "judenburg", "st-veit-an-der-glan", "leibnitz", "melk", "volkermarkt", "st-johann-im-pongau", "deutschlandsberg", "imst", "kapfenberg", "neusiedl-am-see", "spittal-an-der-drau", "bludenz", "freistadt", "landeck", "tulln-an-der-donau", "weiz", "liezen", "voitsberg", "hohenems", "saalfelden-am-steinernen-meer", "feldbach", "furstenfeld", "bischofshofen"],
  ...
  },
  {
    ...
    regionType: "coastal_region",
    cities: ["amsterdam", "bayonne", "bruges", "caen", "cagliari", "constanta", "gdansk", "granada", "le-havre", "lisbon", "lubeck", "malmo", "san-sebastian", "tarragona", "venice", "den-helder", "kampen", "saint-germain-en-laye", "alkmaar", "vlissingen", "noordoostpolder", "grasse", "harderwijk", "evreux", "saint-brieuc", "goes", "sneek", "dieppe", "sete", "la-roche-sur-yon", "cherbourg-octeville", "saint-lo", "royan", "aubagne", "lisieux", "husum", "martigues", "beaune", "conflans-sainte-honorine", "poissy", "orange-fr", "frejus", "corbeil-essonnes", "pessac", "saintes", "fougeres", "draguignan", "anglet", "villefranche-sur-saone", "libourne", "carpentras", "rochefort", "saint-herblain", "le-cannet", "la-seyne-sur-mer", "uetersen", "wilhelmshaven", "knokke-heist", "sigmaringen", "huy", "herstal", "dinant", "gembloux", "tuttlingen", "emden", "traunstein"],
  ...
  },
  {
    ...
    cities: ["aarhus", "brussels", "jaca", "karlovy-vary", "limerick", "orleans", "paris", "rennes", "sankt-polten", "beauvais", "saint-quentin", "valenciennes", "lens", "bourges", "bethune", "villeneuve-d-ascq", "chateauroux", "douai", "versailles", "arles", "chartres", "bourg-en-bresse", "charleville-mezieres", "vichy", "auxerre", "chalons-en-champagne", "laon", "evreux", "saint-brieuc", "courbevoie", "suresnes", "compiegne", "nevers", "cambrai", "dieppe", "brive-la-gaillarde", "agen", "laval-fr", "saint-germain-en-laye", "gap", "perigueux", "albertville", "alencon", "soissons", "haguenau", "ales", "antony", "abbeville", "melun", "clamart", "bobigny", "aulnay-sous-bois", "montlucon", "saint-lo", "mont-de-marsan", "royan", "cergy", "champigny-sur-marne", "istres", "cherbourg-octeville", "lisieux", "roanne", "cahors", "issy-les-moulineaux", "mantes-la-jolie", "montelimar", "martigues", "puteaux", "drancy", "sarcelles", "evry", "digne-les-bains", "noisy-le-grand", "agde", "castres", "pontoise", "salon-de-provence", "pessac", "saint-cloud", "bergerac"],
  ...
  },
  {
    ...
    regionType: "island_region",
    cities: ["bilbao", "brest", "cork", "dublin", "dubrovnik", "esbjerg", "hamburg", "kingston-upon-hull", "konstanz", "la-rochelle", "liverpool", "naples", "parnu", "portsmouth", "rijeka", "evreux", "dieppe", "wismar", "landshut", "bourg-en-bresse", "greifswald", "frankfurt-oder", "rosenheim", "friedrichshafen", "grasse", "saint-brieuc", "neubrandenburg", "montauban", "brandenburg-an-der-havel", "cuxhaven", "thionville", "meissen", "macon-fr", "saint-germain-en-laye", "kempten", "la-roche-sur-yon", "neuwied", "maidstone", "dover-uk", "royan", "hastings-uk", "cherbourg-octeville", "husum", "martigues", "taunton", "orange-fr", "frejus", "beaune", "grimsby", "salford", "corbeil-essonnes", "ashford", "woking", "pessac", "bury", "saintes", "weston-super-mare", "scunthorpe", "margate", "folkestone", "fougeres", "bracknell", "maidenhead", "birkenhead", "draguignan", "south-shields", "barrow-in-furness", "chatham", "gravesend", "villefranche-sur-saone", "libourne", "abingdon-on-thames", "carpentras", "conflans-sainte-honorine", "rochefort", "brentwood", "saint-herblain", "royal-tunbridge-wells", "le-cannet", "la-seyne-sur-mer"],
  ...
  },
  {
    ...
    regionType: "lake_region",
    cities: ["almere", "bucharest", "budapest", "burgas", "cesis", "chania", "charleroi", "debrecen", "dublin", "evora", "ghent", "gothenburg", "ioannina", "jonkoping", "karlstad", "almelo", "oss", "alkmaar", "gouda", "heerlen", "den-helder", "heerenveen", "vlissingen", "zeist", "velsen", "noordoostpolder", "harderwijk", "meppel", "goes", "kampen", "smallingerland", "weert", "ridderkerk", "sneek", "aalten", "heusden", "virton", "wavre", "eupen", "ixelles", "waterloo-be", "uccle", "etterbeek", "lier", "saint-gilles", "beveren", "woluwe-saint-pierre", "waregem", "woluwe-saint-lambert", "forest", "knokke-heist", "binche", "jette", "spa", "ath", "evere", "auderghem", "tienen", "halle-be", "lommel", "dinant", "overpelt", "maasmechelen", "gembloux", "nivelles", "chur", "fribourg", "bellinzona", "solothurn", "la-chaux-de-fonds", "altdorf", "glarus", "schwyz", "nyon", "herisau", "sarnen", "montreux", "uster", "olten", "kreuzlingen"],
  ...
  },
  {
    ...
    regionType: "mountain_region",
    cities: ["banska-bystrica", "braga", "bratislava", "burgas", "celje", "evora", "ljubljana", "pecs", "plovdiv", "sofia", "viseu", "zilina", "porto", "maribor", "matosinhos", "sion", "schaffhausen", "aarau", "zug", "thun", "davos", "frauenfeld", "delemont", "liestal", "locarno", "vevey", "stans", "yverdon-les-bains", "martigny", "baden-ch", "interlaken", "horgen", "dietikon"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["freiburg", "karlsruhe", "metz", "saarbrucken", "strasbourg", "trier", "montbeliard", "mulhouse", "colmar", "ulm", "ludwigshafen", "duisburg", "leverkusen", "troyes", "rastatt", "haguenau", "landau-in-der-pfalz", "saarlouis", "bad-kreuznach", "homburg", "calw", "pirmasens", "emmendingen", "freudenstadt", "merzig", "neunkirchen"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["aosta", "chambery", "grenoble", "nice", "turin", "asti", "cannes", "antibes", "toulon", "valence", "pavia", "gap", "cagnes-sur-mer", "digne-les-bains", "draguignan", "le-cannet"],
  ...
  },
  {
    ...
    regionType: "lake_region",
    cities: ["angers", "annecy", "besancon", "chambery", "clermont-ferrand", "grenoble", "limoges", "metz", "nice", "strasbourg", "colmar", "mulhouse", "saint-nazaire", "valence", "cannes", "charleville-mezieres", "suresnes", "soissons", "versailles", "saint-die-des-vosges", "chartres", "neuilly-sur-seine", "vichy", "auxerre", "laon", "courbevoie", "chateauroux", "belfort", "nevers", "montauban", "dieppe", "brive-la-gaillarde", "agen", "sete", "asnieres-sur-seine", "saint-germain-en-laye", "gap", "perigueux", "albertville", "epinal", "aurillac", "haguenau", "antony", "chalon-sur-saone", "vienne", "levallois-perret", "aubervilliers", "meaux", "metropolis-of-lyon", "clamart", "bobigny", "moulins", "mont-de-marsan", "meudon", "aix-les-bains", "clichy", "auch", "champigny-sur-marne", "merignac", "roanne", "le-puy-en-velay", "rodez", "cahors", "issy-les-moulineaux", "bourg-la-reine", "vincennes", "puteaux", "drancy", "frejus", "sarcelles", "evry", "digne-les-bains", "noisy-le-grand", "agde", "corbeil-essonnes", "thonon-les-bains", "gennevilliers", "saint-cloud", "montrouge", "bergerac"],
  ...
  },
  {
    ...
    regionType: "mountain_region",
    cities: ["aix-en-provence", "avignon", "bayonne", "chambery", "clermont-ferrand", "grenoble", "lyon", "marseille", "montpellier", "nice", "pau", "strasbourg", "toulouse", "montbeliard", "cannes", "vichy", "compiegne", "antony", "saint-die-des-vosges", "arles", "bourg-en-bresse", "charleville-mezieres", "neuilly-sur-seine", "chalons-en-champagne", "grasse", "saint-brieuc", "courbevoie", "chateauroux", "belfort", "suresnes", "nevers", "montauban", "brive-la-gaillarde", "thionville", "agen", "macon-fr", "sete", "laval-fr", "asnieres-sur-seine", "gap", "perigueux", "alencon", "epinal", "aurillac", "soissons", "ales", "cagnes-sur-mer", "levallois-perret", "aubervilliers", "metropolis-of-lyon", "aulnay-sous-bois", "montlucon", "moulins", "meudon", "aix-les-bains", "cergy", "clichy", "istres", "cherbourg-octeville", "aubagne", "lisieux", "le-puy-en-velay", "cahors", "hyeres", "bourg-la-reine", "montelimar", "martigues", "puteaux", "orange-fr", "sarcelles", "beaune", "digne-les-bains", "agde", "castres", "pontoise", "thonon-les-bains", "salon-de-provence", "gennevilliers", "saint-cloud", "villejuif"],
  ...
  },
  {
    ...
    regionType: "national_park_region",
    cities: ["grenoble", "marseille", "montpellier", "nice", "pau", "toulon", "antibes", "cannes", "albi", "beziers", "biarritz", "tarbes", "gap", "ales", "hyeres", "martigues", "istres", "aubagne", "rodez", "chaumont", "la-seyne-sur-mer"],
  ...
  },
  {
    ...
    regionType: "protected_landscape_region",
    cities: ["angers", "bordeaux", "brest", "dijon", "le-mans", "lille", "limoges", "lyon", "metz", "nantes", "orleans", "saint-etienne", "strasbourg", "toulouse", "lens", "saint-brieuc", "nevers", "abbeville", "villeneuve-d-ascq", "arles", "chartres", "charleville-mezieres", "vichy", "auxerre", "chalons-en-champagne", "laon", "evreux", "courbevoie", "chateauroux", "suresnes", "compiegne", "cambrai", "dieppe", "brive-la-gaillarde", "agen", "macon-fr", "sete", "laval-fr", "saint-germain-en-laye", "perigueux", "albertville", "alencon", "douai", "soissons", "haguenau", "la-roche-sur-yon", "antony", "melun", "meaux", "clamart", "aulnay-sous-bois", "montlucon", "saint-lo", "moulins", "mont-de-marsan", "meudon", "auch", "champigny-sur-marne", "cherbourg-octeville", "aubagne", "lisieux", "le-puy-en-velay", "issy-les-moulineaux", "mantes-la-jolie", "hyeres", "montelimar", "vincennes", "drancy", "orange-fr", "evry", "beaune", "digne-les-bains", "noisy-le-grand", "castres", "corbeil-essonnes", "thonon-les-bains", "salon-de-provence", "saintes", "montrouge", "bergerac"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["bayonne", "bilbao", "jaca", "pau", "san-sebastian", "toulouse", "vitoria-gasteiz", "lleida", "biarritz", "tarbes", "mont-de-marsan", "dax", "anglet"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["annecy", "besancon", "brest", "caen", "clermont-ferrand", "dijon", "grenoble", "le-havre", "lille", "limoges", "marseille", "nancy", "nimes", "saint-etienne", "villeneuve-d-ascq", "dreux", "villejuif", "oyonnax", "fougeres", "maubeuge", "dole", "ivry-sur-seine", "saint-maur-des-fosses", "annemasse", "chatenay-malabry", "sens", "palaiseau", "dax", "chatellerault", "anglet", "villefranche-sur-saone", "libourne", "chaumont", "sevres", "conflans-sainte-honorine", "saint-herblain", "fontenay-sous-bois", "le-blanc-mesnil", "massy", "rambouillet", "poissy"],
  ...
  },
  {
    ...
    regionType: "forest_region",
    cities: ["augsburg", "berlin", "bochum", "cologne", "heidelberg", "karlsruhe", "kassel", "leipzig", "passau", "potsdam", "stuttgart", "trier", "wolfsburg", "wurzburg", "hamm", "luneburg", "hamelin", "wetzlar", "marburg", "landshut", "bayreuth", "lutherstadt-wittenberg", "aschaffenburg", "greifswald", "aalen", "frankfurt-oder", "detmold", "bautzen", "celle", "dachau", "ansbach", "brandenburg-an-der-havel", "plauen", "cuxhaven", "coburg", "heidenheim-an-der-brenz", "schweinfurt", "gotha", "amberg", "eisenach", "altenburg", "offenburg", "neu-ulm", "goppingen", "hof", "straubing", "freiberg", "bad-homburg-vor-der-hohe", "unna", "halberstadt", "stade", "arnsberg", "quedlinburg", "lorrach", "oranienburg", "landau-in-der-pfalz", "soest", "herford", "aurich", "saarlouis", "merseburg", "kleve", "pirmasens", "boblingen", "limburg-an-der-lahn", "bad-kissingen", "pirna", "deggendorf", "naumburg", "eberswalde", "muhlhausen-thuringia", "bocholt", "stendal", "landsberg-am-lech", "biberach-an-der-riss", "nordhorn", "schwabisch-hall", "homburg", "gustrow", "gifhorn"],
  ...
  },
  {
    ...
    regionType: "lake_region",
    cities: ["aachen", "augsburg", "berlin", "freiburg", "garmisch-partenkirchen", "gorlitz", "hamburg", "hanover", "munich", "regensburg", "munster", "osnabruck", "halle", "braunschweig", "monchengladbach", "aschaffenburg", "gotha", "luneburg", "wismar", "landshut", "bayreuth", "lutherstadt-wittenberg", "aalen", "rosenheim", "friedrichshafen", "detmold", "goslar", "bautzen", "neubrandenburg", "speyer", "celle", "dachau", "ansbach", "plauen", "coburg", "heidenheim-an-der-brenz", "schweinfurt", "kempten", "nordhausen", "altenburg", "offenburg", "neu-ulm", "ludenscheid", "wesel", "hof", "freiberg", "waiblingen", "unna", "rastatt", "neuwied", "stade", "arnsberg", "quedlinburg", "oranienburg", "soest", "herford", "aurich", "saarlouis", "wolfenbuttel", "bad-kreuznach", "merseburg", "kleve", "boblingen", "naumburg", "eberswalde", "muhlhausen-thuringia", "bocholt", "stendal", "euskirchen", "landsberg-am-lech", "biberach-an-der-riss", "bergheim", "viersen", "nordhorn", "schwabisch-hall", "homburg", "siegburg", "gustrow", "gifhorn", "gummersbach"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["aachen", "esch-sur-alzette", "luxembourg-city", "saarbrucken", "trier", "gelsenkirchen", "duisburg", "krefeld", "leverkusen", "mulheim-an-der-ruhr", "neuss", "solingen", "wuppertal", "herne", "monchengladbach", "neuwied", "eschweiler", "limburg-an-der-lahn", "bergheim", "siegburg", "euskirchen", "viersen", "gummersbach", "heinsberg"],
  ...
  },
  {
    ...
    regionType: "mountain_region",
    cities: ["cologne", "dresden", "erfurt", "frankfurt", "freiburg", "garmisch-partenkirchen", "gorlitz", "magdeburg", "nuremberg", "passau", "stuttgart", "wurzburg", "ulm", "gelsenkirchen", "braunschweig", "detmold", "eisenach", "wetzlar", "marburg", "luneburg", "bayreuth", "aschaffenburg", "aalen", "rosenheim", "goslar", "bautzen", "eschweiler", "speyer", "celle", "ansbach", "brandenburg-an-der-havel", "plauen", "coburg", "meissen", "hamelin", "heidenheim-an-der-brenz", "schweinfurt", "gotha", "amberg", "kempten", "nordhausen", "offenburg", "neu-ulm", "goppingen", "hof", "straubing", "bad-homburg-vor-der-hohe", "waiblingen", "halberstadt", "rastatt", "arnsberg", "quedlinburg", "lorrach", "landau-in-der-pfalz", "soest", "herford", "saarlouis", "wolfenbuttel", "bad-kreuznach", "pirmasens", "boblingen", "limburg-an-der-lahn", "bad-kissingen", "pirna", "deggendorf", "naumburg", "eberswalde", "suhl", "muhlhausen-thuringia", "euskirchen", "landsberg-am-lech", "biberach-an-der-riss", "viersen", "schwabisch-hall", "homburg", "siegburg", "husum", "gummersbach", "ingelheim-am-rhein", "rottweil"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["aachen", "arnhem", "bochum", "cologne", "dusseldorf", "eindhoven", "enschede", "maastricht", "nijmegen", "zoetermeer", "leeuwarden", "gelsenkirchen", "hamm", "herne", "munster", "doetinchem", "weert", "deventer", "oss", "tiel", "aalten", "wesel", "kleve", "bocholt", "bergheim", "viersen", "nordhorn", "heinsberg", "coesfeld", "borken"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["berlin", "dresden", "gorlitz", "szczecin", "wroclaw", "legnica", "walbrzych", "koszalin", "jelenia-gora", "gorzow-wielkopolski", "stralsund", "zielona-gora", "cottbus", "kolobrzeg", "frankfurt-oder", "eberswalde", "senftenberg"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["cologne", "dortmund", "flensburg", "kiel", "lubeck", "mainz", "munich", "potsdam", "regensburg", "rostock", "trier", "ulm", "ingolstadt", "gelsenkirchen", "hamm", "goslar", "cuxhaven", "oranienburg", "gifhorn", "rottweil", "meiningen", "calw", "uetersen", "eisleben", "pinneberg", "peine", "kothen", "bernburg", "arnstadt", "rendsburg", "furstenfeldbruck", "wilhelmshaven", "bad-tolz", "saalfeld", "aichach", "donauworth", "gunzburg", "bad-hersfeld", "meppen", "itzehoe", "warendorf", "emmendingen", "starnberg", "sigmaringen", "helmstedt", "freital", "annaberg-buchholz", "nienburg-weser", "neumarkt-in-der-oberpfalz", "freudenstadt", "coesfeld", "erding", "salzwedel", "senftenberg", "merzig", "balingen", "tuttlingen", "kulmbach", "forchheim", "neunkirchen", "delmenhorst", "emden", "cloppenburg", "vechta", "friedberg", "borken", "traunstein", "sangerhausen", "neumunster", "gelnhausen", "neuburg-an-der-donau"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["belfast", "derry", "drogheda", "dublin", "letterkenny", "sligo", "bray", "lisburn", "bangor", "newry", "ballymena", "omagh"],
  ...
  },
  {
    ...
    regionType: "national_park_region",
    cities: ["amsterdam", "arnhem", "delft", "eindhoven", "enschede", "groningen", "nijmegen", "s-hertogenbosch", "utrecht", "leeuwarden", "alphen-aan-den-rijn", "dordrecht", "ede", "zoetermeer", "amersfoort", "heerenveen", "smallingerland", "alkmaar", "deventer", "gouda", "den-helder", "almelo", "vlissingen", "doetinchem", "zeist", "velsen", "noordoostpolder", "meppel", "gorinchem", "goes", "oss", "kampen", "weert", "ridderkerk", "sneek", "tiel", "aalten", "heusden"],
  ...
  },
  {
    ...
    regionType: "protected_landscape_region",
    cities: ["brampton", "burnaby", "colorado-springs", "jacksonville", "long-beach", "markham", "mississauga", "newark", "surrey", "vaughan", "virginia-beach", "jefferson-city", "eau-claire", "sioux-city", "kalamazoo", "rapid-city", "terre-haute", "lawrence", "little-rock", "davenport", "south-bend", "kenosha", "joliet", "grand-forks", "racine", "bowling-green", "st-joseph", "waukegan", "waterloo", "hamilton-us", "oshkosh", "florence-us", "pontiac", "muncie", "saginaw", "kokomo", "franklin", "overland-park", "council-bluffs", "la-crosse", "waukesha", "decatur", "conway", "grand-island", "st-charles", "bentonville", "gary", "manhattan", "anderson", "noblesville", "appleton", "mansfield", "huntington", "delaware", "elyria", "sheboygan", "mankato", "owensboro", "belleville-us", "janesville", "quincy", "enid", "stillwater", "dubuque", "wheaton", "fond-du-lac", "findlay", "leamington", "covington", "st-cloud", "hutchinson", "pine-bluff", "shakopee", "evanston", "jonesboro", "wausau", "jeffersonville", "salina"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["birmingham-al", "brampton", "burnaby", "colorado-springs", "el-paso", "fort-worth", "fresno", "hartford", "jacksonville", "laval", "long-beach", "markham", "newark", "reno", "rochester", "san-angelo", "st-joseph", "waterloo", "jefferson-city", "eau-claire", "mckinney", "lawrence", "overland-park", "council-bluffs", "la-crosse", "decatur", "conway", "grand-island", "bentonville", "manhattan", "lakewood", "littleton", "st-charles", "lawton", "gary", "mankato", "quincy", "frisco", "brighton-us", "owensboro", "belleville-us", "janesville", "waxahachie", "sherman", "enid", "stillwater", "dubuque", "wheaton", "fond-du-lac", "rockwall", "mesquite", "st-cloud", "hutchinson", "pine-bluff", "shakopee", "jonesboro", "wausau", "jeffersonville", "salina", "evanston", "castle-rock"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["birmingham-al", "el-paso", "fort-worth", "fresno", "jacksonville", "reno", "rochester", "tulsa", "virginia-beach", "mckinney", "wichita-falls", "grand-prairie-us", "lawton", "frisco", "waxahachie", "sherman", "enid", "stillwater", "rockwall", "mesquite", "killeen"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["bundaberg", "dubbo", "gladstone", "invercargill", "kalgoorlie", "lower-hutt", "tamworth", "wodonga", "wangaratta", "grafton", "griffith", "taree", "echuca", "goulburn", "sale", "lithgow", "morwell", "benalla", "ararat", "cowra", "inverell", "mudgee", "gunnedah", "kempsey", "moree", "leeton", "warragul", "lismore", "warwick", "traralgon", "colac", "muswellbrook", "singleton", "forster", "murwillumbah", "ballina-nsw", "casino", "penrith", "moss-vale", "cooma", "tumut", "forbes", "narrabri", "deniliquin", "goondiwindi", "cootamundra", "glen-innes", "stawell", "narrandera", "renmark", "junee", "scone", "tenterfield", "gosford", "bairnsdale", "katoomba", "yass", "castlemaine", "wonthaggi", "kyneton", "beaudesert", "gatton", "byron-bay", "leongatha", "goonellabah", "moruya", "cowes"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["brisbane", "cairns", "gold-coast", "sunshine-coast", "toowoomba", "townsville", "gympie", "nambour", "maryborough", "emerald", "dalby", "kingaroy", "biloela", "beaudesert", "gatton"],
  ...
  },
  {
    ...
    regionType: "coastal_region",
    cities: ["bristol", "durham", "edinburgh", "exeter", "liverpool", "norwich", "swansea", "bournemouth", "preston", "middlesbrough", "newport", "chester", "gloucester", "maidstone", "taunton", "blackpool", "canterbury", "dover-uk", "hastings-uk", "chichester", "salisbury", "worthing", "paisley", "ayr-uk", "grimsby", "salford", "greenock", "kirkcaldy", "ashford", "woking", "bury", "weston-super-mare", "scunthorpe", "margate", "folkestone", "bracknell", "maidenhead", "birkenhead", "south-shields", "barrow-in-furness", "chatham", "gravesend", "abingdon-on-thames", "bangor", "brentwood", "royal-tunbridge-wells", "great-yarmouth", "kilmarnock", "dorchester", "windsor", "hertford", "dumbarton", "newbury", "yeovil", "eastleigh", "rochester-uk", "neath", "gillingham", "beverley", "torquay", "bexhill-on-sea", "clacton-on-sea", "widnes", "andover", "glenrothes", "port-talbot", "ballymena", "stretford", "harlow", "accrington", "bridgwater", "omagh", "littlehampton", "barnstaple", "bootle"],
  ...
  },
  {
    ...
    regionType: "forest_region",
    cities: ["birmingham", "bristol", "derby", "liverpool", "norwich", "southampton", "swansea", "southend-on-sea", "preston", "bournemouth", "milton-keynes", "northampton", "reading", "chester", "gloucester", "lichfield", "peterborough-uk", "blackpool", "ipswich-uk", "worcester-uk", "canterbury", "colchester", "chelmsford", "maidstone", "winchester", "doncaster", "cheltenham", "slough", "hereford", "dover-uk", "wigan", "shrewsbury", "rotherham", "stratford-upon-avon", "hastings-uk", "bedford", "chichester", "aylesbury", "st-albans", "salisbury", "oldham", "guildford", "wakefield", "perth-uk", "basingstoke", "eastbourne", "worthing", "high-wycombe", "gateshead", "walsall", "taunton", "darlington", "scarborough", "dunfermline", "harrogate", "west-bromwich", "warwick-uk", "dudley", "rugby", "stafford", "greenock", "crawley", "weston-super-mare", "redditch", "nuneaton", "livingston", "margate", "folkestone", "farnborough", "bracknell", "hamilton-uk", "maidenhead", "boston-uk", "stockton-on-tees", "south-shields", "dumfries", "leamington-spa", "king-s-lynn", "gravesend", "mansfield-uk"],
  ...
  },
  {
    ...
    regionType: "lake_region",
    cities: ["bristol", "carlisle", "inverness", "manchester", "newcastle-upon-tyne", "nottingham", "stoke-on-trent", "northampton", "swindon", "wrexham", "luton", "ipswich-uk", "slough", "hastings-uk", "st-albans", "harrogate", "worcester-uk", "blackburn", "chelmsford", "doncaster", "wigan", "shrewsbury", "rotherham", "stratford-upon-avon", "halifax-uk", "oldham", "guildford", "wakefield", "perth-uk", "basingstoke", "eastbourne", "rochdale", "gateshead", "lisburn", "burnley", "walsall", "lichfield", "west-bromwich", "warwick-uk", "paisley", "dudley", "ayr-uk", "rugby", "stafford", "grimsby", "salford", "greenock", "kirkcaldy", "ashford", "crawley", "woking", "bury", "redditch", "scunthorpe", "nuneaton", "livingston", "farnborough", "bracknell", "hamilton-uk", "boston-uk", "south-shields", "dumfries", "leamington-spa", "barrow-in-furness", "gravesend", "mansfield-uk", "falkirk", "lowestoft", "loughborough", "brentwood", "royal-tunbridge-wells", "corby", "great-yarmouth", "tamworth-uk", "hemel-hempstead", "kilmarnock", "merthyr-tydfil", "newry", "burton-upon-trent", "horsham-uk"],
  ...
  },
  {
    ...
    regionType: "mountain_region",
    cities: ["belfast", "birmingham", "cardiff", "derry", "lancaster", "northampton", "preston", "middlesbrough", "gloucester", "newport", "chester", "wrexham", "swindon", "salisbury", "eastbourne", "scarborough", "blackpool", "worcester-uk", "canterbury", "blackburn", "maidstone", "winchester", "cheltenham", "hereford", "wigan", "shrewsbury", "stratford-upon-avon", "halifax-uk", "chichester", "oldham", "guildford", "perth-uk", "rochdale", "worthing", "lisburn", "burnley", "taunton", "darlington", "dunfermline", "warwick-uk", "paisley", "ayr-uk", "rugby", "stafford", "grimsby", "salford", "kirkcaldy", "ashford", "crawley", "bury", "redditch", "scunthorpe", "nuneaton", "livingston", "farnborough", "hamilton-uk", "birkenhead", "stockton-on-tees", "dumfries", "leamington-spa", "barrow-in-furness", "chatham", "bangor", "falkirk", "merthyr-tydfil", "elgin-uk", "newry", "dorchester", "banbury", "horsham-uk", "godalming", "dumbarton", "trowbridge", "yeovil", "eastleigh", "motherwell", "rochester-uk", "neath", "gillingham", "beverley"],
  ...
  },
  {
    ...
    regionType: "national_park_region",
    cities: ["aberdeen", "brighton", "cardiff", "glasgow", "leeds", "manchester", "newcastle-upon-tyne", "sheffield", "southampton", "york", "stirling", "winchester", "chichester", "basingstoke", "darlington", "hereford", "salisbury", "stockton-on-tees", "lowestoft", "great-yarmouth", "merthyr-tydfil", "greenock", "dorchester", "newbury", "trowbridge", "yeovil", "eastleigh", "neath", "andover", "port-talbot", "barnstaple", "dumbarton", "kendal"],
  ...
  },
  {
    ...
    regionType: "protected_landscape_region",
    cities: ["birmingham", "cambridge", "durham", "edinburgh", "inverness", "lancaster", "lincoln", "liverpool", "london", "oxford", "preston", "milton-keynes", "luton", "reading", "stoke-on-trent", "peterborough-uk", "blackpool", "ipswich-uk", "worcester-uk", "canterbury", "colchester", "blackburn", "chelmsford", "maidstone", "winchester", "doncaster", "cheltenham", "slough", "hereford", "dover-uk", "shrewsbury", "rotherham", "stratford-upon-avon", "halifax-uk", "hastings-uk", "bedford", "chichester", "aylesbury", "st-albans", "salisbury", "guildford", "wakefield", "perth-uk", "basingstoke", "eastbourne", "worthing", "high-wycombe", "gateshead", "walsall", "taunton", "darlington", "lichfield", "scarborough", "dunfermline", "harrogate", "west-bromwich", "warwick-uk", "dudley", "rugby", "stafford", "crawley", "woking", "weston-super-mare", "redditch", "nuneaton", "livingston", "margate", "folkestone", "farnborough", "hamilton-uk", "maidenhead", "birkenhead", "boston-uk", "stockton-on-tees", "dumfries", "leamington-spa", "king-s-lynn", "chatham", "mansfield-uk", "abingdon-on-thames"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["bristol", "coventry", "inverness", "leicester", "newcastle-upon-tyne", "plymouth", "sunderland", "truro", "preston", "milton-keynes", "luton", "bournemouth", "reading", "stoke-on-trent", "wolverhampton", "falkirk", "ely", "bury-st-edmunds", "banbury", "horsham-uk", "newcastle-under-lyme", "godalming", "motherwell", "elgin-uk", "grantham", "cannock", "chesterfield", "rochester-uk", "gillingham", "torquay", "welwyn-garden-city", "kidderminster", "bexhill-on-sea", "huntingdon", "clacton-on-sea", "wellingborough", "hartlepool", "widnes", "glenrothes", "port-talbot", "ballymena", "stretford", "harlow", "accrington", "kendal", "bridgwater", "omagh", "littlehampton", "barnstaple", "cirencester", "bootle", "stevenage", "lewes"],
  ...
  },
  {
    ...
    regionType: "coastal_region",
    cities: ["bellingham", "boston", "charleston", "eugene", "los-angeles", "new-haven", "new-york", "portland", "rochester", "san-francisco", "savannah", "seattle", "oakland", "anaheim", "salinas", "newport-news", "olympia", "vancouver-us", "kenosha", "santa-monica", "salem-us", "edinburg-us", "racine", "palo-alto", "plymouth-us", "camden", "redwood-city", "huntington-beach", "oxnard", "white-plains", "waukegan", "biloxi", "hattiesburg", "kissimmee", "oceanside", "san-rafael", "waukesha", "garden-grove", "hilo", "gary", "york-us", "victoria-us", "sheboygan", "ocala", "daytona-beach", "titusville", "findlay", "elyria", "elk-grove", "hollywood", "mankato", "escondido", "miami-beach", "belleville-us", "san-mateo", "mountain-view", "pembroke-pines", "new-bedford", "wheaton", "fond-du-lac", "suffolk", "bradenton", "shakopee", "hoboken", "hempstead", "compton", "evanston", "daly-city", "woodland", "barnstable", "vacaville", "boca-raton", "newport-beach", "lynn", "livermore", "alameda", "norwalk-us", "beaverton", "carson", "federal-way"],
  ...
  },
  {
    ...
    regionType: "forest_region",
    cities: ["asheville", "boise", "boulder", "charleston", "grand-rapids", "milwaukee", "san-francisco", "santa-fe", "santa-rosa", "san-jose-us", "oakland", "dover", "athens-us", "macon", "erie", "yuma", "idaho-falls", "great-falls", "binghamton", "little-rock", "salem", "olympia", "jefferson-city", "cambridge-us", "vancouver-us", "paterson", "davenport", "south-bend", "eau-claire", "mckinney", "kenosha", "wichita-falls", "joliet", "santa-monica", "salem-us", "tuscaloosa", "flint", "roswell", "minot", "edinburg-us", "sioux-city", "grand-forks", "kalamazoo", "reading-us", "racine", "alexandria-va", "newport-news", "merced", "plymouth-us", "prescott", "casper", "dothan", "pocatello", "bellevue", "overland-park", "ogden", "council-bluffs", "san-rafael", "biloxi", "pasco", "bryan", "hamilton-us", "el-centro", "medford", "decatur", "conway", "pittsfield", "ontario", "san-marcos", "hagerstown", "oshkosh", "marietta", "sunnyvale", "grand-prairie-us", "hattiesburg", "hayward", "florence-us", "twin-falls", "pontiac", "muncie"],
  ...
  },
  {
    ...
    regionType: "lake_region",
    cities: ["austin", "burlington-vt", "denver", "madison", "missoula", "nashville", "providence", "reno", "sacramento", "salt-lake-city", "traverse-city", "aurora", "stockton", "worcester", "waco", "flint", "prescott", "canton", "little-rock", "carson-city", "dover", "olympia", "jefferson-city", "cambridge-us", "athens-us", "vancouver-us", "south-bend", "eau-claire", "erie", "yuma", "mckinney", "kenosha", "wichita-falls", "salem-us", "tuscaloosa", "sioux-city", "idaho-falls", "grand-forks", "kalamazoo", "reading-us", "racine", "rapid-city", "alexandria-va", "palo-alto", "merced", "plymouth-us", "rockville", "bowling-green", "camden", "utica", "san-marcos", "georgetown", "pocatello", "bellevue", "overland-park", "council-bluffs", "pasco", "bryan", "hamilton-us", "el-centro", "medford", "waukesha", "decatur", "conway", "grand-island", "pittsfield", "oshkosh", "sunnyvale", "grand-prairie-us", "hayward", "florence-us", "twin-falls", "pontiac", "lakewood", "muncie", "saginaw", "corona", "hackensack", "littleton", "bentonville"],
  ...
  },
  {
    ...
    regionType: "mountain_region",
    cities: ["albuquerque", "anchorage", "bellingham", "boulder", "charlotte", "chattanooga", "denver", "el-paso", "knoxville", "los-angeles", "omaha", "portland", "reno", "richmond", "salt-lake-city", "roswell", "utica", "schenectady", "tempe", "salem", "carson-city", "cambridge-us", "athens-us", "vancouver-us", "paterson", "davenport", "macon", "yuma", "wichita-falls", "santa-monica", "idaho-falls", "kalamazoo", "reading-us", "rapid-city", "alexandria-va", "palo-alto", "prescott", "san-angelo", "lancaster-us", "yakima", "st-george", "great-falls", "oxnard", "nashua", "terre-haute", "wilkes-barre", "redding", "san-luis-obispo", "charlottesville", "binghamton", "marietta", "decatur-us", "pocatello", "oceanside", "ogden", "casper", "la-crosse", "san-rafael", "pasco", "el-centro", "medford", "conway", "grand-island", "pittsfield", "ontario", "san-marcos", "hagerstown", "sunnyvale", "hayward", "florence-us", "twin-falls", "lakewood", "pomona", "corona", "corvallis", "littleton", "bentonville", "middletown", "gastonia", "garden-grove"],
  ...
  },
  {
    ...
    regionType: "national_park_region",
    cities: ["atlanta", "bellingham", "boulder", "chicago", "cleveland", "durango", "el-paso", "fresno", "knoxville", "los-angeles", "louisville", "miami", "richmond", "san-diego", "tacoma", "alexandria-va", "st-george", "redding", "roswell", "rapid-city", "rockville", "bowling-green", "yakima", "charlottesville", "hagerstown", "st-charles", "hilo", "elyria", "hollywood", "miami-beach", "owensboro", "belleville-us", "pembroke-pines", "quincy-us", "hanford", "madera", "caldwell", "troy", "newnan", "chico", "paradise", "rexburg", "boca-raton", "perth-amboy", "hollister", "manassas", "wilson", "sparks", "valdosta", "rio-rancho", "nampa", "lake-charles", "sanford", "fort-pierce"],
  ...
  },
  {
    ...
    regionType: "protected_landscape_region",
    cities: ["ann-arbor", "colorado-springs", "jacksonville", "las-vegas", "long-beach", "new-york", "newark", "oklahoma-city", "virginia-beach", "chesapeake", "detroit", "anaheim", "aurora", "riverside", "allentown", "minot", "lancaster-us", "charlottesville", "little-rock", "salem", "carson-city", "dover", "olympia", "jefferson-city", "athens-us", "paterson", "south-bend", "eau-claire", "macon", "erie", "yuma", "mckinney", "wichita-falls", "joliet", "salem-us", "tuscaloosa", "flint", "roswell", "edinburg-us", "sioux-city", "idaho-falls", "grand-forks", "kalamazoo", "reading-us", "rapid-city", "alexandria-va", "newport-news", "merced", "plymouth-us", "prescott", "gastonia", "pocatello", "bellevue", "overland-park", "ogden", "casper", "la-crosse", "biloxi", "pasco", "bryan", "hamilton-us", "el-centro", "medford", "waukesha", "decatur", "grand-island", "pittsfield", "ontario", "san-marcos", "hagerstown", "oshkosh", "marietta", "grand-prairie-us", "hattiesburg", "hayward", "florence-us", "twin-falls", "pontiac", "muncie", "pomona"],
  ...
  },
  {
    ...
    cities: ["atlanta", "birmingham-al", "chicago", "cleveland", "minneapolis", "portland", "akron", "youngstown", "montgomery", "little-rock", "south-bend", "tuscaloosa", "edinburg-us", "grand-forks", "rockville", "bowling-green", "grand-junction", "new-braunfels", "salem", "carson-city", "cambridge-us", "paterson", "joliet", "santa-monica", "sioux-city", "palo-alto", "merced", "oxnard", "charlottesville", "binghamton", "waterloo", "pocatello", "bryan", "el-centro", "medford", "twin-falls", "ogden", "council-bluffs", "la-crosse", "san-rafael", "ontario", "oshkosh", "sunnyvale", "grand-prairie-us", "muncie", "pomona", "corona", "corvallis", "hackensack", "st-charles", "bentonville", "middletown", "garden-grove", "palmdale", "kokomo", "cupertino", "rancho-cucamonga", "napa", "taunton-us", "logan", "grants-pass", "hollywood", "mankato", "anderson", "noblesville", "miami-beach", "owensboro", "waxahachie", "mountain-view", "quincy", "pembroke-pines", "palm-springs", "new-bedford", "dubuque", "yuba-city", "quincy-us", "hanford", "madera", "moorhead", "pine-bluff"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["albuquerque", "anchorage", "ann-arbor", "austin", "buffalo", "charleston", "duluth", "fort-collins", "knoxville", "richmond", "salt-lake-city", "san-diego", "santa-cruz", "savannah", "seattle", "dover", "athens-us", "macon", "erie", "yuma", "tuscaloosa", "flint", "roswell", "minot", "edinburg-us", "idaho-falls", "newport-news", "prescott", "rockville", "bowling-green", "camden", "utica", "redwood-city", "huntington-beach", "san-angelo", "lancaster-us", "yakima", "st-george", "great-falls", "canton", "nashua", "terre-haute", "wilkes-barre", "schenectady", "redding", "grand-junction", "tempe", "san-luis-obispo", "st-joseph", "charlottesville", "oceanside", "casper", "biloxi", "bryan", "hamilton-us", "san-marcos", "hagerstown", "marietta", "hattiesburg", "pontiac", "lakewood", "saginaw", "corvallis", "hackensack", "littleton", "middletown", "gastonia", "kissimmee", "dothan", "palmdale", "kokomo", "lawton", "franklin", "cupertino", "hilo", "rancho-cucamonga", "georgetown", "napa", "gary", "taunton-us"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["almere", "amsterdam", "leiden", "the-hague", "utrecht", "zoetermeer", "leeuwarden", "alphen-aan-den-rijn", "dordrecht", "ede", "westland", "amersfoort", "apeldoorn", "alkmaar", "deventer", "zeist", "ridderkerk", "heerenveen", "smallingerland"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["angers", "le-mans", "nantes", "rennes", "tours", "lorient", "bourges", "poitiers", "saint-nazaire", "niort", "laval-fr", "alencon", "la-roche-sur-yon", "fougeres", "chatellerault", "rochefort", "saint-herblain"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["antwerp", "brussels", "ghent", "hasselt", "leuven", "aalst", "genk", "molenbeek", "kortrijk", "mons", "anderlecht", "mechelen", "schaerbeek", "wavre", "eupen", "uccle", "lier", "oudenaarde", "woluwe-saint-pierre", "woluwe-saint-lambert", "knokke-heist", "jette", "spa", "auderghem", "huy", "dinant", "nivelles", "ixelles", "waterloo-be", "etterbeek", "saint-gilles", "beveren", "waregem", "forest", "binche", "ath", "evere", "aarschot", "tienen", "halle-be", "herstal", "lommel", "overpelt", "maasmechelen", "gembloux", "bilzen"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["arnhem", "enschede", "groningen", "maastricht", "nijmegen", "zoetermeer", "leeuwarden", "alphen-aan-den-rijn", "dordrecht", "ede", "westland", "amersfoort", "apeldoorn", "haarlemmermeer", "gouda", "velsen", "sneek", "doetinchem"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["belfast", "derry", "lisburn", "paisley", "ayr-uk", "greenock", "hamilton-uk", "dumfries", "barrow-in-furness", "kilmarnock", "bangor", "dumbarton", "motherwell", "newry", "ballymena", "omagh"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["berlin", "dresden", "leipzig", "magdeburg", "potsdam", "braunschweig", "halle", "gottingen", "cottbus", "hildesheim", "weimar", "lutherstadt-wittenberg", "bautzen", "meissen", "altenburg", "freiberg", "halberstadt", "greifswald", "frankfurt-oder", "neubrandenburg", "quedlinburg", "oranienburg", "stendal", "pirna", "gustrow", "eisleben", "kothen", "bernburg", "helmstedt", "salzwedel", "freital", "senftenberg", "sangerhausen"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["birmingham", "derby", "leicester", "stoke-on-trent", "wolverhampton", "preston", "milton-keynes", "luton", "northampton", "reading", "peterborough-uk", "chelmsford", "shrewsbury", "bedford", "rochdale", "aylesbury", "west-bromwich", "stafford", "weston-super-mare", "farnborough", "abingdon-on-thames", "brentwood", "boston-uk", "king-s-lynn", "loughborough", "corby", "tamworth-uk", "hemel-hempstead", "merthyr-tydfil", "godalming", "welwyn-garden-city", "harlow", "cirencester", "ely", "bury-st-edmunds", "burton-upon-trent", "banbury", "newcastle-under-lyme", "windsor", "hertford", "newbury", "trowbridge", "yeovil", "eastleigh", "grantham", "cannock", "chesterfield", "neath", "kidderminster", "huntingdon", "wellingborough", "widnes", "andover", "port-talbot", "stretford", "accrington", "bridgwater", "bootle", "stevenage"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["bayonne", "bordeaux", "la-rochelle", "pau", "angouleme", "niort", "saint-nazaire", "poitiers", "biarritz", "vannes", "agen", "perigueux", "royan", "merignac", "cahors", "pessac", "saintes", "libourne", "dax", "anglet", "rochefort"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["boston", "providence", "worcester", "manchester-nh", "albany-ny", "bridgeport", "cambridge-us", "salem-us", "plymouth-us", "nashua", "pittsfield", "middletown", "taunton-us", "new-bedford", "quincy-us", "brockton", "barnstable", "lynn"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["boulder", "colorado-springs", "denver", "aurora", "cheyenne", "lakewood", "littleton", "brighton-us", "castle-rock"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["brisbane", "gold-coast", "sunshine-coast", "toowoomba", "gympie", "nambour", "lismore", "warwick", "dalby", "kingaroy", "murwillumbah", "ballina-nsw", "casino", "gatton", "byron-bay", "goonellabah", "beaudesert"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["bath", "bristol", "cardiff", "exeter", "swansea", "bournemouth", "reading", "gloucester", "newport", "swindon", "worcester-uk", "cheltenham", "stratford-upon-avon", "aylesbury", "worthing", "bedford", "warwick-uk", "crawley", "redditch", "bracknell", "loughborough", "tamworth-uk", "abingdon-on-thames", "corby", "hemel-hempstead", "merthyr-tydfil", "banbury", "horsham-uk", "windsor", "torquay", "wellingborough", "bridgwater", "littlehampton", "dorchester", "burton-upon-trent", "newcastle-under-lyme", "godalming", "hertford", "newbury", "trowbridge", "yeovil", "eastleigh", "cannock", "neath", "welwyn-garden-city", "kidderminster", "andover", "port-talbot", "barnstaple", "cirencester", "stevenage"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["bruges", "charleroi", "namur", "ostend", "aalst", "genk", "molenbeek", "kortrijk", "mons", "anderlecht", "mechelen", "schaerbeek", "hasselt", "ixelles", "waterloo-be", "etterbeek", "saint-gilles", "beveren", "waregem", "forest", "binche", "ath", "evere", "tienen", "lommel", "gembloux", "wavre", "uccle", "lier", "oudenaarde", "woluwe-saint-pierre", "woluwe-saint-lambert", "knokke-heist", "jette", "aarschot", "auderghem", "huy", "halle-be", "herstal", "dinant", "overpelt", "maasmechelen", "bilzen", "nivelles"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["chemnitz", "erfurt", "gorlitz", "braunschweig", "halle", "furth", "offenbach-am-main", "paderborn", "darmstadt", "berlin", "erlangen", "gottingen", "cottbus", "hildesheim", "bayreuth", "coburg", "nordhausen", "lutherstadt-wittenberg", "gotha", "amberg", "eisenach", "altenburg", "hof", "halberstadt", "naumburg", "suhl", "meiningen", "saalfeld", "kulmbach", "sangerhausen", "eisleben", "kothen", "bernburg", "arnstadt", "freital", "annaberg-buchholz", "senftenberg", "forchheim"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["chicago", "milwaukee", "rockford", "green-bay", "peoria", "fort-wayne", "cedar-rapids", "iowa-city", "davenport", "kenosha", "joliet", "racine", "waukegan", "waukesha", "gary", "janesville", "dubuque", "wheaton", "fond-du-lac", "evanston"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["aachen", "bochum", "bonn", "cologne", "dusseldorf", "essen", "gelsenkirchen", "hamm", "herne", "munster", "duisburg", "krefeld", "leverkusen", "mulheim-an-der-ruhr", "neuss", "wesel", "bad-homburg-vor-der-hohe", "marburg", "detmold", "arnsberg", "soest", "nordhorn", "ingelheim-am-rhein", "bad-kreuznach", "kleve", "limburg-an-der-lahn", "bocholt", "warendorf", "friedberg", "heinsberg", "coesfeld", "merzig", "neunkirchen", "borken", "gelnhausen"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["durham", "kingston-upon-hull", "sunderland", "york", "preston", "middlesbrough", "wrexham", "chester", "blackpool", "blackburn", "doncaster", "wigan", "rotherham", "oldham", "burnley", "scarborough", "grimsby", "salford", "birkenhead", "mansfield-uk", "kirkcaldy", "stockton-on-tees", "chesterfield", "beverley", "hartlepool", "widnes", "stretford", "accrington", "bootle", "kendal"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["aberdeen", "carlisle", "dundee", "edinburgh", "glasgow", "newcastle-upon-tyne", "preston", "middlesbrough", "stirling", "wrexham", "chester", "perth-uk", "gateshead", "dunfermline", "kirkcaldy", "livingston", "south-shields", "falkirk", "paisley", "ayr-uk", "kilmarnock", "glenrothes", "kendal", "dumbarton", "motherwell"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["frankfurt", "heidelberg", "karlsruhe", "kassel", "mainz", "wurzburg", "ingolstadt", "hamm", "herne", "braunschweig", "duisburg", "gelsenkirchen", "krefeld", "leverkusen", "mulheim-an-der-ruhr", "schweinfurt", "wetzlar", "aschaffenburg", "eisenach", "bad-homburg-vor-der-hohe", "rastatt", "bad-kissingen", "suhl", "muhlhausen-thuringia", "meiningen", "calw", "arnstadt", "bad-hersfeld", "gelnhausen", "freudenstadt", "merzig", "forchheim", "neunkirchen", "friedberg"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["freiburg", "konstanz", "saarbrucken", "stuttgart", "ulm", "ingolstadt", "ludwigshafen", "duisburg", "leverkusen", "furth", "heilbronn", "wiesbaden", "speyer", "offenburg", "goppingen", "waiblingen", "rastatt", "lorrach", "pirmasens", "boblingen", "biberach-an-der-riss", "rottweil", "landau-in-der-pfalz", "calw", "balingen", "tuttlingen", "emmendingen", "sigmaringen", "freudenstadt", "merzig", "neunkirchen"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["graz", "klagenfurt", "sankt-polten", "vienna", "villach", "linz", "eisenstadt", "gmunden", "modling", "judenburg", "melk", "neusiedl-am-see", "liezen", "furstenfeld", "bruck-an-der-mur", "vocklabruck", "st-veit-an-der-glan", "leibnitz", "volkermarkt", "st-johann-im-pongau", "deutschlandsberg", "kapfenberg", "freistadt", "tulln-an-der-donau", "weiz", "voitsberg", "oberwart", "feldbach", "bischofshofen"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["annecy", "avignon", "chambery", "grenoble", "lyon", "saint-etienne", "toulon", "antibes", "valence", "cannes", "albi", "beziers", "bourg-en-bresse", "macon-fr", "albertville", "vienne", "metropolis-of-lyon", "aix-les-bains", "roanne", "le-puy-en-velay", "thonon-les-bains", "oyonnax", "annemasse", "villefranche-sur-saone", "carpentras"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["bremen", "hamburg", "hanover", "kiel", "lubeck", "wolfsburg", "hamm", "herne", "braunschweig", "osnabruck", "oldenburg", "munster", "paderborn", "bielefeld", "halle", "celle", "luneburg", "wismar", "cuxhaven", "hamelin", "herford", "wolfenbuttel", "gustrow", "gifhorn", "stendal", "elmshorn", "leer", "pinneberg", "peine", "itzehoe", "nienburg-weser", "delmenhorst", "cloppenburg", "vechta", "neumunster", "uetersen", "rendsburg", "wilhelmshaven", "helmstedt", "salzwedel"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["hobart", "launceston", "kingston-au", "new-norfolk", "longford"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["innsbruck", "salzburg", "linz", "wiener-neustadt", "dornbirn", "kufstein", "lienz", "schwaz", "kitzbuhel", "zell-am-see", "st-johann-im-pongau", "imst", "landeck", "saalfelden-am-steinernen-meer", "spittal-an-der-drau", "bludenz", "hohenems", "bischofshofen"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["bradford", "lancaster", "leeds", "liverpool", "manchester", "sheffield", "preston", "stoke-on-trent", "wolverhampton", "middlesbrough", "northampton", "hereford", "halifax-uk", "wakefield", "walsall", "lichfield", "dudley", "bury", "nuneaton", "leamington-spa", "corby", "mansfield-uk", "loughborough", "tamworth-uk", "burton-upon-trent", "newcastle-under-lyme", "grantham", "cannock", "kidderminster", "chesterfield", "beverley", "hartlepool", "widnes", "stretford", "accrington", "kendal", "bootle"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["brighton", "cambridge", "london", "oxford", "portsmouth", "southampton", "milton-keynes", "luton", "bournemouth", "reading", "stoke-on-trent", "wolverhampton", "northampton", "southend-on-sea", "high-wycombe", "st-albans", "ashford", "woking", "folkestone", "boston-uk", "chatham", "royal-tunbridge-wells", "king-s-lynn", "lowestoft", "brentwood", "corby", "great-yarmouth", "tamworth-uk", "hemel-hempstead", "rochester-uk", "bexhill-on-sea", "clacton-on-sea", "lewes", "ely", "dorchester", "bury-st-edmunds", "burton-upon-trent", "banbury", "horsham-uk", "windsor", "godalming", "hertford", "newbury", "trowbridge", "grantham", "cannock", "gillingham", "welwyn-garden-city", "kidderminster", "huntingdon", "wellingborough", "andover", "harlow", "littlehampton", "cirencester", "stevenage"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["long-beach", "los-angeles", "santa-barbara", "anaheim", "riverside", "bakersfield", "santa-monica", "huntington-beach", "oxnard", "oceanside", "ontario", "pomona", "corona", "garden-grove", "palmdale", "rancho-cucamonga", "escondido", "orange-us", "palm-springs", "norwalk", "compton", "rialto", "newport-beach", "carson"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["aix-en-provence", "marseille", "montpellier", "nice", "nimes", "toulon", "cannes", "antibes", "valence", "arles", "grasse", "ales", "istres", "aubagne", "montelimar", "cagnes-sur-mer", "orange-fr", "frejus", "salon-de-provence", "carpentras", "draguignan", "le-cannet", "la-seyne-sur-mer"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["ballarat", "bendigo", "geelong", "melbourne", "morwell", "benalla", "warragul", "traralgon", "colac", "castlemaine", "wonthaggi", "kyneton", "leongatha", "cowes"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["gatineau", "laval", "montreal", "ottawa", "sherbrooke", "belleville", "kingston", "trois-rivieres", "longueuil", "cornwall", "peterborough", "vaudreuil-dorion", "magog", "joliette", "shawinigan", "saint-hyacinthe", "victoriaville", "sorel-tracy", "saint-eustache", "brossard", "saint-constant", "sainte-therese", "l-assomption", "cowansville", "chateauguay", "sainte-adele", "beauharnois", "boucherville", "becancour", "blainville", "mirabel", "lachute", "mascouche", "dollard-des-ormeaux", "westmount", "candiac", "sainte-julie", "la-prairie", "beloeil", "saint-bruno-de-montarville", "salaberry-de-valleyfield", "chambly", "pointe-claire", "cote-saint-luc", "boisbriand", "saint-lin-laurentides", "dorval", "mont-saint-hilaire", "saint-lazare", "saint-lambert", "deux-montagnes", "varennes", "beaconsfield"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["augsburg", "garmisch-partenkirchen", "munich", "nuremberg", "passau", "regensburg", "ulm", "ingolstadt", "furth", "heilbronn", "aalen", "friedrichshafen", "ansbach", "heidenheim-an-der-brenz", "amberg", "straubing", "dachau", "goppingen", "waiblingen", "deggendorf", "schwabisch-hall", "sigmaringen", "neumarkt-in-der-oberpfalz", "forchheim", "furstenfeldbruck", "bad-tolz", "aichach", "donauworth", "gunzburg", "starnberg", "erding", "traunstein", "neuburg-an-der-donau"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["hartford", "new-haven", "new-york", "newark", "philadelphia", "allentown", "worcester", "bridgeport", "paterson", "reading-us", "camden", "wilkes-barre", "white-plains", "new-brunswick", "hackensack", "middletown", "perth-amboy", "hoboken", "hempstead", "norwalk-us", "edison", "danbury"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["lincoln", "norwich", "nottingham", "preston", "stoke-on-trent", "wolverhampton", "milton-keynes", "luton", "southend-on-sea", "northampton", "middlesbrough", "canterbury", "colchester", "dover-uk", "peterborough-uk", "rugby", "scunthorpe", "margate", "maidenhead", "king-s-lynn", "gravesend", "hemel-hempstead", "lowestoft", "loughborough", "royal-tunbridge-wells", "great-yarmouth", "ely", "bury-st-edmunds", "hertford", "gillingham", "huntingdon", "stevenage", "windsor", "grantham", "rochester-uk", "beverley", "welwyn-garden-city", "clacton-on-sea", "wellingborough", "harlow"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["orleans", "paris", "reims", "rouen", "beauvais", "poitiers", "bourges", "saint-quentin", "troyes", "versailles", "chartres", "neuilly-sur-seine", "auxerre", "chalons-en-champagne", "laon", "courbevoie", "cambrai", "compiegne", "asnieres-sur-seine", "douai", "abbeville", "melun", "levallois-perret", "aubervilliers", "meaux", "clamart", "aulnay-sous-bois", "meudon", "cergy", "clichy", "lisieux", "bourg-la-reine", "puteaux", "sarcelles", "evry", "noisy-le-grand", "corbeil-essonnes", "pontoise", "saint-cloud", "dreux", "ivry-sur-seine", "saint-maur-des-fosses", "chatenay-malabry", "palaiseau", "fontenay-sous-bois", "massy", "gennevilliers", "villejuif", "sens", "sevres", "conflans-sainte-honorine", "le-blanc-mesnil", "rambouillet", "poissy"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["bunbury", "perth", "collie", "northam", "narrogin"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["eugene", "portland", "salem", "olympia", "vancouver-us", "corvallis", "beaverton"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["breda", "delft", "eindhoven", "rotterdam", "s-hertogenbosch", "zoetermeer", "alphen-aan-den-rijn", "dordrecht", "ede", "westland", "amersfoort", "apeldoorn", "haarlemmermeer", "zaanstad", "heerlen", "noordoostpolder", "tiel", "meppel"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["sacramento", "san-francisco", "salinas", "oakland", "santa-rosa", "san-jose-us", "stockton", "palo-alto", "merced", "redwood-city", "san-rafael", "sunnyvale", "hayward", "cupertino", "napa", "elk-grove", "san-mateo", "mountain-view", "yuba-city", "hollister", "daly-city", "woodland", "vacaville", "livermore", "alameda"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["bellingham", "seattle", "tacoma", "yakima", "redmond", "federal-way"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["metz", "strasbourg", "montbeliard", "mulhouse", "colmar", "troyes", "saint-die-des-vosges", "belfort", "thionville", "epinal", "haguenau"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["newcastle", "sydney", "wollongong", "central-coast", "orange", "goulburn", "lithgow", "nowra", "cessnock", "muswellbrook", "singleton", "penrith", "moss-vale", "gosford", "katoomba"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["brampton", "hamilton-ontario", "markham", "mississauga", "toronto", "vaughan", "barrie", "st-catharines", "peterborough", "guelph", "oshawa", "brantford", "cambridge-ca", "stratford", "welland", "aurora-ca", "orillia", "woodstock", "quinte-west", "halton-hills", "owen-sound", "orangeville", "cobourg", "thorold"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["perpignan", "toulouse", "narbonne", "albi", "beziers", "tarbes", "carcassonne", "biarritz", "montauban", "brive-la-gaillarde", "sete", "aurillac", "auch", "rodez", "agde", "castres", "bergerac"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["burnaby", "nanaimo", "surrey", "vancouver", "victoria", "abbotsford", "chilliwack", "new-westminster", "richmond-ca", "north-vancouver", "port-moody", "campbell-river", "langley", "courtenay", "port-alberni", "white-rock", "langford"],
  ...
  },
  {
    ...
    regionType: "lake_region",
    cities: ["almere", "angers", "charleroi", "limoges", "metz", "leeuwarden", "amersfoort", "zaanstad", "alphen-aan-den-rijn", "saint-nazaire", "saint-quentin", "anderlecht", "troyes", "schaerbeek", "haarlemmermeer", "harderwijk", "aalten", "versailles", "alkmaar", "saint-die-des-vosges", "gouda", "heerlen", "den-helder", "almelo", "charleville-mezieres", "heerenveen", "neuilly-sur-seine", "auxerre", "velsen", "laon", "noordoostpolder", "meppel", "goes", "oss", "belfort", "smallingerland", "weert", "nevers", "sneek", "asnieres-sur-seine", "albertville", "epinal", "aurillac", "soissons", "antony", "chalon-sur-saone", "vienne", "levallois-perret", "aubervilliers", "bobigny", "aulnay-sous-bois", "moulins", "mont-de-marsan", "meudon", "aix-les-bains", "clichy", "champigny-sur-marne", "merignac", "roanne", "le-puy-en-velay", "rodez", "cahors", "issy-les-moulineaux", "bourg-la-reine", "vincennes", "puteaux", "drancy", "frejus", "sarcelles", "evry", "beaune", "noisy-le-grand", "agde", "castres", "pontoise", "thonon-les-bains", "gennevilliers", "saint-cloud", "montrouge", "bergerac"],
  ...
  },
  {
    ...
    regionType: "protected_landscape_region",
    cities: ["almere", "angers", "coventry", "le-mans", "limoges", "metz", "orleans", "saint-etienne", "zoetermeer", "milton-keynes", "luton", "angouleme", "bourges", "poitiers", "lorient", "meppel", "heusden", "versailles", "deventer", "villeneuve-d-ascq", "arles", "chartres", "den-helder", "almelo", "heerenveen", "vlissingen", "vichy", "doetinchem", "chalons-en-champagne", "velsen", "evreux", "gorinchem", "chateauroux", "kampen", "suresnes", "smallingerland", "compiegne", "ridderkerk", "cambrai", "tiel", "aalten", "laval-fr", "alencon", "douai", "ales", "la-roche-sur-yon", "abbeville", "peterborough-uk", "clamart", "bobigny", "doncaster", "cheltenham", "montlucon", "saint-lo", "royan", "rotherham", "bedford", "istres", "aylesbury", "st-albans", "roanne", "rodez", "eastbourne", "mantes-la-jolie", "bourg-la-reine", "montelimar", "vincennes", "walsall", "darlington", "lichfield", "scarborough", "dunfermline", "west-bromwich", "dudley", "pontoise", "salon-de-provence", "pessac", "saintes", "montrouge", "dreux"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["almere", "angers", "bradford", "charleroi", "coventry", "derby", "drogheda", "enschede", "limoges", "metz", "orleans", "s-hertogenbosch", "saint-etienne", "sunderland", "swords", "gorinchem", "asnieres-sur-seine", "villeneuve-d-ascq", "neuilly-sur-seine", "belfort", "cambrai", "aurillac", "douai", "abbeville", "chalon-sur-saone", "bobigny", "montlucon", "saint-lo", "moulins", "champigny-sur-marne", "issy-les-moulineaux", "vincennes", "drancy", "levallois-perret", "aubervilliers", "aix-les-bains", "clichy", "gennevilliers", "montrouge", "villejuif", "maubeuge", "dole", "sens", "sevres", "le-blanc-mesnil", "rambouillet", "dreux", "oyonnax", "fougeres", "ivry-sur-seine", "saint-maur-des-fosses", "annemasse", "draguignan", "chatenay-malabry", "palaiseau", "dax", "chatellerault", "anglet", "villefranche-sur-saone", "libourne", "chaumont", "bangor", "falkirk", "carpentras", "lowestoft", "conflans-sainte-honorine", "rochefort", "saint-herblain", "le-cannet", "fontenay-sous-bois", "massy", "kilmarnock", "la-seyne-sur-mer", "poissy", "ely", "wavre", "newry", "eupen", "ixelles", "bury-st-edmunds"],
