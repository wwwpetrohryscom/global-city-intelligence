...
export const REGIONAL_DISCOVERY_COLLECTIONS: readonly RegionalCollection[] = [
  ...
  },
  {
    ...
    description:
      "Australia Mountains groups 7 nearby places across 7 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["canberra", "dubbo", "hobart", "melbourne", "port-macquarie", "rockhampton", "toowoomba"],
    nearbyPlaces: ["bunya-mountains-national-park-near-toowoomba", "mount-archer-national-park-near-rockhampton", "namadgi-national-park-near-canberra", "warrumbungle-national-park-near-dubbo", "werrikimbe-national-park-near-port-macquarie", "you-yangs-regional-park-near-melbourne", "kunanyi-mount-wellington-near-hobart"],
  ...
  },
  {
    ...
    description:
      "Austria–Czechia Borderlands groups 5 nearby places across 4 cities for local-first day and weekend discovery — mainly nature areas, mountains. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["brno", "ceske-budejovice", "sankt-polten", "vienna"],
    nearbyPlaces: ["dunkelsteinerwald-near-sankt-polten", "hohe-wand-near-vienna", "wachau-near-sankt-polten", "podyji-national-park-near-brno", "trebon-basin-near-ceske-budejovice"],
  ...
  },
  {
    ...
    description:
      "Austria–Italy Borderlands groups 9 nearby places across 7 cities for local-first day and weekend discovery — mainly mountains, nature areas, parks. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["bolzano", "innsbruck", "klagenfurt", "salzburg", "udine", "verona", "villach"],
    nearbyPlaces: ["dobratsch-near-villach", "karawanks-near-klagenfurt", "karwendel-near-innsbruck", "krimml-waterfalls-near-salzburg", "patscherkofel-near-innsbruck", "adige-valley-near-verona", "carnic-alps-near-udine", "dolomites-near-bolzano", "julian-prealps-natural-park-near-udine"],
  ...
  },
  {
    ...
    description:
      "Austria Mountains groups 8 nearby places across 6 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["graz", "innsbruck", "klagenfurt", "salzburg", "vienna", "villach"],
  ...
  },
  {
    ...
    description:
      "Baltic Europe Weekend Escapes groups 6 nearby places across 3 cities for local-first day and weekend discovery — mainly parks. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["daugavpils", "kohtla-jarve", "panevezys"],
    nearbyPlaces: ["alutaguse-national-park-near-kohtla-jarve", "lahemaa-national-park-near-kohtla-jarve", "aukstaitija-national-park-near-daugavpils", "razna-national-park-near-daugavpils", "anyksciai-regional-park-near-panevezys", "birzai-regional-park-near-panevezys"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["antwerp", "breda", "charleroi", "delft", "eindhoven", "hasselt", "liege", "maastricht", "nijmegen", "s-hertogenbosch"],
  ...
  },
  {
    ...
    regionType: "island_region",
    cities: ["laval", "nanaimo", "quebec-city", "st-johns", "toronto", "victoria", "windsor-ontario"],
    nearbyPlaces: ["pelee-island-near-windsor-ontario", "salt-spring-island-near-victoria", "saysutshun-newcastle-island-marine-park-near-nanaimo", "toronto-islands-near-toronto", "witless-bay-ecological-reserve-near-st-johns", "ile-d-orleans-near-quebec-city", "iles-de-boucherville-national-park-near-laval"],
  ...
  },
  {
    ...
    description:
      "Central Europe Mountains groups 7 nearby places across 6 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["celje", "hradec-kralove", "kielce", "magdeburg", "opole", "villach"],
    nearbyPlaces: ["dobratsch-near-villach", "orlicke-mountains-near-hradec-kralove", "harz-near-magdeburg", "saint-anne-mountain-near-opole", "swietokrzyskie-mountains-near-kielce", "kamniksavinja-alps-near-celje", "pohorje-near-celje"],
  ...
  },
  {
    ...
    description:
      "Croatia–Slovenia Borderlands groups 5 nearby places across 4 cities for local-first day and weekend discovery — mainly mountains, nature areas. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["celje", "ljubljana", "rijeka", "zagreb"],
    nearbyPlaces: ["medvednica-nature-park-near-zagreb", "risnjak-national-park-near-rijeka", "kamniksavinja-alps-near-celje", "pohorje-near-celje", "vipava-valley-near-ljubljana"],
  ...
  },
  {
    ...
    description:
      "Czechia–Germany Borderlands groups 19 nearby places across 12 cities for local-first day and weekend discovery — mainly nature areas, mountains. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["ceske-budejovice", "chemnitz", "dresden", "gorlitz", "hradec-kralove", "karlovy-vary", "leipzig", "liberec", "nuremberg", "passau", "potsdam", "prague"],
    nearbyPlaces: ["adrspach-teplice-rocks-near-hradec-kralove", "bohemian-switzerland-near-prague", "jested-near-liberec", "koneprusy-caves-near-prague", "slavkov-forest-near-karlovy-vary", "trebon-basin-near-ceske-budejovice", "bavarian-forest-near-passau", "bavarian-forest-national-park-near-passau", "dresden-heath-near-dresden", "franconian-switzerland-near-nuremberg", "leipzig-riverside-forest-near-leipzig", "lusatian-mountains-near-dresden", "ore-mountains-near-dresden", "ore-mountains-vogtland-nature-park-near-chemnitz", "pegnitz-valley-near-nuremberg", "saxon-switzerland-national-park-near-dresden", "spreewald-near-potsdam", "zittau-mountains-near-gorlitz", "zschopau-near-chemnitz"],
  ...
  },
  {
    ...
    description:
      "Czechia Mountains groups 5 nearby places across 5 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
  ...
  },
  {
    ...
    description:
      "Czechia–Poland Borderlands groups 13 nearby places across 8 cities for local-first day and weekend discovery — mainly mountains, nature areas, parks. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["brno", "hradec-kralove", "liberec", "olomouc", "opole", "ostrava", "prague", "wroclaw"],
  ...
  },
  {
    ...
    description:
      "Denmark–Germany Borderlands groups 7 nearby places across 7 cities for local-first day and weekend discovery — mainly waterfronts, islands, nature areas. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["copenhagen", "esbjerg", "flensburg", "kiel", "odense", "rostock", "vejle"],
    nearbyPlaces: ["fano-near-esbjerg", "stevns-klint-near-copenhagen", "svanninge-bakker-near-odense", "vejle-fjord-near-vejle", "fischland-darss-zingst-near-rostock", "flensburg-fjord-near-flensburg", "holstein-switzerland-near-kiel"],
  ...
  },
  {
    ...
    title: "Eastern Alps",
    description:
      "Eastern Alps groups 5 nearby places across 5 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["bolzano", "celje", "innsbruck", "klagenfurt", "verona"],
    nearbyPlaces: ["karawanks-near-klagenfurt", "karwendel-near-innsbruck", "dolomites-near-bolzano", "lessinia-regional-park-near-verona", "kamniksavinja-alps-near-celje"],
  ...
  },
  {
    ...
    description:
      "Estonia–Finland Borderlands groups 6 nearby places across 4 cities for local-first day and weekend discovery — mainly islands, parks, nature areas. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["helsinki", "kohtla-jarve", "tallinn", "vantaa"],
    nearbyPlaces: ["aegna-near-tallinn", "lahemaa-national-park-near-kohtla-jarve", "nuuksio-national-park-near-helsinki", "sipoonkorpi-national-park-near-vantaa", "suomenlinna-helsinki", "tammisaari-archipelago-national-park-near-helsinki"],
  ...
  },
  {
    ...
    description:
      "European Coast groups 17 nearby places across 15 cities for local-first day and weekend discovery — mainly beaches. This is a geographic discovery collection derived from a shared coastline; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "coastal_region",
  ...
  },
  {
    ...
    description:
      "European Forests groups 9 nearby places across 9 cities for local-first day and weekend discovery — mainly nature areas, parks. This is a geographic discovery collection derived from forest landscapes; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "forest_region",
    cities: ["aarhus", "brussels", "jaca", "karlovy-vary", "limerick", "orleans", "paris", "rennes", "sankt-polten"],
    nearbyPlaces: ["dunkelsteinerwald-near-sankt-polten", "sonian-forest-near-brussels", "slavkov-forest-near-karlovy-vary", "marselisborg-forests-near-aarhus", "forest-of-orleans-near-orleans", "foret-de-rambouillet-near-paris", "broceliande-forest-near-rennes", "curragh-chase-forest-park-near-limerick", "irati-forest-near-jaca"],
  ...
  },
  {
    ...
    description:
      "European Mountains groups 14 nearby places across 12 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["banska-bystrica", "braga", "bratislava", "burgas", "celje", "evora", "ljubljana", "pecs", "plovdiv", "sofia", "viseu", "zilina"],
    nearbyPlaces: ["rhodope-mountains-near-plovdiv", "strandzha-near-burgas", "vitosha-near-sofia", "mecsek-near-pecs", "peneda-geres-national-park-near-braga", "serra-da-estrela-natural-park-near-viseu", "serra-de-sao-mamede-near-evora", "little-carpathians-near-bratislava", "mala-fatra-national-park-near-zilina", "polana-near-banska-bystrica", "velka-fatra-near-bratislava", "kamniksavinja-alps-near-celje", "pohorje-near-celje", "triglav-national-park-near-ljubljana"],
  ...
  },
  {
    ...
    title: "France Lakes",
    description:
      "France Lakes groups 11 nearby places across 10 cities for local-first day and weekend discovery — mainly lakes. This is a geographic discovery collection derived from lake-district geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "lake_region",
    cities: ["angers", "annecy", "besancon", "chambery", "clermont-ferrand", "grenoble", "limoges", "metz", "nice", "strasbourg"],
    nearbyPlaces: ["lac-blanc-near-strasbourg", "lac-pavin-near-clermont-ferrand", "lac-de-madine-near-metz", "lac-de-maine-near-angers", "lac-de-monteynard-avignonet-near-grenoble", "lac-de-saint-cassien-near-nice", "lac-de-saint-point-near-besancon", "lac-de-vassiviere-near-limoges", "lac-du-bourget-near-chambery", "lake-annecy-near-annecy", "lake-of-sainte-croix-near-nice"],
  ...
  },
  {
    ...
    title: "Germany Lakes",
    description:
      "Germany Lakes groups 13 nearby places across 10 cities for local-first day and weekend discovery — mainly lakes. This is a geographic discovery collection derived from lake-district geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "lake_region",
    cities: ["aachen", "augsburg", "berlin", "freiburg", "garmisch-partenkirchen", "gorlitz", "hamburg", "hanover", "munich", "regensburg"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["aachen", "esch-sur-alzette", "luxembourg-city", "saarbrucken", "trier"],
    nearbyPlaces: ["eifel-national-park-near-aachen", "hunsruck-hochwald-national-park-near-trier", "saar-hunsruck-nature-park-near-saarbrucken", "saarschleife-near-saarbrucken", "mullerthal-near-luxembourg-city", "upper-sure-natural-park-near-esch-sur-alzette"],
  ...
  },
  {
    ...
    description:
      "Germany Mountains groups 17 nearby places across 12 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["cologne", "dresden", "erfurt", "frankfurt", "freiburg", "garmisch-partenkirchen", "gorlitz", "magdeburg", "nuremberg", "passau", "stuttgart", "wurzburg"],
  ...
  },
  {
    ...
    description:
      "Germany–Netherlands Borderlands groups 11 nearby places across 9 cities for local-first day and weekend discovery — mainly nature areas, parks. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["aachen", "arnhem", "bochum", "cologne", "dusseldorf", "eindhoven", "enschede", "maastricht", "nijmegen"],
    nearbyPlaces: ["eifel-national-park-near-aachen", "hambach-forest-near-cologne", "hohe-mark-nature-park-near-bochum", "neandertal-near-dusseldorf", "rhineland-nature-park-near-cologne", "groote-peel-national-park-near-eindhoven", "de-maasduinen-national-park-near-nijmegen", "hoge-veluwe-national-park-near-arnhem", "sallandse-heuvelrug-national-park-near-enschede", "sint-pietersberg-near-maastricht", "veluwezoom-national-park-near-arnhem"],
  ...
  },
  {
    ...
    description:
      "Greece Mountains groups 8 nearby places across 6 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["athens", "heraklion", "ioannina", "kavala", "larissa", "volos"],
    nearbyPlaces: ["mount-geraneia-near-athens", "mount-hymettus-near-athens", "mount-ida-crete-near-heraklion", "mount-ossa-near-larissa", "mount-pangaion-near-kavala", "mount-pelion-near-volos", "mount-parnitha-near-athens", "tymfi-near-ioannina"],
  ...
  },
  {
    ...
    description:
      "Greece Weekend Escapes groups 8 nearby places across 5 cities for local-first day and weekend discovery — mainly mountains, lakes, nature areas. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["chania", "heraklion", "ioannina", "kavala", "larissa"],
    nearbyPlaces: ["lake-kournas-near-chania", "lake-pamvotida-near-ioannina", "mount-ida-crete-near-heraklion", "mount-ossa-near-larissa", "mount-pangaion-near-kavala", "samaria-gorge-near-chania", "tymfi-near-ioannina", "vale-of-tempe-near-larissa"],
  ...
  },
  {
    ...
    description:
      "Hungary–Poland Borderlands groups 5 nearby places across 3 cities for local-first day and weekend discovery — mainly mountains, parks. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["krakow", "miskolc", "zakopane"],
    nearbyPlaces: ["aggtelek-national-park-near-miskolc", "beskids-near-krakow", "pieniny-near-krakow", "tatra-mountains-near-krakow", "tatra-national-park-near-zakopane"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["banska-bystrica", "budapest", "kosice", "miskolc", "presov"],
    nearbyPlaces: ["aggtelek-national-park-near-miskolc", "bukk-national-park-near-budapest", "danube-ipoly-national-park-near-budapest", "pieniny-national-park-near-presov", "polana-near-banska-bystrica", "slovak-paradise-national-park-near-kosice"],
  ...
  },
  {
    ...
    description:
      "Ireland Mountains groups 10 nearby places across 10 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["athlone", "cork", "drogheda", "galway", "kilkenny", "killarney", "limerick", "sligo", "tralee", "waterford"],
  ...
  },
  {
    ...
    description:
      "Ireland–United Kingdom Borderlands groups 9 nearby places across 6 cities for local-first day and weekend discovery — mainly mountains, waterfronts, parks. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["belfast", "derry", "drogheda", "dublin", "letterkenny", "sligo"],
    nearbyPlaces: ["benbulbin-near-sligo", "cooley-mountains-near-drogheda", "lough-swilly-near-letterkenny", "phoenix-park-dublin", "cave-hill-near-belfast", "lough-foyle-near-derry", "mourne-mountains-near-belfast", "slieve-croob-near-belfast", "sperrins-near-derry"],
  ...
  },
  {
    ...
    description:
      "Ireland Weekend Escapes groups 5 nearby places across 5 cities for local-first day and weekend discovery — mainly parks, mountains, waterfronts. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["dublin", "dundalk", "letterkenny", "swords", "westport"],
    nearbyPlaces: ["connemara-national-park-near-westport", "cooley-mountains-near-dundalk", "lough-swilly-near-letterkenny", "north-bull-island-near-swords", "wicklow-mountains-near-dublin"],
  ...
  },
  {
    ...
    description:
      "Italy Mountains groups 19 nearby places across 14 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["aosta", "bolzano", "catania", "como", "laquila", "lucca", "naples", "palermo", "reggio-emilia", "trento", "turin", "udine", "venice", "verona"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["celje", "kranj", "ljubljana", "udine"],
    nearbyPlaces: ["carnic-alps-near-udine", "julian-prealps-natural-park-near-udine", "kamniksavinja-alps-near-celje", "triglav-national-park-near-kranj", "vipava-valley-near-ljubljana"],
  ...
  },
  {
    ...
    description:
      "Italy Weekend Escapes groups 15 nearby places across 12 cities for local-first day and weekend discovery — mainly mountains, nature areas, lakes. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["ancona", "aosta", "bari", "bolzano", "cagliari", "catania", "milan", "palermo", "pisa", "ravenna", "trapani", "trento"],
  ...
  },
  {
    ...
    description:
      "Latvia–Lithuania Borderlands groups 6 nearby places across 4 cities for local-first day and weekend discovery — mainly parks, nature areas. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["daugavpils", "panevezys", "riga", "vilnius"],
    nearbyPlaces: ["aukstaitija-national-park-near-daugavpils", "kemeri-national-park-near-riga", "anyksciai-regional-park-near-panevezys", "birzai-regional-park-near-panevezys", "trakai-historical-national-park-near-vilnius", "verkiai-regional-park-near-vilnius"],
  ...
  },
  {
    ...
    description:
      "Latvia Weekend Escapes groups 5 nearby places across 3 cities for local-first day and weekend discovery — mainly parks, nature areas, lakes. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["cesis", "daugavpils", "riga"],
    nearbyPlaces: ["aukstaitija-national-park-near-daugavpils", "gauja-national-park-near-cesis", "kemeri-national-park-near-riga", "lake-burtnieks-near-cesis", "razna-national-park-near-daugavpils"],
  ...
  },
  {
    ...
    description:
      "Netherlands Weekend Escapes groups 6 nearby places across 5 cities for local-first day and weekend discovery — mainly nature areas. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["amsterdam", "haarlem", "rotterdam", "tilburg", "zwolle"],
    nearbyPlaces: ["de-biesbosch-national-park-near-rotterdam", "loonse-en-drunense-duinen-national-park-near-tilburg", "midden-delfland-near-rotterdam", "oostvaardersplassen-near-amsterdam", "sallandse-heuvelrug-national-park-near-zwolle", "zuid-kennemerland-national-park-near-haarlem"],
  ...
  },
  {
    ...
    description:
      "New Zealand Weekend Escapes groups 8 nearby places across 5 cities for local-first day and weekend discovery — mainly mountains, nature areas, lakes. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["christchurch", "napier", "new-plymouth", "queenstown", "rotorua"],
    nearbyPlaces: ["arthurs-pass-national-park-near-christchurch", "egmont-national-park-near-new-plymouth", "fiordland-near-queenstown", "hanmer-springs-near-christchurch", "lake-rotokare-near-new-plymouth", "port-hills-near-christchurch", "te-mata-peak-near-napier", "waiotapu-near-rotorua"],
  ...
  },
  {
    ...
    title: "North America Weekend Escapes",
    description:
      "North America Weekend Escapes groups 18 nearby places across 9 cities for local-first day and weekend discovery — mainly parks, nature areas, mountains. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
  ...
  },
  {
    ...
    description:
      "Northern Europe Weekend Escapes groups 9 nearby places across 5 cities for local-first day and weekend discovery — mainly parks, waterfronts, nature areas. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["lahti", "norrkoping", "orebro", "vantaa", "vejle"],
    nearbyPlaces: ["mols-bjerge-national-park-near-vejle", "vejle-fjord-near-vejle", "nuuksio-national-park-near-vantaa", "paijanne-national-park-near-lahti", "repovesi-national-park-near-lahti", "sipoonkorpi-national-park-near-vantaa", "braviken-near-norrkoping", "kolmarden-near-norrkoping", "tiveden-national-park-near-orebro"],
  ...
  },
  {
    ...
    description:
      "Oceania Weekend Escapes groups 12 nearby places across 7 cities for local-first day and weekend discovery — mainly nature areas, parks, mountains. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["bundaberg", "dubbo", "gladstone", "invercargill", "kalgoorlie", "lower-hutt", "tamworth"],
    nearbyPlaces: ["boorabbin-national-park-near-kalgoorlie", "burrum-coast-national-park-near-bundaberg", "deepwater-national-park-near-bundaberg", "eurimbula-national-park-near-gladstone", "goulburn-river-national-park-near-dubbo", "kroombit-tops-national-park-near-gladstone", "oxley-wild-rivers-national-park-near-tamworth", "warrabah-national-park-near-tamworth", "warrumbungle-national-park-near-dubbo", "belmont-regional-park-near-lower-hutt", "fiordland-national-park-near-invercargill", "the-catlins-near-invercargill"],
  ...
  },
  {
    ...
    description:
      "Poland–Slovakia Borderlands groups 14 nearby places across 8 cities for local-first day and weekend discovery — mainly mountains, nature areas, parks. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["banska-bystrica", "czestochowa", "kosice", "krakow", "presov", "rzeszow", "zakopane", "zilina"],
    nearbyPlaces: ["beskids-near-krakow", "czarnorzeki-strzyzow-landscape-park-near-rzeszow", "gorce-national-park-near-zakopane", "magura-national-park-near-rzeszow", "ojcow-national-park-near-czestochowa", "pieniny-near-krakow", "tatra-mountains-near-krakow", "tatra-national-park-near-zakopane", "mala-fatra-national-park-near-zilina", "pieniny-national-park-near-presov", "polana-near-banska-bystrica", "slovak-paradise-national-park-near-kosice", "sulov-rocks-near-zilina", "velka-fatra-near-banska-bystrica"],
  ...
  },
  {
    ...
    description:
      "Portugal Weekend Escapes groups 7 nearby places across 7 cities for local-first day and weekend discovery — mainly nature areas, mountains. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["braganca", "coimbra", "faro", "funchal", "guimaraes", "vila-nova-de-gaia", "viseu"],
    nearbyPlaces: ["alvao-natural-park-near-vila-nova-de-gaia", "montesinho-natural-park-near-braganca", "peneda-geres-national-park-near-guimaraes", "ponta-de-sao-lourenco-near-funchal", "ria-formosa-natural-park-near-faro", "serra-da-estrela-natural-park-near-viseu", "bucaco-forest-near-coimbra"],
  ...
  },
  {
    ...
    description:
      "Romania Mountains groups 7 nearby places across 7 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
  ...
  },
  {
    ...
    description:
      "Southern Europe Mountains groups 6 nearby places across 5 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["burgos", "cartagena", "larissa", "leon", "reggio-emilia"],
    nearbyPlaces: ["mount-ossa-near-larissa", "appennino-tosco-emiliano-national-park-near-reggio-emilia", "monte-cusna-near-reggio-emilia", "sierra-espuna-near-cartagena", "sierra-de-ancares-near-leon", "sierra-de-la-demanda-near-burgos"],
  ...
  },
  {
    ...
    description:
      "Southern Europe Protected Landscapes groups 8 nearby places across 7 cities for local-first day and weekend discovery — mainly nature areas, parks. This is a geographic discovery collection derived from a shared protected landscape; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "protected_landscape_region",
    cities: ["almeria", "burgos", "cadiz", "cartagena", "santiago-de-compostela", "setubal", "vila-nova-de-gaia"],
    nearbyPlaces: ["alvao-natural-park-near-vila-nova-de-gaia", "arrabida-natural-park-near-setubal", "sado-estuary-natural-reserve-near-setubal", "cabo-de-gata-nijar-natural-park-near-almeria", "calblanque-regional-park-near-cartagena", "fragas-do-eume-near-santiago-de-compostela", "la-brena-y-marismas-del-barbate-natural-park-near-cadiz", "ojo-guarena-near-burgos"],
  ...
  },
  {
    ...
    description:
      "Southern Europe Weekend Escapes groups 28 nearby places across 15 cities for local-first day and weekend discovery — mainly nature areas, parks, mountains. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
  ...
  },
  {
    ...
    description:
      "Spain Mountains groups 19 nearby places across 15 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
  ...
  },
  {
    ...
    description:
      "Spain Protected Landscapes groups 15 nearby places across 14 cities for local-first day and weekend discovery — mainly nature areas, parks. This is a geographic discovery collection derived from a shared protected landscape; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "protected_landscape_region",
    cities: ["a-coruna", "alicante", "almeria", "bilbao", "burgos", "cadiz", "cartagena", "girona", "malaga", "oviedo", "pamplona", "salamanca", "san-sebastian", "valencia"],
  ...
  },
  {
    ...
    description:
      "Spain Weekend Escapes groups 13 nearby places across 10 cities for local-first day and weekend discovery — mainly nature areas, mountains, islands. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["a-coruna", "caceres", "granada", "jaca", "murcia", "oviedo", "salamanca", "seville", "vigo", "zaragoza"],
  ...
  },
  {
    ...
    description:
      "Sweden National Parks groups 7 nearby places across 7 cities for local-first day and weekend discovery — mainly nature areas, islands. This is a geographic discovery collection derived from a shared national-park system; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "national_park_region",
    cities: ["gothenburg", "helsingborg", "jonkoping", "malmo", "orebro", "stockholm", "uppsala"],
    nearbyPlaces: ["dalby-soderskog-national-park-near-malmo", "farnebofjarden-national-park-near-uppsala", "sodra-bohuslan-archipelago-near-gothenburg", "store-mosse-national-park-near-jonkoping", "soderasen-national-park-near-helsingborg", "tiveden-national-park-near-orebro", "angso-national-park-near-stockholm"],
  ...
  },
  {
    ...
    description:
      "United Kingdom Weekend Escapes groups 10 nearby places across 8 cities for local-first day and weekend discovery — mainly nature areas, waterfronts, lakes. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["bristol", "coventry", "inverness", "leicester", "newcastle-upon-tyne", "plymouth", "sunderland", "truro"],
    nearbyPlaces: ["cannock-chase-near-coventry", "carrick-roads-near-truro", "dartmoor-near-plymouth", "durham-coast-near-sunderland", "glen-affric-near-inverness", "hadrians-wall-near-newcastle-upon-tyne", "loch-ness-near-inverness", "mendip-hills-near-bristol", "roseland-peninsula-near-truro", "the-national-forest-near-leicester"],
  ...
  },
  {
    ...
    description:
      "United States Coast groups 12 nearby places across 12 cities for local-first day and weekend discovery — mainly beaches, waterfronts. This is a geographic discovery collection derived from a shared coastline; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "coastal_region",
    cities: ["bellingham", "boston", "charleston", "eugene", "los-angeles", "new-haven", "new-york", "portland", "rochester", "san-francisco", "savannah", "seattle"],
  ...
  },
  {
    ...
    description:
      "United States Lakes groups 11 nearby places across 11 cities for local-first day and weekend discovery — mainly lakes. This is a geographic discovery collection derived from lake-district geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "lake_region",
  ...
  },
  {
    ...
    description:
      "United States Mountains groups 20 nearby places across 15 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
  ...
  },
  {
    ...
    description:
      "United States Protected Landscapes groups 10 nearby places across 9 cities for local-first day and weekend discovery — mainly nature areas, parks. This is a geographic discovery collection derived from a shared protected landscape; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "protected_landscape_region",
    cities: ["ann-arbor", "colorado-springs", "jacksonville", "las-vegas", "long-beach", "new-york", "newark", "oklahoma-city", "virginia-beach"],
  ...
  },
  {
    ...
    description:
      "United States River Valleys groups 6 nearby places across 6 cities for local-first day and weekend discovery — mainly nature areas, waterfronts. This is a geographic discovery collection derived from river-valley geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "river_region",
    cities: ["atlanta", "birmingham-al", "chicago", "cleveland", "minneapolis", "portland"],
    nearbyPlaces: ["cahaba-river-national-wildlife-refuge-near-birmingham-al", "chattahoochee-river-recreation-area-near-atlanta", "columbia-river-gorge-near-portland", "cuyahoga-valley-national-park-near-cleveland", "kankakee-river-state-park-near-chicago", "mississippi-river-recreation-area-near-minneapolis"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Aarhus groups 10 nearby places across 6 cities for local-first day and weekend discovery — mainly nature areas, waterfronts, islands. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["aalborg", "aarhus", "esbjerg", "odense", "roskilde", "vejle"],
    nearbyPlaces: ["fano-near-esbjerg", "gudena-near-aarhus", "kalo-castle-near-aarhus", "marselisborg-forests-near-aarhus", "mols-bjerge-national-park-near-aarhus", "rebild-bakker-near-aalborg", "roskilde-fjord-near-roskilde", "stevns-klint-near-roskilde", "svanninge-bakker-near-odense", "vejle-fjord-near-vejle"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["angers", "le-mans", "nantes", "rennes", "tours"],
    nearbyPlaces: ["chateau-de-chenonceau-near-tours", "lac-de-maine-near-angers", "loire-anjou-touraine-regional-nature-park-near-angers", "normandie-maine-regional-natural-park-near-le-mans", "broceliande-forest-near-rennes", "parc-naturel-regional-de-briere-near-nantes"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Berlin groups 13 nearby places across 5 cities for local-first day and weekend discovery — mainly nature areas, mountains, parks. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["berlin", "dresden", "leipzig", "magdeburg", "potsdam"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Bilbao groups 14 nearby places across 6 cities for local-first day and weekend discovery — mainly mountains, nature areas, waterfronts. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["bilbao", "burgos", "logrono", "pamplona", "san-sebastian", "santander"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Birmingham groups 9 nearby places across 5 cities for local-first day and weekend discovery — mainly nature areas, parks, mountains. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["birmingham", "derby", "leicester", "stoke-on-trent", "wolverhampton"],
    nearbyPlaces: ["bradgate-park-near-leicester", "cannock-chase-near-birmingham", "clent-hills-near-birmingham", "malvern-hills-near-birmingham", "peak-district-national-park-near-derby", "the-national-forest-near-derby", "tittesworth-reservoir-near-stoke-on-trent", "wenlock-edge-near-wolverhampton", "wyre-forest-near-birmingham"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Bruges groups 8 nearby places across 4 cities for local-first day and weekend discovery — mainly beaches, nature areas, cultural sites. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["bruges", "charleroi", "namur", "ostend"],
    nearbyPlaces: ["blankenberge-near-bruges", "citadel-of-namur-near-namur", "eau-d-heure-lakes-near-charleroi", "knokke-heist-near-bruges", "nieuwpoort-near-bruges", "sonian-forest-near-charleroi", "yser-near-ostend", "zwin-near-bruges"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Budapest groups 7 nearby places across 3 cities for local-first day and weekend discovery — mainly parks, nature areas, lakes. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["budapest", "miskolc", "pecs"],
    nearbyPlaces: ["aggtelek-national-park-near-miskolc", "bukk-national-park-near-budapest", "danube-ipoly-national-park-near-budapest", "lake-balaton-near-budapest", "mecsek-near-pecs", "orfu-near-pecs", "tihany-near-budapest"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Chemnitz groups 6 nearby places across 3 cities for local-first day and weekend discovery — mainly nature areas, mountains, lakes. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["chemnitz", "erfurt", "gorlitz"],
    nearbyPlaces: ["berzdorfer-see-near-gorlitz", "hainich-national-park-near-erfurt", "ore-mountains-vogtland-nature-park-near-chemnitz", "thuringian-forest-near-erfurt", "zittau-mountains-near-gorlitz", "zschopau-near-chemnitz"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Cologne groups 9 nearby places across 6 cities for local-first day and weekend discovery — mainly nature areas, parks, lakes. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["aachen", "bochum", "bonn", "cologne", "dusseldorf", "essen"],
    nearbyPlaces: ["arnsberg-forest-nature-park-near-bochum", "eifel-national-park-near-aachen", "hambach-forest-near-cologne", "hohe-mark-nature-park-near-bochum", "neandertal-near-dusseldorf", "rhineland-nature-park-near-cologne", "rur-reservoir-near-aachen", "siebengebirge-near-bonn", "zollverein-coal-mine-industrial-complex-near-essen"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Dublin groups 8 nearby places across 4 cities for local-first day and weekend discovery — mainly mountains, parks, cultural sites. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["athlone", "drogheda", "dublin", "swords"],
    nearbyPlaces: ["bru-na-boinne-near-drogheda", "bull-island-near-dublin", "clara-bog-near-athlone", "cooley-mountains-near-drogheda", "glendalough-near-dublin", "phoenix-park-dublin", "slieve-bloom-mountains-near-athlone", "wicklow-mountains-national-park-near-swords"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Durham groups 5 nearby places across 4 cities for local-first day and weekend discovery — mainly nature areas, beaches, islands. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["durham", "kingston-upon-hull", "sunderland", "york"],
    nearbyPlaces: ["durham-coast-near-durham", "marsden-rock-near-sunderland", "north-pennines-near-durham", "north-york-moors-national-park-near-york", "spurn-near-kingston-upon-hull"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["bologna", "florence", "lucca", "pisa", "rimini", "siena"],
    nearbyPlaces: ["alpi-apuane-near-lucca", "comacchio-valleys-near-bologna", "furlo-pass-near-rimini", "garfagnana-near-lucca", "gessi-bolognesi-park-near-bologna", "lake-bilancino-near-florence", "lake-massaciuccoli-near-pisa", "monti-del-chianti-near-florence", "val-d-orcia-near-siena", "vallombrosa-near-florence"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Freiburg groups 12 nearby places across 4 cities for local-first day and weekend discovery — mainly nature areas, mountains, lakes. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["freiburg", "konstanz", "saarbrucken", "stuttgart"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["annecy", "avignon", "chambery", "grenoble", "lyon", "saint-etienne"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["bremen", "hamburg", "hanover", "kiel", "lubeck", "wolfsburg"],
    nearbyPlaces: ["elm-lappwald-nature-park-near-wolfsburg", "holstein-switzerland-near-hamburg", "kiel-fjord-near-kiel", "lubeck-near-hamburg", "neuwerk-near-hamburg", "schaalsee-near-hamburg", "steinhuder-meer-near-hanover", "teufelsmoor-near-bremen", "travemunde-near-lubeck"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Helsinki groups 11 nearby places across 5 cities for local-first day and weekend discovery — mainly islands, nature areas, parks. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["helsinki", "lahti", "tampere", "turku", "vantaa"],
    nearbyPlaces: ["archipelago-national-park-near-turku", "helvetinjarvi-national-park-near-tampere", "isojarvi-national-park-near-tampere", "liesjarvi-national-park-near-helsinki", "nuuksio-national-park-near-helsinki", "paijanne-national-park-near-lahti", "repovesi-national-park-near-lahti", "seitseminen-national-park-near-tampere", "sipoonkorpi-national-park-near-vantaa", "suomenlinna-helsinki", "tammisaari-archipelago-national-park-near-helsinki"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Krakow groups 9 nearby places across 5 cities for local-first day and weekend discovery — mainly mountains, nature areas, cultural sites. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["czestochowa", "gliwice", "katowice", "krakow", "zakopane"],
    nearbyPlaces: ["beskids-near-krakow", "eagle-nests-landscape-park-near-katowice", "gorce-national-park-near-zakopane", "ojcow-national-park-near-czestochowa", "pieniny-near-krakow", "pieskowa-skaa-near-czestochowa", "pszczyna-near-gliwice", "tatra-mountains-near-krakow", "tatra-national-park-near-zakopane"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Lisbon groups 8 nearby places across 3 cities for local-first day and weekend discovery — mainly nature areas, lakes, waterfronts. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["evora", "lisbon", "setubal"],
    nearbyPlaces: ["alqueva-dam-near-evora", "arrabida-natural-park-near-setubal", "cascais-near-lisbon", "costa-da-caparica-near-lisbon", "sado-estuary-natural-reserve-near-setubal", "serra-de-sao-mamede-near-evora", "sintra-near-lisbon", "tagus-estuary-natural-reserve-near-lisbon"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Liverpool groups 13 nearby places across 6 cities for local-first day and weekend discovery — mainly nature areas, parks, lakes. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["bradford", "lancaster", "leeds", "liverpool", "manchester", "sheffield"],
    nearbyPlaces: ["arnside-and-silverdale-national-landscape-near-lancaster", "delamere-forest-near-liverpool", "dovestone-reservoir-near-manchester", "formby-near-liverpool", "hilbre-island-near-liverpool", "ilkley-moor-near-bradford", "lyme-park-near-manchester", "peak-district-national-park-near-bradford", "peak-district-near-manchester", "rivington-near-manchester", "thurstaston-common-near-liverpool", "yorkshire-dales-near-lancaster", "yorkshire-dales-near-leeds"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Ljubljana groups 6 nearby places across 3 cities for local-first day and weekend discovery — mainly mountains, lakes, nature areas. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["celje", "kranj", "ljubljana"],
    nearbyPlaces: ["kamniksavinja-alps-near-celje", "lake-bled-near-kranj", "lake-bohinj-near-ljubljana", "pohorje-near-celje", "triglav-national-park-near-kranj", "vipava-valley-near-ljubljana"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["brighton", "cambridge", "london", "oxford", "portsmouth", "southampton"],
    nearbyPlaces: ["brighton-near-london", "cotswolds-near-oxford", "hayling-island-near-portsmouth", "hyde-park-london", "greenwich-london", "new-forest-national-park-near-southampton", "richmond-park-london", "kew-gardens-london", "south-downs-national-park-near-brighton", "wicken-fen-near-cambridge", "windsor-near-london"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Malaga groups 10 nearby places across 4 cities for local-first day and weekend discovery — mainly parks, nature areas, mountains. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["almeria", "cadiz", "granada", "malaga"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Montreal groups 11 nearby places across 5 cities for local-first day and weekend discovery — mainly nature areas, parks, lakes. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["gatineau", "laval", "montreal", "ottawa", "sherbrooke"],
    nearbyPlaces: ["foy-provincial-park-near-ottawa", "gatineau-park-near-ottawa", "lake-memphremagog-near-sherbrooke", "larose-forest-near-ottawa", "mer-bleue-bog-near-ottawa", "mont-orford-national-park-near-sherbrooke", "mont-tremblant-national-park-near-montreal", "oka-national-park-near-laval", "ottawa-river-near-gatineau", "plaisance-national-park-near-gatineau", "iles-de-boucherville-national-park-near-laval"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Naples groups 5 nearby places across 2 cities for local-first day and weekend discovery — mainly waterfronts, mountains, islands. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["naples", "salerno"],
    nearbyPlaces: ["amalfi-coast-near-salerno", "ischia-near-naples", "matese-regional-park-near-naples", "sorrentine-peninsula-near-naples", "vesuvius-national-park-near-naples"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near New York groups 10 nearby places across 5 cities for local-first day and weekend discovery — mainly parks, nature areas, beaches. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["hartford", "new-haven", "new-york", "newark", "philadelphia"],
    nearbyPlaces: ["great-swamp-national-wildlife-refuge-near-newark", "hammonasset-beach-state-park-near-new-haven", "harriman-state-park-near-new-york", "hudson-valley-near-new-york", "jamaica-bay-wildlife-refuge-near-new-york", "jones-beach-state-park-near-new-york", "penwood-state-park-near-hartford", "south-mountain-reservation-near-newark", "talcott-mountain-state-park-near-hartford", "valley-forge-national-historical-park-near-philadelphia"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Norwich groups 5 nearby places across 3 cities for local-first day and weekend discovery — mainly nature areas, lakes, parks. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["lincoln", "norwich", "nottingham"],
    nearbyPlaces: ["carsington-water-near-nottingham", "hartsholme-country-park-near-lincoln", "norfolk-coast-near-norwich", "peak-district-near-nottingham", "thetford-forest-near-norwich"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Paris groups 9 nearby places across 4 cities for local-first day and weekend discovery — mainly cultural sites, nature areas, parks. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["orleans", "paris", "reims", "rouen"],
    nearbyPlaces: ["brenne-regional-natural-park-near-orleans", "champagne-hillsides-houses-and-cellars-near-reims", "chantilly-near-paris", "fontainebleau-near-paris", "forest-of-orleans-near-orleans", "foret-de-rambouillet-near-paris", "haute-vallee-de-chevreuse-regional-natural-park-near-paris", "versailles-near-paris", "etretat-near-rouen"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Porto groups 7 nearby places across 5 cities for local-first day and weekend discovery — mainly waterfronts, nature areas, weekend places. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["aveiro", "braga", "guimaraes", "porto", "viana-do-castelo"],
    nearbyPlaces: ["douro-valley-near-porto", "alvao-natural-park-near-porto", "costa-nova-do-prado-near-aveiro", "cavado-river-near-guimaraes", "douro-international-natural-park-near-porto", "lima-river-near-viana-do-castelo", "peneda-geres-national-park-near-braga"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Prague groups 8 nearby places across 4 cities for local-first day and weekend discovery — mainly nature areas, mountains, cultural sites. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["hradec-kralove", "karlovy-vary", "liberec", "prague"],
    nearbyPlaces: ["adrspach-teplice-rocks-near-hradec-kralove", "bohemian-switzerland-near-prague", "jested-near-liberec", "karlstejn-near-prague", "koneprusy-caves-near-prague", "ore-mountains-near-karlovy-vary", "orlicke-mountains-near-hradec-kralove", "slavkov-forest-near-karlovy-vary"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Queenstown groups 6 nearby places across 3 cities for local-first day and weekend discovery — mainly lakes, parks, waterfronts. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["dunedin", "invercargill", "queenstown"],
    nearbyPlaces: ["fiordland-national-park-near-invercargill", "lake-hayes-near-queenstown", "moke-lake-near-queenstown", "otago-peninsula-near-dunedin", "the-catlins-near-invercargill", "the-remarkables-near-queenstown"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Rome groups 6 nearby places across 3 cities for local-first day and weekend discovery — mainly lakes, nature areas, parks. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["laquila", "perugia", "rome"],
    nearbyPlaces: ["bracciano-lake-near-rome", "circeo-national-park-near-rome", "gran-sasso-and-monti-della-laga-national-park-near-laquila", "lake-trasimeno-near-perugia", "maiella-national-park-near-laquila", "tivoli-near-rome"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Rotterdam groups 7 nearby places across 5 cities for local-first day and weekend discovery — mainly nature areas, historic towns, cultural sites. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["breda", "delft", "eindhoven", "rotterdam", "s-hertogenbosch"],
    nearbyPlaces: ["de-biesbosch-national-park-near-delft", "groote-peel-national-park-near-eindhoven", "de-loonse-en-drunense-duinen-national-park-near-s-hertogenbosch", "delft-near-rotterdam", "kinderdijk-near-rotterdam", "mastbos-near-breda", "midden-delfland-near-delft"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Seattle groups 6 nearby places across 3 cities for local-first day and weekend discovery — mainly parks, waterfronts, beaches. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["bellingham", "seattle", "tacoma"],
    nearbyPlaces: ["deception-pass-state-park-near-seattle", "larrabee-state-park-near-bellingham", "mount-rainier-national-park-near-tacoma", "north-cascades-national-park-near-bellingham", "olympic-national-park-near-tacoma", "wallace-falls-state-park-near-seattle"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Stockholm groups 10 nearby places across 5 cities for local-first day and weekend discovery — mainly nature areas, islands, waterfronts. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["linkoping", "norrkoping", "orebro", "stockholm", "uppsala"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["metz", "strasbourg"],
    nearbyPlaces: ["lac-blanc-near-strasbourg", "lac-de-madine-near-metz", "lorraine-regional-natural-park-near-metz", "mont-sainte-odile-near-strasbourg", "northern-vosges-regional-park-near-strasbourg", "vosges-near-strasbourg"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Tallinn groups 7 nearby places across 4 cities for local-first day and weekend discovery — mainly parks, islands, lakes. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["kohtla-jarve", "parnu", "tallinn", "tartu"],
    nearbyPlaces: ["aegna-near-tallinn", "alutaguse-national-park-near-kohtla-jarve", "kihnu-near-parnu", "lahemaa-national-park-near-kohtla-jarve", "lake-peipus-near-tartu", "matsalu-national-park-near-tallinn", "soomaa-national-park-near-parnu"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Venice groups 12 nearby places across 5 cities for local-first day and weekend discovery — mainly nature areas, mountains, beaches. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["ferrara", "padua", "udine", "venice", "verona"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Vilnius groups 8 nearby places across 3 cities for local-first day and weekend discovery — mainly parks, lakes, nature areas. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["kaunas", "panevezys", "vilnius"],
    nearbyPlaces: ["anyksciai-regional-park-near-panevezys", "asveja-near-vilnius", "birzai-regional-park-near-panevezys", "dzukija-national-park-near-vilnius", "kaunas-reservoir-near-kaunas", "kauno-marios-regional-park-near-kaunas", "trakai-historical-national-park-near-vilnius", "verkiai-regional-park-near-vilnius"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Warsaw groups 8 nearby places across 4 cities for local-first day and weekend discovery — mainly nature areas, lakes, parks. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["kielce", "lodz", "lublin", "warsaw"],
    nearbyPlaces: ["kabaty-woods-near-warsaw", "kampinos-national-park-near-warsaw", "masovian-landscape-park-near-warsaw", "roztocze-national-park-near-lublin", "zegrze-reservoir-near-warsaw", "lodz-hills-landscape-park-near-lodz", "swietokrzyski-national-park-near-kielce", "swietokrzyskie-mountains-near-kielce"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Wellington groups 7 nearby places across 4 cities for local-first day and weekend discovery — mainly nature areas, parks, islands. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["lower-hutt", "nelson", "palmerston-north", "wellington"],
    nearbyPlaces: ["abel-tasman-national-park-near-nelson", "belmont-regional-park-near-lower-hutt", "kapiti-island-near-wellington", "remutaka-forest-park-near-wellington", "tararua-forest-park-near-palmerston-north", "tararua-forest-park-near-wellington", "zealandia-near-wellington"],
  ...
  },
  {
    ...
    description:
      "Western Europe Lakes groups 5 nearby places across 5 cities for local-first day and weekend discovery — mainly lakes. This is a geographic discovery collection derived from lake-district geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "lake_region",
    cities: ["almere", "angers", "charleroi", "limoges", "metz"],
    nearbyPlaces: ["eau-d-heure-lakes-near-charleroi", "lac-de-madine-near-metz", "lac-de-maine-near-angers", "lac-de-vassiviere-near-limoges", "markermeer-near-almere"],
  ...
  },
  {
    ...
    description:
      "Western Europe Protected Landscapes groups 9 nearby places across 8 cities for local-first day and weekend discovery — mainly parks, nature areas. This is a geographic discovery collection derived from a shared protected landscape; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "protected_landscape_region",
    cities: ["almere", "angers", "coventry", "le-mans", "limoges", "metz", "orleans", "saint-etienne"],
    nearbyPlaces: ["brenne-regional-natural-park-near-orleans", "livradois-forez-regional-natural-park-near-saint-etienne", "loire-anjou-touraine-regional-nature-park-near-angers", "lorraine-regional-natural-park-near-metz", "normandie-maine-regional-natural-park-near-le-mans", "pilat-regional-natural-park-near-saint-etienne", "perigord-limousin-regional-natural-park-near-limoges", "oostvaardersplassen-near-almere", "cannock-chase-near-coventry"],
  ...
  },
  {
    ...
    description:
      "Western Europe Weekend Escapes groups 27 nearby places across 15 cities for local-first day and weekend discovery — mainly nature areas, parks, lakes. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
