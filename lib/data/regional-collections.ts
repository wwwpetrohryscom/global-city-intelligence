...
export const REGIONAL_DISCOVERY_COLLECTIONS: readonly RegionalCollection[] = [
  ...
  },
  {
    ...
    description:
      "Austria–Czechia Borderlands groups 9 nearby places across 4 cities for local-first day and weekend discovery — mainly nature areas, mountains. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["brno", "ceske-budejovice", "sankt-polten", "vienna"],
    nearbyPlaces: ["dunkelsteinerwald-near-sankt-polten", "hohe-wand-near-vienna", "wachau-near-sankt-polten", "podyji-national-park-near-brno", "trebon-basin-near-ceske-budejovice", "hohe-wand-near-sankt-polten", "otscher-near-sankt-polten", "traisen-near-sankt-polten", "vienna-woods-near-sankt-polten"],
  ...
  },
  {
    ...
    description:
      "Austria Mountains groups 9 nearby places across 6 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["graz", "innsbruck", "klagenfurt", "salzburg", "vienna", "villach"],
    nearbyPlaces: ["dobratsch-near-villach", "gesause-national-park-near-graz", "hohe-wand-near-vienna", "karawanks-near-klagenfurt", "karwendel-near-innsbruck", "patscherkofel-near-innsbruck", "schockl-near-graz", "untersberg-near-salzburg", "julian-alps-near-villach"],
  ...
  },
  {
    ...
    description:
      "Belgium–Netherlands Borderlands groups 22 nearby places across 10 cities for local-first day and weekend discovery — mainly nature areas, parks. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
  ...
  },
  {
    ...
    description:
      "Central Europe Mountains groups 11 nearby places across 6 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["celje", "hradec-kralove", "kielce", "magdeburg", "opole", "villach"],
    nearbyPlaces: ["dobratsch-near-villach", "orlicke-mountains-near-hradec-kralove", "harz-near-magdeburg", "saint-anne-mountain-near-opole", "swietokrzyskie-mountains-near-kielce", "kamniksavinja-alps-near-celje", "pohorje-near-celje", "brocken-near-magdeburg", "donacka-gora-near-celje", "julian-alps-near-villach", "kuneticka-hora-near-hradec-kralove"],
  ...
  },
  {
    ...
    description:
      "Croatia–Slovenia Borderlands groups 7 nearby places across 4 cities for local-first day and weekend discovery — mainly mountains, nature areas. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["celje", "ljubljana", "rijeka", "zagreb"],
    nearbyPlaces: ["medvednica-nature-park-near-zagreb", "risnjak-national-park-near-rijeka", "kamniksavinja-alps-near-celje", "pohorje-near-celje", "vipava-valley-near-ljubljana", "donacka-gora-near-celje", "savinja-near-celje"],
  ...
  },
  {
    ...
    description:
      "Czechia–Germany Borderlands groups 27 nearby places across 12 cities for local-first day and weekend discovery — mainly nature areas, mountains. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
  ...
  },
  {
    ...
    description:
      "Czechia Mountains groups 6 nearby places across 5 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["brno", "hradec-kralove", "karlovy-vary", "liberec", "ostrava"],
    nearbyPlaces: ["beskydy-protected-area-near-ostrava", "jested-near-liberec", "ore-mountains-near-karlovy-vary", "orlicke-mountains-near-hradec-kralove", "white-carpathians-near-brno", "kuneticka-hora-near-hradec-kralove"],
  ...
  },
  {
    ...
    title: "Eastern Alps",
    description:
      "Eastern Alps groups 6 nearby places across 5 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["bolzano", "celje", "innsbruck", "klagenfurt", "verona"],
    nearbyPlaces: ["karawanks-near-klagenfurt", "karwendel-near-innsbruck", "dolomites-near-bolzano", "lessinia-regional-park-near-verona", "kamniksavinja-alps-near-celje", "donacka-gora-near-celje"],
  ...
  },
  {
    ...
    description:
      "European Coast groups 18 nearby places across 15 cities for local-first day and weekend discovery — mainly beaches. This is a geographic discovery collection derived from a shared coastline; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "coastal_region",
  ...
  },
  {
    ...
    title: "France Lakes",
    description:
      "France Lakes groups 12 nearby places across 10 cities for local-first day and weekend discovery — mainly lakes. This is a geographic discovery collection derived from lake-district geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "lake_region",
    cities: ["angers", "annecy", "besancon", "chambery", "clermont-ferrand", "grenoble", "limoges", "metz", "nice", "strasbourg"],
    nearbyPlaces: ["lac-blanc-near-strasbourg", "lac-pavin-near-clermont-ferrand", "lac-de-madine-near-metz", "lac-de-maine-near-angers", "lac-de-monteynard-avignonet-near-grenoble", "lac-de-saint-cassien-near-nice", "lac-de-saint-point-near-besancon", "lac-de-vassiviere-near-limoges", "lac-du-bourget-near-chambery", "lake-annecy-near-annecy", "lake-of-sainte-croix-near-nice", "lake-der-chantecoq-near-metz"],
  ...
  },
  {
    ...
    description:
      "Germany–Luxembourg Borderlands groups 13 nearby places across 5 cities for local-first day and weekend discovery — mainly nature areas, parks. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
  ...
  },
  {
    ...
    description:
      "Germany Mountains groups 18 nearby places across 12 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
  ...
  },
  {
    ...
    description:
      "Greece Mountains groups 11 nearby places across 6 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["athens", "heraklion", "ioannina", "kavala", "larissa", "volos"],
    nearbyPlaces: ["mount-geraneia-near-athens", "mount-hymettus-near-athens", "mount-ida-crete-near-heraklion", "mount-ossa-near-larissa", "mount-pangaion-near-kavala", "mount-pelion-near-volos", "mount-parnitha-near-athens", "tymfi-near-ioannina", "antichasia-mountains-near-larissa", "mount-olympus-near-larissa", "pelion-near-larissa"],
  ...
  },
  {
    ...
    description:
      "Greece Weekend Escapes groups 16 nearby places across 5 cities for local-first day and weekend discovery — mainly mountains, lakes, nature areas. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["chania", "heraklion", "ioannina", "kavala", "larissa"],
    nearbyPlaces: ["lake-kournas-near-chania", "lake-pamvotida-near-ioannina", "mount-ida-crete-near-heraklion", "mount-ossa-near-larissa", "mount-pangaion-near-kavala", "samaria-gorge-near-chania", "tymfi-near-ioannina", "vale-of-tempe-near-larissa", "antichasia-mountains-near-larissa", "falasarna-near-chania", "frangokastello-near-chania", "gramvousa-near-chania", "lake-karla-near-larissa", "lefka-ori-near-chania", "mount-olympus-near-larissa", "pelion-near-larissa"],
  ...
  },
  {
    ...
    description:
      "Hungary–Poland Borderlands groups 9 nearby places across 3 cities for local-first day and weekend discovery — mainly mountains, parks. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["krakow", "miskolc", "zakopane"],
    nearbyPlaces: ["aggtelek-national-park-near-miskolc", "beskids-near-krakow", "pieniny-near-krakow", "tatra-mountains-near-krakow", "tatra-national-park-near-zakopane", "bukk-mountains-near-miskolc", "hortobagy-national-park-near-miskolc", "lake-tisza-near-miskolc", "zemplen-mountains-near-miskolc"],
  ...
  },
  {
    ...
    description:
      "Ireland Weekend Escapes groups 13 nearby places across 5 cities for local-first day and weekend discovery — mainly parks, mountains, waterfronts. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["dublin", "dundalk", "letterkenny", "swords", "westport"],
    nearbyPlaces: ["connemara-national-park-near-westport", "cooley-mountains-near-dundalk", "lough-swilly-near-letterkenny", "north-bull-island-near-swords", "wicklow-mountains-near-dublin", "cuilcagh-near-dundalk", "howth-head-near-swords", "ireland-s-eye-near-swords", "malahide-near-swords", "mourne-mountains-near-dundalk", "ravensdale-near-dundalk", "rogerstown-estuary-near-swords", "slieve-foye-near-dundalk"],
  ...
  },
  {
    ...
    title: "Italy Coast",
    description:
      "Italy Coast groups 8 nearby places across 5 cities for local-first day and weekend discovery — mainly waterfronts, beaches. This is a geographic discovery collection derived from a shared coastline; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "coastal_region",
    cities: ["cagliari", "naples", "salerno", "taranto", "venice"],
    nearbyPlaces: ["amalfi-coast-near-salerno", "cavallino-treporti-near-venice", "gulf-of-taranto-near-taranto", "poetto-near-cagliari", "sorrentine-peninsula-near-naples", "cape-palinuro-near-salerno", "cheradi-islands-near-taranto", "porto-cesareo-near-taranto"],
  ...
  },
  {
    ...
    description:
      "Italy Mountains groups 22 nearby places across 14 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["aosta", "bolzano", "catania", "como", "laquila", "lucca", "naples", "palermo", "reggio-emilia", "trento", "turin", "udine", "venice", "verona"],
    nearbyPlaces: ["alpi-apuane-near-lucca", "appennino-tosco-emiliano-national-park-near-reggio-emilia", "carnic-alps-near-udine", "dolomites-near-bolzano", "dolomiti-bellunesi-national-park-near-venice", "gran-paradiso-national-park-near-turin", "lessinia-regional-park-near-verona", "madonie-park-near-palermo", "maiella-national-park-near-laquila", "maritime-alps-natural-park-near-turin", "matese-regional-park-near-naples", "mont-blanc-near-aosta", "monte-baldo-near-verona", "monte-cusna-near-reggio-emilia", "monte-generoso-near-como", "mount-etna-near-catania", "orsiera-rocciavre-natural-park-near-turin", "paganella-near-trento", "vesuvius-national-park-near-naples", "alpe-di-succiso-near-reggio-emilia", "monte-cimone-near-reggio-emilia", "pietra-di-bismantova-near-reggio-emilia"],
  ...
  },
  {
    ...
    description:
      "Italy–Slovenia Borderlands groups 7 nearby places across 4 cities for local-first day and weekend discovery — mainly mountains, nature areas, parks. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["celje", "kranj", "ljubljana", "udine"],
    nearbyPlaces: ["carnic-alps-near-udine", "julian-prealps-natural-park-near-udine", "kamniksavinja-alps-near-celje", "triglav-national-park-near-kranj", "vipava-valley-near-ljubljana", "donacka-gora-near-celje", "savinja-near-celje"],
  ...
  },
  {
    ...
    description:
      "Portugal Protected Landscapes groups 9 nearby places across 6 cities for local-first day and weekend discovery — mainly nature areas. This is a geographic discovery collection derived from a shared protected landscape; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "protected_landscape_region",
    cities: ["braganca", "faro", "funchal", "lisbon", "porto", "setubal"],
    nearbyPlaces: ["alvao-natural-park-near-porto", "arrabida-natural-park-near-setubal", "douro-international-natural-park-near-porto", "montesinho-natural-park-near-braganca", "ponta-de-sao-lourenco-near-funchal", "ria-formosa-natural-park-near-faro", "sado-estuary-natural-reserve-near-setubal", "tagus-estuary-natural-reserve-near-lisbon", "sintra-cascais-natural-park-near-setubal"],
  ...
  },
  {
    ...
    description:
      "Portugal Weekend Escapes groups 11 nearby places across 7 cities for local-first day and weekend discovery — mainly nature areas, mountains. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["braganca", "coimbra", "faro", "funchal", "guimaraes", "vila-nova-de-gaia", "viseu"],
    nearbyPlaces: ["alvao-natural-park-near-vila-nova-de-gaia", "montesinho-natural-park-near-braganca", "peneda-geres-national-park-near-guimaraes", "ponta-de-sao-lourenco-near-funchal", "ria-formosa-natural-park-near-faro", "serra-da-estrela-natural-park-near-viseu", "bucaco-forest-near-coimbra", "ria-de-aveiro-near-vila-nova-de-gaia", "serra-da-estrela-near-vila-nova-de-gaia", "serra-do-bucaco-near-vila-nova-de-gaia", "serra-do-marao-near-vila-nova-de-gaia"],
  ...
  },
  {
    ...
    description:
      "Romania Mountains groups 8 nearby places across 7 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["baia-mare", "brasov", "bucharest", "cluj-napoca", "galati", "iasi", "sibiu"],
    nearbyPlaces: ["bucegi-natural-park-near-bucharest", "ceahlau-massif-near-iasi", "cindrel-mountains-near-sibiu", "fagaras-mountains-near-cluj-napoca", "macin-mountains-near-galati", "piatra-craiului-national-park-near-brasov", "rodna-mountains-near-baia-mare", "vrancea-mountains-near-galati"],
  ...
  },
  {
    ...
    description:
      "Southern Europe Protected Landscapes groups 20 nearby places across 7 cities for local-first day and weekend discovery — mainly nature areas, parks. This is a geographic discovery collection derived from a shared protected landscape; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "protected_landscape_region",
  ...
  },
  {
    ...
    description:
      "Spain Mountains groups 22 nearby places across 15 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
  ...
  },
  {
    ...
    description:
      "Spain Protected Landscapes groups 25 nearby places across 14 cities for local-first day and weekend discovery — mainly nature areas, parks. This is a geographic discovery collection derived from a shared protected landscape; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "protected_landscape_region",
  ...
  },
  {
    ...
    description:
      "United States Coast groups 14 nearby places across 12 cities for local-first day and weekend discovery — mainly beaches, waterfronts. This is a geographic discovery collection derived from a shared coastline; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "coastal_region",
  ...
  },
  {
    ...
    description:
      "United States Mountains groups 22 nearby places across 15 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Bilbao groups 18 nearby places across 6 cities for local-first day and weekend discovery — mainly mountains, nature areas, waterfronts. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Bruges groups 12 nearby places across 4 cities for local-first day and weekend discovery — mainly beaches, nature areas, cultural sites. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["bruges", "charleroi", "namur", "ostend"],
    nearbyPlaces: ["blankenberge-near-bruges", "citadel-of-namur-near-namur", "eau-d-heure-lakes-near-charleroi", "knokke-heist-near-bruges", "nieuwpoort-near-bruges", "sonian-forest-near-charleroi", "yser-near-ostend", "zwin-near-bruges", "ardennes-near-charleroi", "lesse-near-charleroi", "marche-les-dames-near-charleroi", "sambre-near-charleroi"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Dublin groups 16 nearby places across 4 cities for local-first day and weekend discovery — mainly mountains, parks, cultural sites. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["athlone", "drogheda", "dublin", "swords"],
    nearbyPlaces: ["bru-na-boinne-near-drogheda", "bull-island-near-dublin", "clara-bog-near-athlone", "cooley-mountains-near-drogheda", "glendalough-near-dublin", "phoenix-park-dublin", "slieve-bloom-mountains-near-athlone", "wicklow-mountains-national-park-near-swords", "bettystown-near-drogheda", "clogherhead-near-drogheda", "hill-of-tara-near-drogheda", "howth-head-near-swords", "ireland-s-eye-near-swords", "loughcrew-near-drogheda", "malahide-near-swords", "rogerstown-estuary-near-swords"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Durham groups 8 nearby places across 4 cities for local-first day and weekend discovery — mainly nature areas, beaches, islands. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["durham", "kingston-upon-hull", "sunderland", "york"],
    nearbyPlaces: ["durham-coast-near-durham", "marsden-rock-near-sunderland", "north-pennines-near-durham", "north-york-moors-national-park-near-york", "spurn-near-kingston-upon-hull", "castle-eden-dene-near-sunderland", "roker-near-sunderland", "whitburn-near-sunderland"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Freiburg groups 15 nearby places across 4 cities for local-first day and weekend discovery — mainly nature areas, mountains, lakes. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Grenoble groups 17 nearby places across 6 cities for local-first day and weekend discovery — mainly mountains, lakes, nature areas. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Lisbon groups 12 nearby places across 3 cities for local-first day and weekend discovery — mainly nature areas, lakes, waterfronts. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["evora", "lisbon", "setubal"],
    nearbyPlaces: ["alqueva-dam-near-evora", "arrabida-natural-park-near-setubal", "cascais-near-lisbon", "costa-da-caparica-near-lisbon", "sado-estuary-natural-reserve-near-setubal", "serra-de-sao-mamede-near-evora", "sintra-near-lisbon", "tagus-estuary-natural-reserve-near-lisbon", "cape-espichel-near-setubal", "costa-da-caparica-near-setubal", "sintra-cascais-natural-park-near-setubal", "troia-peninsula-near-setubal"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Liverpool groups 17 nearby places across 6 cities for local-first day and weekend discovery — mainly nature areas, parks, lakes. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["bradford", "lancaster", "leeds", "liverpool", "manchester", "sheffield"],
    nearbyPlaces: ["arnside-and-silverdale-national-landscape-near-lancaster", "delamere-forest-near-liverpool", "dovestone-reservoir-near-manchester", "formby-near-liverpool", "hilbre-island-near-liverpool", "ilkley-moor-near-bradford", "lyme-park-near-manchester", "peak-district-national-park-near-bradford", "peak-district-near-manchester", "rivington-near-manchester", "thurstaston-common-near-liverpool", "yorkshire-dales-near-lancaster", "yorkshire-dales-near-leeds", "bolton-abbey-near-bradford", "brimham-rocks-near-bradford", "hardcastle-crags-near-bradford", "otley-chevin-near-bradford"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Ljubljana groups 8 nearby places across 3 cities for local-first day and weekend discovery — mainly mountains, lakes, nature areas. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["celje", "kranj", "ljubljana"],
    nearbyPlaces: ["kamniksavinja-alps-near-celje", "lake-bled-near-kranj", "lake-bohinj-near-ljubljana", "pohorje-near-celje", "triglav-national-park-near-kranj", "vipava-valley-near-ljubljana", "donacka-gora-near-celje", "savinja-near-celje"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Malaga groups 18 nearby places across 4 cities for local-first day and weekend discovery — mainly parks, nature areas, mountains. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Montreal groups 14 nearby places across 5 cities for local-first day and weekend discovery — mainly nature areas, parks, lakes. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["gatineau", "laval", "montreal", "ottawa", "sherbrooke"],
    nearbyPlaces: ["foy-provincial-park-near-ottawa", "gatineau-park-near-ottawa", "lake-memphremagog-near-sherbrooke", "larose-forest-near-ottawa", "mer-bleue-bog-near-ottawa", "mont-orford-national-park-near-sherbrooke", "mont-tremblant-national-park-near-montreal", "oka-national-park-near-laval", "ottawa-river-near-gatineau", "plaisance-national-park-near-gatineau", "iles-de-boucherville-national-park-near-laval", "mont-rigaud-near-laval", "mont-rougemont-near-laval", "mont-saint-bruno-national-park-near-laval"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Naples groups 8 nearby places across 2 cities for local-first day and weekend discovery — mainly waterfronts, mountains, islands. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["naples", "salerno"],
    nearbyPlaces: ["amalfi-coast-near-salerno", "ischia-near-naples", "matese-regional-park-near-naples", "sorrentine-peninsula-near-naples", "vesuvius-national-park-near-naples", "cape-palinuro-near-salerno", "monti-lattari-near-salerno", "vesuvius-national-park-near-salerno"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Paris groups 10 nearby places across 4 cities for local-first day and weekend discovery — mainly cultural sites, nature areas, parks. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["orleans", "paris", "reims", "rouen"],
    nearbyPlaces: ["brenne-regional-natural-park-near-orleans", "champagne-hillsides-houses-and-cellars-near-reims", "chantilly-near-paris", "fontainebleau-near-paris", "forest-of-orleans-near-orleans", "foret-de-rambouillet-near-paris", "haute-vallee-de-chevreuse-regional-natural-park-near-paris", "versailles-near-paris", "etretat-near-rouen", "loing-near-orleans"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Prague groups 12 nearby places across 4 cities for local-first day and weekend discovery — mainly nature areas, mountains, cultural sites. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["hradec-kralove", "karlovy-vary", "liberec", "prague"],
    nearbyPlaces: ["adrspach-teplice-rocks-near-hradec-kralove", "bohemian-switzerland-near-prague", "jested-near-liberec", "karlstejn-near-prague", "koneprusy-caves-near-prague", "ore-mountains-near-karlovy-vary", "orlicke-mountains-near-hradec-kralove", "slavkov-forest-near-karlovy-vary", "broumovsko-protected-landscape-area-near-hradec-kralove", "kuneticka-hora-near-hradec-kralove", "orlice-near-hradec-kralove", "prachov-rocks-near-hradec-kralove"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Vilnius groups 12 nearby places across 3 cities for local-first day and weekend discovery — mainly parks, lakes, nature areas. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["kaunas", "panevezys", "vilnius"],
    nearbyPlaces: ["anyksciai-regional-park-near-panevezys", "asveja-near-vilnius", "birzai-regional-park-near-panevezys", "dzukija-national-park-near-vilnius", "kaunas-reservoir-near-kaunas", "kauno-marios-regional-park-near-kaunas", "trakai-historical-national-park-near-vilnius", "verkiai-regional-park-near-vilnius", "grazute-regional-park-near-panevezys", "labanoras-regional-park-near-panevezys", "lake-sartai-near-panevezys", "lake-tauragnas-near-panevezys"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Wellington groups 9 nearby places across 4 cities for local-first day and weekend discovery — mainly nature areas, parks, islands. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["lower-hutt", "nelson", "palmerston-north", "wellington"],
    nearbyPlaces: ["abel-tasman-national-park-near-nelson", "belmont-regional-park-near-lower-hutt", "kapiti-island-near-wellington", "remutaka-forest-park-near-wellington", "tararua-forest-park-near-palmerston-north", "tararua-forest-park-near-wellington", "zealandia-near-wellington", "kapiti-island-near-lower-hutt", "pakuratahi-forest-near-lower-hutt"],
  ...
  },
  {
    ...
    description:
      "Western Europe Lakes groups 6 nearby places across 5 cities for local-first day and weekend discovery — mainly lakes. This is a geographic discovery collection derived from lake-district geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "lake_region",
    cities: ["almere", "angers", "charleroi", "limoges", "metz"],
    nearbyPlaces: ["eau-d-heure-lakes-near-charleroi", "lac-de-madine-near-metz", "lac-de-maine-near-angers", "lac-de-vassiviere-near-limoges", "markermeer-near-almere", "lake-der-chantecoq-near-metz"],
