...
export const REGIONAL_DISCOVERY_COLLECTIONS: readonly RegionalCollection[] = [
  ...
  },
  {
    ...
    description:
      "Austria Mountains groups 12 nearby places across 7 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["graz", "innsbruck", "klagenfurt", "salzburg", "vienna", "villach", "linz"],
    nearbyPlaces: ["dobratsch-near-villach", "gesause-national-park-near-graz", "hohe-wand-near-vienna", "karawanks-near-klagenfurt", "karwendel-near-innsbruck", "patscherkofel-near-innsbruck", "schockl-near-graz", "untersberg-near-salzburg", "julian-alps-near-villach", "hollengebirge-near-linz", "sengsengebirge-near-linz", "traunstein-near-linz"],
  ...
  },
  {
    ...
    description:
      "Baltic Sea Coast groups 7 nearby places across 7 cities for local-first day and weekend discovery — mainly islands, beaches. This is a geographic discovery collection derived from a shared coastline; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "coastal_region",
    cities: ["helsinki", "lubeck", "parnu", "tallinn", "umea", "visby", "espoo"],
    nearbyPlaces: ["aegna-near-tallinn", "kihnu-near-parnu", "suomenlinna-helsinki", "travemunde-near-lubeck", "gotska-sandon-national-park-near-visby", "holmoarna-near-umea", "porkkalanniemi-near-espoo"],
  ...
  },
  {
    ...
    description:
      "Canada Islands groups 8 nearby places across 8 cities for local-first day and weekend discovery — mainly islands. This is a geographic discovery collection derived from island geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "island_region",
    cities: ["laval", "nanaimo", "quebec-city", "st-johns", "toronto", "victoria", "windsor-ontario", "montreal"],
    nearbyPlaces: ["pelee-island-near-windsor-ontario", "salt-spring-island-near-victoria", "saysutshun-newcastle-island-marine-park-near-nanaimo", "toronto-islands-near-toronto", "witless-bay-ecological-reserve-near-st-johns", "ile-d-orleans-near-quebec-city", "iles-de-boucherville-national-park-near-laval", "iles-de-boucherville-national-park-near-montreal"],
  ...
  },
  {
    ...
    description:
      "Croatia Mountains groups 9 nearby places across 5 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    cities: ["rijeka", "split", "zagreb", "dubrovnik", "osijek"],
    nearbyPlaces: ["biokovo-nature-park-near-split", "medvednica-nature-park-near-zagreb", "mosor-near-split", "papuk-nature-park-near-zagreb", "risnjak-national-park-near-rijeka", "biokovo-near-dubrovnik", "dilj-near-osijek", "papuk-near-osijek", "risnjak-national-park-near-zagreb"],
  ...
  },
  {
    ...
    description:
      "Croatia–Slovenia Borderlands groups 10 nearby places across 6 cities for local-first day and weekend discovery — mainly mountains, nature areas. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["celje", "ljubljana", "rijeka", "zagreb", "osijek", "maribor"],
    nearbyPlaces: ["medvednica-nature-park-near-zagreb", "risnjak-national-park-near-rijeka", "kamniksavinja-alps-near-celje", "pohorje-near-celje", "vipava-valley-near-ljubljana", "donacka-gora-near-celje", "savinja-near-celje", "lonjsko-polje-near-osijek", "pohorje-near-maribor", "risnjak-national-park-near-zagreb"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["banska-bystrica", "bratislava", "brno", "ostrava", "zilina", "zlin", "pardubice"],
  ...
  },
  {
    ...
    description:
      "European Islands groups 29 nearby places across 15 cities for local-first day and weekend discovery — mainly islands. This is a geographic discovery collection derived from island geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "island_region",
  ...
  },
  {
    ...
    description:
      "European Mountains groups 19 nearby places across 15 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
    ...
    nearbyPlaces: ["rhodope-mountains-near-plovdiv", "strandzha-near-burgas", "vitosha-near-sofia", "mecsek-near-pecs", "peneda-geres-national-park-near-braga", "serra-da-estrela-natural-park-near-viseu", "serra-de-sao-mamede-near-evora", "little-carpathians-near-bratislava", "mala-fatra-national-park-near-zilina", "polana-near-banska-bystrica", "velka-fatra-near-bratislava", "kamniksavinja-alps-near-celje", "pohorje-near-celje", "triglav-national-park-near-ljubljana", "donacka-gora-near-celje", "peneda-geres-national-park-near-porto", "pohorje-near-maribor", "serra-do-marao-near-matosinhos", "sredna-gora-near-stara-zagora"],
  ...
  },
  {
    ...
    description:
      "France National Parks groups 8 nearby places across 8 cities for local-first day and weekend discovery — mainly mountains, nature areas. This is a geographic discovery collection derived from a shared national-park system; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "national_park_region",
    cities: ["grenoble", "marseille", "montpellier", "nice", "pau", "toulon", "antibes", "cannes"],
    nearbyPlaces: ["calanques-near-marseille", "cevennes-national-park-near-montpellier", "mercantour-national-park-near-nice", "pyrenees-national-park-near-pau", "ecrins-national-park-near-grenoble", "calanques-national-park-near-toulon", "mercantour-national-park-near-antibes", "mercantour-national-park-near-cannes"],
  ...
  },
  {
    ...
    title: "Germany Lakes",
    description:
      "Germany Lakes groups 24 nearby places across 15 cities for local-first day and weekend discovery — mainly lakes. This is a geographic discovery collection derived from lake-district geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "lake_region",
  ...
  },
  {
    ...
    description:
      "Germany–Poland Borderlands groups 23 nearby places across 8 cities for local-first day and weekend discovery — mainly mountains, nature areas, parks. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["berlin", "dresden", "gorlitz", "szczecin", "wroclaw", "legnica", "walbrzych", "koszalin"],
  ...
  },
  {
    ...
    description:
      "Ireland Weekend Escapes groups 14 nearby places across 5 cities for local-first day and weekend discovery — mainly parks, mountains, waterfronts. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["dublin", "dundalk", "letterkenny", "swords", "westport"],
    nearbyPlaces: ["connemara-national-park-near-westport", "cooley-mountains-near-dundalk", "lough-swilly-near-letterkenny", "north-bull-island-near-swords", "wicklow-mountains-near-dublin", "cuilcagh-near-dundalk", "howth-head-near-swords", "ireland-s-eye-near-swords", "malahide-near-swords", "mourne-mountains-near-dundalk", "ravensdale-near-dundalk", "rogerstown-estuary-near-swords", "slieve-foye-near-dundalk", "phoenix-park-dublin"],
  ...
  },
  {
    ...
    description:
      "Italy–Slovenia Borderlands groups 14 nearby places across 7 cities for local-first day and weekend discovery — mainly mountains, nature areas, parks. This is a geographic discovery collection derived from cross-border natural continuity; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "cross_border_region",
    cities: ["celje", "kranj", "ljubljana", "udine", "treviso", "trieste", "maribor"],
    nearbyPlaces: ["carnic-alps-near-udine", "julian-prealps-natural-park-near-udine", "kamniksavinja-alps-near-celje", "triglav-national-park-near-kranj", "vipava-valley-near-ljubljana", "donacka-gora-near-celje", "savinja-near-celje", "cansiglio-near-treviso", "castello-di-miramare-near-trieste", "dolomiti-bellunesi-national-park-near-treviso", "lago-di-santa-croce-near-treviso", "lakes-of-revine-lago-near-treviso", "piave-river-near-treviso", "pohorje-near-maribor"],
  ...
  },
  {
    ...
    description:
      "Portugal Weekend Escapes groups 21 nearby places across 11 cities for local-first day and weekend discovery — mainly nature areas, mountains. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["braganca", "coimbra", "faro", "funchal", "guimaraes", "vila-nova-de-gaia", "viseu", "leiria", "matosinhos", "porto", "viana-do-castelo"],
    nearbyPlaces: ["alvao-natural-park-near-vila-nova-de-gaia", "montesinho-natural-park-near-braganca", "peneda-geres-national-park-near-guimaraes", "ponta-de-sao-lourenco-near-funchal", "ria-formosa-natural-park-near-faro", "serra-da-estrela-natural-park-near-viseu", "bucaco-forest-near-coimbra", "ria-de-aveiro-near-vila-nova-de-gaia", "serra-da-estrela-near-vila-nova-de-gaia", "serra-do-bucaco-near-vila-nova-de-gaia", "serra-do-marao-near-vila-nova-de-gaia", "aire-and-candeeiros-ranges-natural-park-near-leiria", "alvao-natural-park-near-matosinhos", "northern-littoral-natural-park-near-matosinhos", "paiva-river-near-matosinhos", "peneda-geres-national-park-near-matosinhos", "peneda-geres-national-park-near-porto", "peneda-geres-national-park-near-viana-do-castelo", "ria-de-aveiro-near-matosinhos", "sao-pedro-de-moel-near-leiria", "serra-do-marao-near-matosinhos"],
  ...
  },
  {
    ...
    description:
      "Romania Mountains groups 29 nearby places across 15 cities for local-first day and weekend discovery — mainly mountains. This is a geographic discovery collection derived from shared mountain-range geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "mountain_region",
  ...
  },
  {
    ...
    title: "Spain Coast",
    description:
      "Spain Coast groups 8 nearby places across 7 cities for local-first day and weekend discovery — mainly beaches, waterfronts. This is a geographic discovery collection derived from a shared coastline; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "coastal_region",
    cities: ["a-coruna", "barcelona", "girona", "granada", "san-sebastian", "tarragona", "santiago-de-compostela"],
    nearbyPlaces: ["cabo-de-gata-nijar-natural-park-near-granada", "cap-de-creus-near-girona", "costa-daurada-near-tarragona", "costa-da-morte-near-a-coruna", "hendaye-bay-near-san-sebastian", "sitges-near-barcelona", "carnota-near-santiago-de-compostela", "cies-islands-near-santiago-de-compostela"],
  ...
  },
  {
    ...
    nearbyPlaces: ["atlantic-islands-of-galicia-national-park-near-vigo", "cabaneros-national-park-near-toledo", "donana-national-park-near-cadiz", "guadarrama-national-park-near-madrid", "ordesa-y-monte-perdido-national-park-near-jaca", "picos-de-europa-national-park-near-leon", "sierra-nevada-national-park-near-granada", "sierra-de-las-nieves-national-park-near-malaga", "sierra-de-las-nieves-national-park-near-cadiz", "donana-national-park-near-jerez-de-la-frontera", "guadarrama-national-park-near-alcala-de-henares", "guadarrama-national-park-near-alcorcon", "guadarrama-national-park-near-fuenlabrada", "guadarrama-national-park-near-leganes", "picos-de-europa-national-park-near-gijon", "sierra-de-guadarrama-national-park-near-getafe", "sierra-de-guadarrama-national-park-near-mostoles", "tablas-de-daimiel-national-park-near-fuenlabrada"],
  ...
  },
  {
    ...
    description:
      "Sweden National Parks groups 17 nearby places across 13 cities for local-first day and weekend discovery — mainly nature areas, islands. This is a geographic discovery collection derived from a shared national-park system; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "national_park_region",
    cities: ["gothenburg", "helsingborg", "jonkoping", "malmo", "orebro", "stockholm", "uppsala", "vasteras", "gavle", "halmstad", "vaxjo", "eskilstuna", "sodertalje"],
  ...
  },
  {
    ...
    description:
      "United Kingdom Forests groups 14 nearby places across 13 cities for local-first day and weekend discovery — mainly nature areas. This is a geographic discovery collection derived from forest landscapes; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "forest_region",
    cities: ["birmingham", "bristol", "derby", "liverpool", "norwich", "southampton", "swansea", "southend-on-sea", "preston", "bournemouth", "milton-keynes", "northampton", "reading"],
  ...
  },
  {
    ...
    description:
      "United Kingdom Lakes groups 9 nearby places across 8 cities for local-first day and weekend discovery — mainly lakes. This is a geographic discovery collection derived from lake-district geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "lake_region",
    cities: ["bristol", "carlisle", "inverness", "manchester", "newcastle-upon-tyne", "nottingham", "stoke-on-trent", "northampton"],
    nearbyPlaces: ["carsington-water-near-nottingham", "chew-valley-lake-near-bristol", "dovestone-reservoir-near-manchester", "kielder-water-near-newcastle-upon-tyne", "lake-district-near-carlisle", "loch-ness-near-inverness", "tittesworth-reservoir-near-stoke-on-trent", "pitsford-water-near-northampton", "rutland-water-near-northampton"],
  ...
  },
  {
    ...
    description:
      "United States Coast groups 21 nearby places across 15 cities for local-first day and weekend discovery — mainly beaches, waterfronts. This is a geographic discovery collection derived from a shared coastline; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "coastal_region",
  ...
  },
  {
    ...
    description:
      "United States Lakes groups 17 nearby places across 14 cities for local-first day and weekend discovery — mainly lakes. This is a geographic discovery collection derived from lake-district geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "lake_region",
    cities: ["austin", "burlington-vt", "denver", "madison", "missoula", "nashville", "providence", "reno", "sacramento", "salt-lake-city", "traverse-city", "aurora", "stockton", "worcester"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Bordeaux groups 26 nearby places across 8 cities for local-first day and weekend discovery — mainly nature areas, mountains, beaches. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["bayonne", "bordeaux", "la-rochelle", "pau", "angouleme", "niort", "saint-nazaire", "poitiers"],
    nearbyPlaces: ["biarritz-near-bayonne", "dordogne-near-bordeaux", "dune-of-pilat-near-bordeaux", "gave-de-pau-near-pau", "la-rhune-near-bayonne", "landes-de-gascogne-regional-natural-park-near-bordeaux", "marais-poitevin-near-la-rochelle", "medoc-near-bordeaux", "pyrenees-national-park-near-pau", "ile-de-re-near-la-rochelle", "dronne-near-angouleme", "gironde-estuary-near-angouleme", "ile-d-aix-near-angouleme", "ile-d-aix-near-niort", "ile-d-yeu-near-saint-nazaire", "ile-de-re-near-niort", "ile-de-re-near-poitiers", "lac-de-grand-lieu-near-saint-nazaire", "lay-river-near-niort", "marais-breton-near-saint-nazaire", "marais-poitevin-near-niort", "marais-poitevin-near-poitiers", "noirmoutier-near-saint-nazaire", "sevre-niortaise-near-niort", "tardoire-near-angouleme", "vendee-river-near-niort"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Bristol groups 20 nearby places across 7 cities for local-first day and weekend discovery — mainly nature areas, mountains, beaches. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["bath", "bristol", "cardiff", "exeter", "swansea", "bournemouth", "reading"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Brno groups 19 nearby places across 7 cities for local-first day and weekend discovery — mainly nature areas, mountains. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["brno", "ceske-budejovice", "olomouc", "ostrava", "zlin", "plzen", "pardubice"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Chemnitz groups 26 nearby places across 10 cities for local-first day and weekend discovery — mainly nature areas, mountains, lakes. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["chemnitz", "erfurt", "gorlitz", "braunschweig", "halle", "furth", "offenbach-am-main", "paderborn", "darmstadt", "berlin"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Dubrovnik groups 8 nearby places across 2 cities for local-first day and weekend discovery — mainly islands, mountains, nature areas. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["dubrovnik", "split"],
    nearbyPlaces: ["biokovo-nature-park-near-split", "elaphiti-islands-near-dubrovnik", "hvar-near-split", "krka-national-park-near-split", "mljet-national-park-near-dubrovnik", "mosor-near-split", "peljesac-near-dubrovnik", "biokovo-near-dubrovnik"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Durham groups 19 nearby places across 6 cities for local-first day and weekend discovery — mainly nature areas, beaches, islands. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["durham", "kingston-upon-hull", "sunderland", "york", "preston", "middlesbrough"],
    nearbyPlaces: ["durham-coast-near-durham", "marsden-rock-near-sunderland", "north-pennines-near-durham", "north-york-moors-national-park-near-york", "spurn-near-kingston-upon-hull", "castle-eden-dene-near-sunderland", "roker-near-sunderland", "whitburn-near-sunderland", "arnside-and-silverdale-near-preston", "forest-of-bowland-near-preston", "lake-district-near-preston", "morecambe-bay-near-preston", "north-pennines-near-middlesbrough", "north-york-moors-near-middlesbrough", "pendle-hill-near-preston", "robin-hood-s-bay-near-middlesbrough", "roseberry-topping-near-middlesbrough", "saltburn-by-the-sea-near-middlesbrough", "sutton-bank-near-middlesbrough"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Graz groups 28 nearby places across 6 cities for local-first day and weekend discovery — mainly mountains, lakes, nature areas. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["graz", "klagenfurt", "sankt-polten", "vienna", "villach", "linz"],
    nearbyPlaces: ["barenschutzklamm-near-graz", "dobratsch-near-villach", "dunkelsteinerwald-near-sankt-polten", "gesause-national-park-near-graz", "hohe-wand-near-vienna", "karawanks-near-klagenfurt", "lake-faak-near-villach", "lake-neusiedl-near-vienna", "schockl-near-graz", "schonbrunn-vienna", "stubenberg-am-see-near-graz", "wachau-near-sankt-polten", "worthersee-near-klagenfurt", "hohe-wand-near-sankt-polten", "julian-alps-near-villach", "lake-ossiach-near-villach", "millstatter-see-near-villach", "otscher-near-sankt-polten", "traisen-near-sankt-polten", "vienna-woods-near-sankt-polten", "worthersee-near-villach", "attersee-near-linz", "hollengebirge-near-linz", "kalkalpen-national-park-near-linz", "sengsengebirge-near-linz", "traunsee-near-linz", "traunstein-near-linz", "wachau-valley-near-vienna"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Innsbruck groups 14 nearby places across 3 cities for local-first day and weekend discovery — mainly lakes, mountains, nature areas. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["innsbruck", "salzburg", "linz"],
    nearbyPlaces: ["achen-lake-near-innsbruck", "karwendel-near-innsbruck", "krimml-waterfalls-near-salzburg", "lake-fuschl-near-salzburg", "lake-wolfgang-near-salzburg", "natterer-see-near-innsbruck", "patscherkofel-near-innsbruck", "untersberg-near-salzburg", "attersee-near-linz", "hollengebirge-near-linz", "kalkalpen-national-park-near-linz", "sengsengebirge-near-linz", "traunsee-near-linz", "traunstein-near-linz"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Ljubljana groups 9 nearby places across 4 cities for local-first day and weekend discovery — mainly mountains, lakes, nature areas. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["celje", "kranj", "ljubljana", "maribor"],
    nearbyPlaces: ["kamniksavinja-alps-near-celje", "lake-bled-near-kranj", "lake-bohinj-near-ljubljana", "pohorje-near-celje", "triglav-national-park-near-kranj", "vipava-valley-near-ljubljana", "donacka-gora-near-celje", "savinja-near-celje", "pohorje-near-maribor"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Porto groups 16 nearby places across 7 cities for local-first day and weekend discovery — mainly waterfronts, nature areas, weekend places. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["aveiro", "braga", "guimaraes", "porto", "viana-do-castelo", "matosinhos", "leiria"],
    nearbyPlaces: ["douro-valley-near-porto", "alvao-natural-park-near-porto", "costa-nova-do-prado-near-aveiro", "cavado-river-near-guimaraes", "douro-international-natural-park-near-porto", "lima-river-near-viana-do-castelo", "peneda-geres-national-park-near-braga", "alvao-natural-park-near-matosinhos", "northern-littoral-natural-park-near-matosinhos", "paiva-river-near-matosinhos", "peneda-geres-national-park-near-matosinhos", "peneda-geres-national-park-near-porto", "peneda-geres-national-park-near-viana-do-castelo", "ria-de-aveiro-near-matosinhos", "sao-pedro-de-moel-near-leiria", "serra-do-marao-near-matosinhos"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Sofia groups 7 nearby places across 4 cities for local-first day and weekend discovery — mainly mountains, parks, nature areas. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["plovdiv", "sofia", "stara-zagora", "pleven"],
    nearbyPlaces: ["iskar-gorge-near-sofia", "rhodope-mountains-near-plovdiv", "rila-monastery-nature-park-near-sofia", "rila-national-park-near-sofia", "vitosha-near-sofia", "sredna-gora-near-stara-zagora", "vrachanski-balkan-nature-park-near-pleven"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Sydney groups 12 nearby places across 4 cities for local-first day and weekend discovery — mainly nature areas. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["newcastle", "sydney", "wollongong", "central-coast"],
    nearbyPlaces: ["blue-mountains-near-sydney", "budderoo-national-park-near-wollongong", "garigal-national-park-near-sydney", "ku-ring-gai-chase-national-park-near-sydney", "royal-national-park-sydney", "watagans-national-park-near-newcastle", "bouddi-national-park-near-central-coast", "brisbane-water-national-park-near-central-coast", "dharug-national-park-near-central-coast", "munmorah-state-conservation-area-near-central-coast", "popran-national-park-near-central-coast", "watagans-national-park-near-central-coast"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Vilnius groups 13 nearby places across 4 cities for local-first day and weekend discovery — mainly parks, lakes, nature areas. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["kaunas", "panevezys", "vilnius", "siauliai"],
    nearbyPlaces: ["anyksciai-regional-park-near-panevezys", "asveja-near-vilnius", "birzai-regional-park-near-panevezys", "dzukija-national-park-near-vilnius", "kaunas-reservoir-near-kaunas", "kauno-marios-regional-park-near-kaunas", "trakai-historical-national-park-near-vilnius", "verkiai-regional-park-near-vilnius", "grazute-regional-park-near-panevezys", "labanoras-regional-park-near-panevezys", "lake-sartai-near-panevezys", "lake-tauragnas-near-panevezys", "lake-rekyva-near-siauliai"],
  ...
  },
  {
    ...
    description:
      "Weekend Escapes near Zagreb groups 12 nearby places across 3 cities for local-first day and weekend discovery — mainly mountains, islands, lakes. This is a geographic discovery collection derived from regional weekend-escape geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "weekend_escape_region",
    cities: ["rijeka", "zagreb", "osijek"],
    nearbyPlaces: ["krk-near-rijeka", "medvednica-nature-park-near-zagreb", "papuk-nature-park-near-zagreb", "plitvice-lakes-national-park-near-zagreb", "risnjak-national-park-near-rijeka", "akovo-near-osijek", "dilj-near-osijek", "kopacki-rit-near-osijek", "lonjsko-polje-near-osijek", "mura-drava-danube-near-osijek", "papuk-near-osijek", "risnjak-national-park-near-zagreb"],
  ...
  },
  {
    ...
    description:
      "Western Europe Lakes groups 19 nearby places across 15 cities for local-first day and weekend discovery — mainly lakes. This is a geographic discovery collection derived from lake-district geography; it is not a tourism ranking and uses no popularity or visitor data. Verify access, transport, weather, health, and safety with official sources before visiting.",
    regionType: "lake_region",
