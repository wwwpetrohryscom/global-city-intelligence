...
export const REGIONAL_DISCOVERY_COLLECTIONS: readonly RegionalCollection[] = [
  {
    ...
    cities: ["adelaide", "coffs-harbour", "devonport", "hobart", "mackay", "melbourne", "port-macquarie", "rockhampton", "broome", "busselton", "sale", "karratha", "port-lincoln", "cessnock", "murray-bridge", "port-hedland", "esperance", "gympie", "portland-vic", "nambour", "nowra", "hamilton", "lismore", "margaret-river", "goolwa", "ballina-nsw", "kingston-au"],
  ...
  },
  {
    ...
    cities: ["brisbane", "geraldton", "melbourne", "perth", "townsville", "port-lincoln", "cessnock", "murray-bridge", "port-hedland", "esperance", "portland-vic", "hamilton", "sale", "nambour", "karratha", "nowra", "margaret-river", "goolwa", "kingston-au"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["los-angeles", "sacramento", "san-diego", "san-francisco", "oakland", "santa-rosa", "san-jose-us", "anaheim", "stockton", "riverside", "carson-city", "san-luis-obispo", "redwood-city", "huntington-beach", "oxnard", "rancho-cucamonga", "pomona", "corona", "garden-grove", "palmdale", "cupertino", "napa"],
  ...
  },
  {
    ...
    regionType: "island_region",
    cities: ["laval", "nanaimo", "quebec-city", "st-johns", "toronto", "victoria", "windsor-ontario", "montreal", "sarnia", "sydney-ca", "sept-iles", "saint-eustache", "baie-comeau", "riviere-du-loup", "saint-constant", "sainte-therese", "rimouski", "vaudreuil-dorion", "shawinigan", "l-assomption", "riverview"],
  ...
  },
  {
    ...
    regionType: "national_park_region",
    cities: ["calgary", "charlottetown", "edmonton", "gatineau", "halifax", "laval", "montreal", "saskatoon", "sherbrooke", "winnipeg", "longueuil", "banff", "cornwall", "brandon", "brossard", "prince-albert", "rimouski", "saint-hyacinthe", "gaspe", "sept-iles", "saint-eustache", "vaudreuil-dorion", "alma", "riviere-du-loup", "magog", "shawinigan", "l-assomption", "dolbeau-mistassini", "mirabel", "lachute", "brockville", "mascouche", "beauharnois", "orillia", "riverview", "boucherville", "edmundston"],
  ...
  },
  {
    ...
    regionType: "coastal_region",
    cities: ["amsterdam", "bayonne", "bruges", "caen", "cagliari", "constanta", "gdansk", "granada", "le-havre", "lisbon", "lubeck", "malmo", "san-sebastian", "tarragona", "venice", "den-helder", "kampen", "saint-germain-en-laye", "alkmaar", "vlissingen", "noordoostpolder", "grasse", "harderwijk", "evreux", "saint-brieuc", "goes", "sneek", "dieppe", "sete", "la-roche-sur-yon", "cherbourg-octeville", "saint-lo", "royan", "aubagne", "lisieux", "husum", "martigues"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["aosta", "chambery", "grenoble", "nice", "turin", "asti", "cannes", "antibes", "toulon", "valence", "pavia", "gap", "cagnes-sur-mer"],
  ...
  },
  {
    ...
    regionType: "national_park_region",
    cities: ["grenoble", "marseille", "montpellier", "nice", "pau", "toulon", "antibes", "cannes", "albi", "beziers", "biarritz", "tarbes", "gap", "ales", "hyeres", "martigues", "istres", "aubagne", "rodez"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["bayonne", "bilbao", "jaca", "pau", "san-sebastian", "toulouse", "vitoria-gasteiz", "lleida", "biarritz", "tarbes", "mont-de-marsan"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["annecy", "besancon", "brest", "caen", "clermont-ferrand", "dijon", "grenoble", "le-havre", "lille", "limoges", "marseille", "nancy", "nimes", "saint-etienne", "villeneuve-d-ascq"],
  ...
  },
  {
    ...
    regionType: "cross_border_region",
    cities: ["belfast", "derry", "drogheda", "dublin", "letterkenny", "sligo", "bray", "lisburn"],
  ...
  },
  {
    ...
    regionType: "protected_landscape_region",
    cities: ["brampton", "burnaby", "colorado-springs", "jacksonville", "long-beach", "markham", "mississauga", "newark", "surrey", "vaughan", "virginia-beach", "jefferson-city", "eau-claire", "sioux-city", "kalamazoo", "rapid-city", "terre-haute", "lawrence", "little-rock", "davenport", "south-bend", "kenosha", "joliet", "grand-forks", "racine", "bowling-green", "st-joseph", "waukegan", "waterloo", "hamilton-us", "oshkosh", "florence-us", "pontiac", "muncie", "saginaw", "kokomo", "franklin", "overland-park", "council-bluffs", "la-crosse", "waukesha", "decatur", "conway", "grand-island", "st-charles", "bentonville", "gary", "manhattan"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["birmingham-al", "brampton", "burnaby", "colorado-springs", "el-paso", "fort-worth", "fresno", "hartford", "jacksonville", "laval", "long-beach", "markham", "newark", "reno", "rochester", "san-angelo", "st-joseph", "waterloo", "jefferson-city", "eau-claire", "mckinney", "lawrence", "overland-park", "council-bluffs", "la-crosse", "decatur", "conway", "grand-island", "bentonville", "manhattan", "lakewood", "littleton", "st-charles", "lawton", "gary"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["birmingham-al", "el-paso", "fort-worth", "fresno", "jacksonville", "reno", "rochester", "tulsa", "virginia-beach", "mckinney", "wichita-falls", "grand-prairie-us", "lawton"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["brisbane", "cairns", "gold-coast", "sunshine-coast", "toowoomba", "townsville", "gympie", "nambour", "maryborough", "emerald", "dalby", "kingaroy"],
  ...
  },
  {
    ...
    regionType: "coastal_region",
    cities: ["bristol", "durham", "edinburgh", "exeter", "liverpool", "norwich", "swansea", "bournemouth", "preston", "middlesbrough", "newport", "chester", "gloucester", "maidstone", "taunton", "blackpool", "canterbury", "dover-uk", "hastings-uk", "chichester", "salisbury", "worthing"],
  ...
  },
  {
    ...
    regionType: "mountain_region",
    cities: ["belfast", "birmingham", "cardiff", "derry", "lancaster", "northampton", "preston", "middlesbrough", "gloucester", "newport", "chester", "wrexham", "swindon", "salisbury", "eastbourne", "scarborough", "blackpool", "worcester-uk", "canterbury", "blackburn", "maidstone", "winchester", "cheltenham", "hereford", "wigan", "shrewsbury", "stratford-upon-avon", "halifax-uk", "chichester", "oldham", "guildford", "perth-uk", "rochdale", "worthing", "lisburn", "burnley", "taunton", "darlington", "dunfermline"],
  ...
  },
  {
    ...
    regionType: "national_park_region",
    cities: ["aberdeen", "brighton", "cardiff", "glasgow", "leeds", "manchester", "newcastle-upon-tyne", "sheffield", "southampton", "york", "stirling", "winchester", "chichester", "basingstoke", "darlington", "hereford", "salisbury"],
  ...
  },
  {
    ...
    regionType: "national_park_region",
    cities: ["atlanta", "bellingham", "boulder", "chicago", "cleveland", "durango", "el-paso", "fresno", "knoxville", "los-angeles", "louisville", "miami", "richmond", "san-diego", "tacoma", "alexandria-va", "st-george", "redding", "roswell", "rapid-city", "rockville", "bowling-green", "yakima", "charlottesville", "hagerstown", "st-charles", "hilo"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["angers", "le-mans", "nantes", "rennes", "tours", "lorient", "bourges", "poitiers", "saint-nazaire", "niort", "laval-fr", "alencon", "la-roche-sur-yon"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["birmingham", "derby", "leicester", "stoke-on-trent", "wolverhampton", "preston", "milton-keynes", "luton", "northampton", "reading", "peterborough-uk", "chelmsford", "shrewsbury", "bedford", "rochdale", "aylesbury"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["bayonne", "bordeaux", "la-rochelle", "pau", "angouleme", "niort", "saint-nazaire", "poitiers", "biarritz", "vannes", "agen", "perigueux", "royan", "merignac", "cahors"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["boston", "providence", "worcester", "manchester-nh", "albany-ny", "bridgeport", "cambridge-us", "salem-us", "plymouth-us", "nashua", "pittsfield", "middletown", "taunton-us"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["boulder", "colorado-springs", "denver", "aurora", "cheyenne", "lakewood", "littleton"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["brisbane", "gold-coast", "sunshine-coast", "toowoomba", "gympie", "nambour", "lismore", "warwick", "dalby", "kingaroy", "murwillumbah", "ballina-nsw", "casino"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["bath", "bristol", "cardiff", "exeter", "swansea", "bournemouth", "reading", "gloucester", "newport", "swindon", "worcester-uk", "cheltenham", "stratford-upon-avon", "aylesbury", "worthing", "bedford"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["chicago", "milwaukee", "rockford", "green-bay", "peoria", "fort-wayne", "cedar-rapids", "iowa-city", "davenport", "kenosha", "joliet", "racine", "waukegan", "waukesha", "gary"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["durham", "kingston-upon-hull", "sunderland", "york", "preston", "middlesbrough", "wrexham", "chester", "blackpool", "blackburn", "doncaster", "wigan", "rotherham", "oldham", "burnley", "scarborough"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["aberdeen", "carlisle", "dundee", "edinburgh", "glasgow", "newcastle-upon-tyne", "preston", "middlesbrough", "stirling", "wrexham", "chester", "perth-uk", "gateshead", "dunfermline"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["annecy", "avignon", "chambery", "grenoble", "lyon", "saint-etienne", "toulon", "antibes", "valence", "cannes", "albi", "beziers", "bourg-en-bresse", "macon-fr", "albertville", "vienne", "metropolis-of-lyon", "aix-les-bains", "roanne", "le-puy-en-velay"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["hobart", "launceston", "kingston-au"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["bradford", "lancaster", "leeds", "liverpool", "manchester", "sheffield", "preston", "stoke-on-trent", "wolverhampton", "middlesbrough", "northampton", "hereford", "halifax-uk", "wakefield", "walsall", "lichfield"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["brighton", "cambridge", "london", "oxford", "portsmouth", "southampton", "milton-keynes", "luton", "bournemouth", "reading", "stoke-on-trent", "wolverhampton", "northampton", "southend-on-sea", "high-wycombe", "st-albans"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["long-beach", "los-angeles", "santa-barbara", "anaheim", "riverside", "bakersfield", "santa-monica", "huntington-beach", "oxnard", "oceanside", "ontario", "pomona", "corona", "garden-grove", "palmdale", "rancho-cucamonga"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["aix-en-provence", "marseille", "montpellier", "nice", "nimes", "toulon", "cannes", "antibes", "valence", "arles", "grasse", "ales", "istres", "aubagne", "montelimar", "cagnes-sur-mer"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["ballarat", "bendigo", "geelong", "melbourne", "morwell", "benalla", "warragul", "traralgon", "colac"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["lincoln", "norwich", "nottingham", "preston", "stoke-on-trent", "wolverhampton", "milton-keynes", "luton", "southend-on-sea", "northampton", "middlesbrough", "canterbury", "colchester", "dover-uk", "peterborough-uk"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["orleans", "paris", "reims", "rouen", "beauvais", "poitiers", "bourges", "saint-quentin", "troyes", "versailles", "chartres", "neuilly-sur-seine", "auxerre", "chalons-en-champagne", "laon", "courbevoie", "cambrai", "compiegne", "asnieres-sur-seine", "douai", "abbeville", "melun", "levallois-perret", "aubervilliers", "meaux", "clamart", "aulnay-sous-bois", "meudon", "cergy", "clichy", "lisieux", "bourg-la-reine", "puteaux"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["sacramento", "san-francisco", "salinas", "oakland", "santa-rosa", "san-jose-us", "stockton", "palo-alto", "merced", "redwood-city", "san-rafael", "sunnyvale", "hayward", "cupertino", "napa"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["newcastle", "sydney", "wollongong", "central-coast", "orange", "goulburn", "lithgow", "nowra", "cessnock", "muswellbrook", "singleton", "penrith", "moss-vale"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["brampton", "hamilton-ontario", "markham", "mississauga", "toronto", "vaughan", "barrie", "st-catharines", "peterborough", "guelph", "oshawa", "brantford", "cambridge-ca", "stratford", "welland", "aurora-ca", "orillia", "woodstock"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["perpignan", "toulouse", "narbonne", "albi", "beziers", "tarbes", "carcassonne", "biarritz", "montauban", "brive-la-gaillarde", "sete", "aurillac", "auch", "rodez"],
  ...
  },
  {
    ...
    regionType: "weekend_escape_region",
    cities: ["burnaby", "nanaimo", "surrey", "vancouver", "victoria", "abbotsford", "chilliwack", "new-westminster", "richmond-ca", "north-vancouver", "port-moody"],
