...
--dry prints eligibility + samples; without it, writes /tmp/w13/selected.json."""
...
CC = {"united-states":"us","canada":"ca","australia":"au","france":"fr","united-kingdom":"uk"}
...
CAPS = json.load(open(OUT / "caps.json")) if (OUT / "caps.json").exists() else {
    "united-states": 50, "france": 50, "canada": 50, "australia": 50, "united-kingdom": 50}
ORDER = ["united-states", "united-kingdom", "france", "canada", "australia"]
TARGET = 250
selected = []
used_slugs = set()
...
print("wrote /tmp/w13/selected.json")
