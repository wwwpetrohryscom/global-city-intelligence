...
via QLever. Caches /tmp/w18/nature_<countrySlug>.json (resumable)."""
import sys, json, re
...
OUT = Path("/tmp/w18")
CQ = {"japan": "Q17", "south-korea": "Q884", "china": "Q148", "india": "Q668",
      "pakistan": "Q843", "iran": "Q794", "iraq": "Q796", "saudi-arabia": "Q851",
      "oman": "Q842", "united-arab-emirates": "Q878", "cyprus": "Q229"}
