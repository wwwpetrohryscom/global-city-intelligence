...
slug dedup + within-city QID dedup. Checkpoints /tmp/w18/nearby.json (resumable)."""
...
BAD_TYPE = re.compile(r"historic|memorial|monument|battlefield|\bfort\b|fortress|museum|aquarium|\bzoo\b|"
    ...
    r"stadium|cemetery|botanical|\bgarden\b|\bbuilding\b|historic district|world heritage|conservation area|\bairport\b|aerodrome|airfield|air base|spaceport|seaport|container port|"
...
pool = []
for cc in ["japan", "south-korea", "china", "india", "pakistan", "iran", "iraq", "saudi-arabia", "oman", "united-arab-emirates", "cyprus"]:
