#!/usr/bin/env python3
"""Fill collection gaps for wave18. The under-represented countries (RU/TR/UA/BY/IL/RS/
...
nb = json.load(open("/tmp/w18/nearby.json"))
# wave18 sibling collections (populated before each loop); each created collection
