...
--dry prints eligibility + samples; without it, writes /tmp/w11/selected.json."""
...
CC = {"united-states":"us","canada":"ca","australia":"au","germany":"de","france":"fr","netherlands":"nl"}
...
ORDER = ["united-states", "germany", "france", "canada", "australia", "netherlands"]
TARGET = 250
selected = []
used_slugs = set()
...
print("wrote /tmp/w11/selected.json")
