...
assign = json.load(open("/tmp/w11/coll_assign.json"))
...
# raise regional MAX_CITIES guard 15 -> 50 (required: full collections, every W11 city needs >=1)
reg = ROOT / "lib/data/regional-collections.ts"
s = reg.read_text()
assert "const MAX_CITIES = 15;" in s, "regional MAX_CITIES guard not found"
reg.write_text(s.replace("const MAX_CITIES = 15;", "const MAX_CITIES = 50;"))
print("regional guard MAX_CITIES 15 -> 50")
