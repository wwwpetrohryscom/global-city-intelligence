...
Outputs:
  /tmp/w11/existing_cities.json   list of {slug,name,countrySlug,countryName,region,population,affordability}
  /tmp/w11/existing_slugs.json    sorted list of slugs
  /tmp/w11/existing_qids.json     {slug: QID} harvested from city-images hero notes
  /tmp/w11/existing_qidset.json   sorted list of unique QIDs
  /tmp/w11/country_counts.json    {countrySlug: count}
