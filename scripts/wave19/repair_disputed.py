#!/usr/bin/env python3
"""Editorial disputed-territory repair for Wave 19.
...
Reuses the wave19_select eligibility + slug logic and the repair hero/nearby
...
# ---------- reused wave19_select eligibility (copied to avoid its import side-effects) ----------
