#!/usr/bin/env python3
"""Wave 12 discovery: US/DE/UK/CA/FR/AU via QLever. Caches /tmp/w19/raw_<slug>.json."""
import sys, json
...
COUNTRIES = {
    "brazil": ("Q155", 55000), "mexico": ("Q96", 55000), "argentina": ("Q414", 35000),
    "colombia": ("Q739", 11000), "chile": ("Q298", 32000), "peru": ("Q419", 38000),
    "ecuador": ("Q736", 28000), "bolivia": ("Q750", 22000), "uruguay": ("Q77", 9000),
    "paraguay": ("Q733", 18000), "costa-rica": ("Q800", 9000), "panama": ("Q804", 1500),
    "dominican-republic": ("Q786", 28000),
}
QTMPL = """
