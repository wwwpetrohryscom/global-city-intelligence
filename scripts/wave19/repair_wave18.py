#!/usr/bin/env python3
"""Wave 19 repair: replace cities that lack an acceptable verified hero OR cannot
reach 5 verified nearby places, with stronger same-country candidates satisfying
BOTH. Dynamic repair set (no hardcoded slugs). Mirrors wave19_select eligibility +
