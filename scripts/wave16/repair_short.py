#!/usr/bin/env python3
"""Replace wave16 cities lacking a usable verified hero (or >=5 nearby) with stronger
...
OUT = "/tmp/w16"
REPLACE = {"husi": "romania", "lugoj": "romania"}
...
for bad, cc in REPLACE.items():
    for cand in extra[cc]:
        if cand["slug"] in have or cand["slug"] in picked:
            continue
