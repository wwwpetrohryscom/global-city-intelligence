...
slug dedup + within-city QID dedup. Checkpoints /tmp/w16/nearby.json (resumable)."""
...
REGION = {"sweden": "Northern Europe", "norway": "Northern Europe",
          ...
          "romania": "Eastern Europe", "croatia": "Southeastern Europe",
...
pool = []
for cc in ["sweden", "norway", "denmark", "finland", "romania", "croatia", "slovakia"]:
