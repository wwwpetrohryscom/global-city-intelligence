#!/usr/bin/env python3
"""Wave 12 discovery: US/DE/UK/CA/FR/AU via QLever. Caches /tmp/w16/raw_<slug>.json."""
import sys, json
...
COUNTRIES = {
    "sweden": ("Q34", 9000), "norway": ("Q20", 6000),
    "denmark": ("Q35", 4000), "finland": ("Q33", 9000),
    "romania": ("Q218", 20000), "croatia": ("Q224", 8000),
    "slovakia": ("Q214", 9000),
}
QTMPL = """
