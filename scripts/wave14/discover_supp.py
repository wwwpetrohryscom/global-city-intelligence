#!/usr/bin/env python3
"""Wave 14 supplement: municipality classes for BE/AT/CH (and DE) that are NOT
subclasses of human-settlement Q486972, so the main discover.py Q486972 query misses
them. Query each class directly and merge into raw_<country>.json (dedup by QID)."""
import sys, json
...
SUPP = {
    "belgium":     ("Q31",  ["Q493522"],              9000),
    "austria":     ("Q40",  ["Q667509", "Q262166"],   5000),
    "switzerland": ("Q39",  ["Q70208"],               5000),
    "germany":     ("Q183", ["Q262166", "Q42744322"], 17000),
}
...
} GROUP BY ?item ORDER BY DESC(?population) LIMIT 3000
"""
