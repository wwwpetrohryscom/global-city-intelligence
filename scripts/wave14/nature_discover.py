...
via QLever. Caches /tmp/w14/nature_<countrySlug>.json (resumable)."""
import sys, json, re
...
OUT = Path("/tmp/w14")
CQ = {"united-states": "Q30", "united-kingdom": "Q145", "germany": "Q183",
      "belgium": "Q31", "austria": "Q40", "switzerland": "Q39"}
