...
slug dedup + within-city QID dedup. Checkpoints /tmp/w14/nearby.json (resumable)."""
...
METROS = [(40.713,-74.006),(34.052,-118.244),(41.881,-87.629),(38.895,-77.036),
          (51.507,-0.128),(53.480,-2.243),(52.486,-1.890),(55.953,-3.188),(53.408,-2.991),
          (52.520,13.405),(48.135,11.582),(53.551,9.994),(50.937,6.960),(50.110,8.682),  # Berlin/Munich/Hamburg/Cologne/Frankfurt
          (50.851,4.352),(51.221,4.400),(48.208,16.373),(47.377,8.540),(46.204,6.143),(47.559,7.588)]  # Brussels/Antwerp/Vienna/Zurich/Geneva/Basel
def hav(a, b, c, d):
    r = math.radians
...
pool = []
for cc in ["united-states", "united-kingdom", "germany", "belgium", "austria", "switzerland"]:
