#!/usr/bin/env python3
"""Wave 12 discovery: US/DE/UK/CA/FR/AU via QLever. Caches /tmp/w14/raw_<slug>.json."""
import sys, json
...
COUNTRIES = {
    "united-states": ("Q30", 26000), "united-kingdom": ("Q145", 17000),
    "germany": ("Q183", 18000), "belgium": ("Q31", 11000),
    "austria": ("Q40", 6000), "switzerland": ("Q39", 6000),
}
QTMPL = """
