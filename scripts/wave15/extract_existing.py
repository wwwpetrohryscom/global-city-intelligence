...
Outputs:
  /tmp/w15/existing_cities.json   list of {slug,name,countrySlug,countryName,region,population,affordability}
  /tmp/w15/existing_slugs.json    sorted list of slugs
  /tmp/w15/existing_qids.json     {slug: QID} harvested from city-images hero notes
  /tmp/w15/existing_qidset.json   sorted list of unique QIDs
  /tmp/w15/country_counts.json    {countrySlug: count}
No network. Deterministic."""
import json, re, os
from pathlib import Path

ROOT = Path("/Users/agent/global-city-intelligence")
OUT = Path("/tmp/w15"); OUT.mkdir(parents=True, exist_ok=True)
