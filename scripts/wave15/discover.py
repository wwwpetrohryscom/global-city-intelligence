#!/usr/bin/env python3
"""Wave 12 discovery: US/DE/UK/CA/FR/AU via QLever. Caches /tmp/w15/raw_<slug>.json."""
import sys, json
...
COUNTRIES = {
    "netherlands": ("Q55", 16000), "spain": ("Q29", 20000),
    "italy": ("Q38", 20000), "portugal": ("Q45", 12000),
    "poland": ("Q36", 24000), "czechia": ("Q213", 12000),
}
QTMPL = """
