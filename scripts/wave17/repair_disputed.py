#!/usr/bin/env python3
"""Editorial disputed-territory repair for Wave 17.
...
Reuses the wave17_select eligibility + slug logic and the repair hero/nearby
...
# ---------- reused wave17_select eligibility (copied to avoid its import side-effects) ----------
