...
SUPP = {
    "lithuania": ("Q37",  ["Q515"],                5000),   # city
    "latvia":    ("Q211", ["Q15584664", "Q109329953"], 4000),  # city under municipality + state city
    "estonia":   ("Q191", ["Q11881845"],           4000),   # city of Estonia (buffer)
}
