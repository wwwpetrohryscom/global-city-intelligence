...
via QLever. Caches /tmp/w17/nature_<countrySlug>.json (resumable)."""
import sys, json, re
...
OUT = Path("/tmp/w17")
CQ = {"greece": "Q41", "hungary": "Q28", "bulgaria": "Q219", "slovenia": "Q215",
      "serbia": "Q403", "lithuania": "Q37", "latvia": "Q211", "estonia": "Q191",
      "montenegro": "Q236", "ukraine": "Q212", "belarus": "Q184", "russia": "Q159",
      "turkey": "Q43", "israel": "Q801", "czechia": "Q213"}
