#!/usr/bin/env python3
"""Replace wave17 cities lacking a usable verified hero OR >=5 verified nearby with
...
print(f"nearby total={sum(cnt)} under5={sum(1 for x in cnt if x<5)} | heroes complete={len(heroes)==len(selected)==375}")
