...
slug dedup + within-city QID dedup. Checkpoints /tmp/w17/nearby.json (resumable)."""
...
pool = []
for cc in ["greece", "hungary", "bulgaria", "slovenia", "serbia", "lithuania", "latvia", "estonia", "montenegro", "ukraine", "belarus", "russia", "turkey", "israel", "czechia"]:
