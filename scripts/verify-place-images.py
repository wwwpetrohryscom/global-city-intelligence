...
SLUG_OVERRIDES: dict[str, str] = {
    ...
    # expansion batch — ambiguous city names disambiguated explicitly
    "porto": "Porto",
    "valencia": "Valencia",
    "naples": "Naples",
    "florence": "Florence",
    ...
    "dunedin": "Dunedin",
    # expansion batch 3 — ambiguous city names disambiguated explicitly
    "nice": "Nice",
    "frankfurt": "Frankfurt",
    "cologne": "Cologne",
    ...
    "eindhoven": "Eindhoven",
    "ghent": "Ghent",
    # expansion batch 4 — ambiguous city names disambiguated explicitly
    ...
    "geelong": "Geelong",
    "sunshine-coast": "Sunshine Coast, Queensland",
